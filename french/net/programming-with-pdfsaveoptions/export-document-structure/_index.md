---
title: Exporter la structure du document Word vers un document PDF
linktitle: Exporter la structure du document Word vers un document PDF
...
Cet article fournit un guide étape par étape sur l'utilisation de la fonctionnalité Exporter la structure du document Word vers un document PDF avec Aspose.Words pour .NET. Nous expliquerons chaque partie du code en détail. A la fin de ce tutoriel, vous serez en mesure de comprendre comment exporter la structure d'un document et générer un PDF avec la structure du document visible.
...
Dans ce tutoriel, nous avons expliqué comment exporter la structure d'un document Word vers un document PDF en utilisant Aspose.Words pour .NET. En suivant les étapes décrites, vous pouvez facilement générer un PDF avec la structure de votre document visible, ce qui facilite la navigation et la recherche dans le document. Utilisez les fonctionnalités d'Aspose.Words pour .NET pour exporter la structure de vos documents Word et créer des PDF bien structurés.
...
#### Q : Comment puis-je exporter la structure d'un document Word vers un document PDF en utilisant Aspose.Words pour .NET ?
R : Pour exporter la structure d'un document Word vers un document PDF à l'aide d'Aspose.Words pour .NET, suivez ces étapes :

 Créer une instance de`Document` classe spécifiant le chemin d'accès au document Word.

 Créer une instance de`PdfSaveOptions` classe et définissez la`ExportDocumentStructure` propriété à`true`. Cela exportera la structure du document et la rendra visible dans le volet de navigation "Contenu" d'Adobe Acrobat Pro lors de la modification du fichier PDF.
