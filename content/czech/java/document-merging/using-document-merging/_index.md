...
```
 ...
 Používáním`ImportFormatMode.KEEP_DIFFERENT_STYLES`, Aspose.Words zachovává styly, které se mezi zdrojovými a cílovými dokumenty liší, a konflikty řeší elegantně.
