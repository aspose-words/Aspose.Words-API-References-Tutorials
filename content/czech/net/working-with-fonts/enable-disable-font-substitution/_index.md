...
Odpověď: Chcete-li povolit nahrazování písem v dokumentu aplikace Word pomocí Aspose.Words, můžete použít rozhraní API k určení náhradních písem, která se mají použít, když požadovaná písma nejsou k dispozici. To zajistí konzistentní vizualizaci textu i bez původních písem.
