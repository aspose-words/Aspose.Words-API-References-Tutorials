...
tomto příkladu vás provedeme tím, jak používat funkci chráněného kódu s Aspose.Words for .NET. chráněný kód se používá k reprezentaci bloků kódu se specifickým formátováním.
