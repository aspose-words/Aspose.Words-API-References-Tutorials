...
```
 ...
 Používáním`StartTable` říkáme Aspose.Words, že se chystáme vytvořit tabulku. The`InsertCell` metoda přidá první buňku a`AutoFit` zajišťuje, že naše sloupy mají pevnou šířku.
