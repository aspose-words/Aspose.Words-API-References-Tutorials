...
1.  Aspose.Words for .NET: Ujistěte se, že máte nainstalovanou knihovnu Aspose.Words for .NET. Pokud jste to ještě neudělali, můžete si ji stáhnout[tady](https://releases.aspose.com/words/net/).
...
### Jak vložím písma do dokumentu?
 Vkládání písem lze provést pomocí`FontSettings` třídy v Aspose.Words pro .NET. Odkazovat na[dokumentace](https://reference.aspose.com/words/net/) Více podrobností.
