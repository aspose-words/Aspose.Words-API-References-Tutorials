...
```
 ...
 In dit voorbeeld`MatchCase` ingesteld op`false` om hoofdletterverschillen te negeren, en`FindWholeWordsOnly` ingesteld op`false` om gedeeltelijke overeenkomsten binnen woorden mogelijk te maken.
