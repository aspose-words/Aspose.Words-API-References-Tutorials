...
description: 了解如何使用 Aspose.Words for Java 生成和自定义目录 (TOC)。轻松创建有组织且专业的文档。
type: docs
weight: 21
...
您可以使用以下命令修改与 TOC 级别关联的样式`doc.getStyles().getByStyleIdentifier(StyleIdentifier.TOC_X)`，其中 X 是 TOC 水平。
