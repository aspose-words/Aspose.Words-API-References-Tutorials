...
description: 了解如何使用 Aspose.Words for .NET 分步指南读取 markdown 文档。
type: docs
weight: 10
...
首先，我们将使用`Document`类来读取Markdown文档。我们需要指定要读取的Markdown文件的路径。
...
答：要使用 .NET 读取 Markdown 文档，您可以使用与 Markdown 兼容的库，例如`Markdig`或者`CommonMark.NET`。这些库提供了解析和提取 Markdown 文档内容的功能。
