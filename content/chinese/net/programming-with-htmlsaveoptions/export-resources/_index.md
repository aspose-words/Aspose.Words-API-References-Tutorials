...
description: 使用 Aspose.Words for .NET 将文档资源保存为 HTML 时导出的分步指南。
type: docs
weight: 10
url: /zh/net/programming-with-htmlsaveoptions/export-resources/
---

在本教程中，我们将引导您完成使用 Aspose.Words for .NET 导出文档资源的 C# 源代码。此功能允许您在以 HTML 格式保存文档时将字体等资源导出为外部文件。
...
- `ResourceFolderAlias`指定用于访问资源的 URL 别名。
