...
在本教程中，我们将引导您完成使用 Aspose.Words for .NET 从文档中导出往返信息的 C# 源代码。此功能允许您在导出的 HTML 文件中包括往返信息，从而更轻松地检索对原始文档所做的更改。
...
此代码创建`HtmlSaveOptions`并设置`ExportRoundtripInformation`选择`true`在导出时包含往返信息。
