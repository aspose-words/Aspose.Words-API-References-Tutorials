...
在本教程中，我们将引导您完成 C# 源代码，以使用 Aspose.Words for .NET 向文档添加自定义属性。此功能允许您向文档添加自定义信息。
...
此代码首先检查自定义属性中是否已存在“Authorized”属性。如果存在，则中断该过程。否则，将自定义属性添加到文档中。
...
现在您已经了解了如何使用 Aspose.Words for .NET 向文档添加自定义属性。按照本教程提供的分步指南，您可以轻松地向文档添加自己的自定义属性。