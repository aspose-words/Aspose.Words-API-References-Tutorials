...
---
当涉及到在 .NET 应用程序中对 Word 文档进行文字处理时，Aspose.Words 是一个功能强大且多功能的工具，可以帮助您轻松操作 DOCX 文件。在本文中，我们将探讨 Aspose.Words 的一个特定功能：删除页脚。
...
有时您可能想要从 Word 文档中删除页脚。这可能是由于各种原因造成的，例如需要删除敏感信息、调整文档以供其他用途或只是为了消除不需要的元素。 Aspose.Words 为您提供了一种简单有效的方法来从文档中删除页脚，从而使这项任务变得更加容易。
