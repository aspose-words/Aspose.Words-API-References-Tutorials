...
## 结论
在本教程中，我们学习了如何在使用 Aspose.Words for .NET 渲染文档时优先设置字体文件夹。通过遵循此分步指南，您可以在渲染文档时轻松指定具有自定义搜索优先级的多个字体文件夹。 Aspose.Words 提供了强大而灵活的 API，用于文档中字体的文字处理。有了这些知识，您就可以控制和自定义在根据您的特定需求渲染文档时使用的字体源。
