...
description: 了解如何使用 Aspose.Words Python API 创建和管理 Word 文档中的列表。包含列表格式、自定义、嵌套等源代码的分步指南。
type: docs
weight: 18
...
在我们深入创建和管理列表之前，请确保您已安装 Aspose.Words for Python 库。您可以从以下位置下载：[这里](https://releases.aspose.com/words/python/) 。此外，请参阅 API 文档：[这个链接](https://reference.aspose.com/words/python-net/)获取详细信息。
...
您可以从以下位置下载该库[这个链接](https://releases.aspose.com/words/python/)并按照文档中提供的安装说明进行操作。
...
### 创建列表后如何保存文档？
您可以使用以下方式保存文档`doc.save()`方法并指定所需的输出格式，例如 DOCX 或 PDF。