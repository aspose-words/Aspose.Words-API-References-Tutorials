...
차트의 축에 대한 숫자 서식은 축에 표시되는 숫자 값에 적용되는 서식을 나타냅니다. 소수 자릿수, 천 단위 구분 기호, 통화 기호, 백분율 기호 등과 같은 옵션을 포함하여 숫자가 표시되는 방식을 제어할 수 있습니다. 숫자 형식을 설정하면 특정 요구 사항에 맞게 차트의 숫자 데이터 모양을 사용자 정의할 수 있습니다.
