...
Aspose.Words for .NET은 Word 문서의 차트를 사용하여 단어 처리를 위한 포괄적인 API를 제공합니다. 분산형 차트는 두 개의 숫자 변수를 사용하여 데이터를 시각화하고 분석하는 데 유용합니다. .NET용 Aspose.Words를 사용하면 X와 Y 값 사이의 관계를 나타내고 데이터의 패턴이나 추세를 식별하는 분산형 차트를 쉽게 만들 수 있습니다.
