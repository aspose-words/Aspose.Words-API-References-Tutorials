...
이 튜토리얼에서는 .NET용 Aspose.Words를 사용하여 "문서 텍스트 방향" 기능에 제공되는 C# 소스 코드를 살펴보겠습니다. 이 기능을 사용하면 문서에서 텍스트 방향을 지정할 수 있는데, 이는 히브리어나 아랍어와 같이 오른쪽에서 왼쪽으로 쓰는 언어에 특히 유용합니다.
...
이 튜토리얼에서는 .NET용 Aspose.Words의 문서 텍스트 방향 기능을 살펴보았습니다. 특히 히브리어나 아랍어처럼 오른쪽에서 왼쪽으로 쓰는 언어의 경우 문서에서 텍스트 방향을 지정하는 방법을 배웠습니다.
...
이 기능은 특정 텍스트 방향이 필요한 언어로 단어를 처리할 때 특히 유용하다는 점에 유의하는 것이 중요합니다. Aspose.Words는 문서의 텍스트 방향을 관리하는 강력한 도구를 제공하여 이 작업을 쉽게 만듭니다.
