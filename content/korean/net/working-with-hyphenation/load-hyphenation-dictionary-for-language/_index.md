...
#### Q: Aspose.Words에서는 어떤 언어를 음절화에 지원하나요?

A: Aspose.Words는 영어, 프랑스어, 스페인어, 독일어, 이탈리아어, 네덜란드어, 러시아어, 포르투갈어, 스웨덴어, 노르웨이어, 덴마크어, 핀란드어, 폴란드어, 체코어 등을 포함한 여러 언어에 대한 음절화를 지원합니다. 음절 표기에 지원되는 언어의 전체 목록은 Aspose.Words 문서를 확인하세요.