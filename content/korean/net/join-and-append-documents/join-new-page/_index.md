...
description: .NET용 Aspose.Words를 사용하여 서식을 유지하면서 두 문서를 새 페이지에 결합하는 방법을 알아보세요.
type: docs
weight: 10
url: /ko/net/join-and-append-documents/join-new-page/
---

이 튜토리얼에서는 Aspose.Words for .NET을 사용하여 두 문서를 새 페이지에 결합하는 방법을 설명합니다. 제공된 소스 코드는 새 페이지에서 추가된 문서를 시작하면서 다른 문서의 끝에 문서를 추가하는 방법을 보여줍니다.
...
## 3단계: 새 페이지 섹션 시작 설정
 ...
 새 페이지에서 첨부된 문서를 시작하려면`SectionStart` 소스 문서의 첫 번째 섹션 속성을`SectionStart.NewPage`.
...
이것으로 .NET용 Aspose.Words를 사용하여 두 문서를 새 페이지에 결합하는 구현이 완료되었습니다.

### .NET용 Aspose.Words를 사용하는 Join New Page의 예제 소스 코드 
