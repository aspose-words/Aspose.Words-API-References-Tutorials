...
이 문서에서는 .NET용 Aspose.Words와 함께 PDF 문서의 이미지 압축 기능을 사용하는 방법에 대한 단계별 가이드를 제공합니다. 코드의 각 부분을 자세히 설명하겠습니다. 이 튜토리얼이 끝나면 문서의 이미지를 압축하고 적절한 이미지 압축을 사용하여 PDF를 생성하는 방법을 이해할 수 있습니다.
