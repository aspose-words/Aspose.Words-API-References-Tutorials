...
이 가이드에서는 .NET용 Aspose.Words 라이브러리를 사용하여 더티 필드를 업데이트하여 문서를 업로드하는 방법을 설명했습니다. 제공된 단계를 따르고 제공된 C# 소스 코드를 사용하면 C# 애플리케이션에 이 기능을 쉽게 적용할 수 있습니다. 문서 로드 시 업데이트 더티 필드에는 Word 문서의 최신 값이 표시됩니다.
