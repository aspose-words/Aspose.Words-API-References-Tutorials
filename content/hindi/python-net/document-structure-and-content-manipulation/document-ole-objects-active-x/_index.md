...
OLE ऑब्जेक्ट आपको अपने Word दस्तावेज़ों में स्प्रेडशीट या प्रेजेंटेशन जैसी बाहरी फ़ाइलों को सहजता से एकीकृत करने की अनुमति देते हैं। OLE ऑब्जेक्ट एम्बेड करने के लिए इन चरणों का पालन करें:
...
किसी एम्बेडेड ऑब्जेक्ट का आकार बदलने के लिए, उसे चुनने के लिए उस पर क्लिक करें। आपको आकार बदलने वाले हैंडल दिखेंगे जिनका उपयोग आप इसके आयामों को समायोजित करने के लिए कर सकते हैं।
