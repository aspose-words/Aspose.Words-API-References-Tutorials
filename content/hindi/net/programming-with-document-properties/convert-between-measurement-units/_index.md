...
अब हम मार्जिन, हेडर और फुटर दूरी आदि के मानों को माप की विभिन्न इकाइयों में परिवर्तित करेंगे। विशिष्ट माप इकाइयों में मान निर्दिष्ट करने के लिए निम्नलिखित कोड का उपयोग करें:
...
```
 ...
 यह कोड का उपयोग करता है`ConvertUtil` निर्दिष्ट मानों को इंच में बदलने के लिए Aspose.Words का वर्ग (`InchToPoint` ). आप इसमें उपलब्ध अन्य रूपांतरण विधियों का भी उपयोग कर सकते हैं`ConvertUtil` मानों को अन्य माप इकाइयों में परिवर्तित करने के लिए वर्ग।
...
अब आपने सीख लिया है कि .NET के लिए Aspose.Words का उपयोग करके किसी दस्तावेज़ में मार्जिन, हेडर और फ़ूटर दूरी आदि निर्दिष्ट करते समय माप इकाइयों के बीच कैसे परिवर्तित किया जाए। इस ट्यूटोरियल में दिए गए चरण-दर-चरण मार्गदर्शिका का पालन करके, आप आसानी से अपने दस्तावेज़ों में वांछित माप इकाइयों में मान निर्दिष्ट कर सकते हैं।