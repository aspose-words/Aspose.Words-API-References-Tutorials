...
4.  तुलना विकल्पों को कॉन्फ़िगर करने के लिए एक विकल्प बनाएं`CompareOptions` ऑब्जेक्ट और सेटिंग`Granularity` संपत्ति को वांछित स्तर तक ले जाना (उदाहरण के लिए,`Granularity.CharLevel` (चरित्र-स्तर की तुलना के लिए)।
