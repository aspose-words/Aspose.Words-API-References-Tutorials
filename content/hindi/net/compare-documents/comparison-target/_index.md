...
4.  बनाकर तुलना विकल्प कॉन्फ़िगर करें`CompareOptions` ऑब्जेक्ट और सेटिंग गुण जैसे`IgnoreFormatting` और`Target` (जैसे,`ComparisonTargetType.New` तुलना लक्ष्य के लिए)।
