...
यह ट्यूटोरियल आपको .NET के लिए Aspose.Words की रीस्टार्ट पेज नंबरिंग सुविधा का उपयोग करने की प्रक्रिया के माध्यम से मार्गदर्शन करेगा। यह सुविधा आपको स्रोत दस्तावेज़ में पृष्ठ क्रमांकन को पुनः आरंभ करते समय Word दस्तावेज़ों को जोड़ने और जोड़ने की अनुमति देती है।
...
## चरण 3: स्रोत दस्तावेज़ को पृष्ठ क्रमांकन पुनः आरंभ करने के लिए सेट करें
...
## चरण 5: अंतिम दस्तावेज़ सहेजें
 ...
 अंत में, मर्ज किए गए दस्तावेज़ को रीस्टार्ट पेज नंबरिंग सुविधा के साथ सहेजें`Save` की विधि`Document` कक्षा।

```csharp
dstDoc.Save(dataDir + "JoinAndAppendDocuments.RestartPageNumbering.docx");
```

### .NET के लिए Aspose.Words का उपयोग करके पृष्ठ क्रमांकन पुनः आरंभ करने के लिए उदाहरण स्रोत कोड
...
बस! आपने .NET के लिए Aspose.Words का उपयोग करके पेज नंबरिंग को पुनः आरंभ करने की सुविधा को सफलतापूर्वक लागू कर दिया है। अंतिम दस्तावेज़ में स्रोत दस्तावेज़ में पुनः आरंभ की गई पेज नंबरिंग के साथ मर्ज की गई सामग्री होगी।