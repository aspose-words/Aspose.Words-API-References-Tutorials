...
### प्रश्न 2: क्या मैं हेडर या फ़ुटर में छवियाँ जोड़ सकता हूँ?

 हां, आप आसानी से हेडर या फ़ुटर में चित्र जोड़ सकते हैं`DocumentBuilder.InsertImage` तरीका।

### प्रश्न 3: मैं पहले पृष्ठ के लिए अलग-अलग शीर्षलेख और पादलेख कैसे सेट करूं?
...
### प्रश्न 4: मैं Aspose.Words पर अधिक दस्तावेज़ कहां पा सकता हूं?
