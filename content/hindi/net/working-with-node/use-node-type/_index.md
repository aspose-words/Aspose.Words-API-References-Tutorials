...
###  क्या मैं इसके आधार पर ऑपरेशन कर सकता हूँ?`NodeType`?
 ...
 हां, आप इसके आधार पर विशिष्ट कार्य कर सकते हैं`NodeType` उदाहरण के लिए, आप किसी नोड की जाँच करके केवल पैराग्राफ़ पर फ़ॉर्मेटिंग लागू कर सकते हैं।`NodeType` है`NodeType.Paragraph`.
