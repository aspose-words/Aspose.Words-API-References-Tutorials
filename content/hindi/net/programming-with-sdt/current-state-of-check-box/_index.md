...
description: Aspose.Words for .NET के साथ Word दस्तावेज़ों में चेकबॉक्स प्रबंधित करना सीखें। यह मार्गदर्शिका प्रोग्रामेटिक रूप से चेकबॉक्स सेट अप करने, अपडेट करने और सहेजने को कवर करती है।
type: docs
weight: 10
...
### क्या मैं Word दस्तावेज़ में नए चेकबॉक्स बनाने के लिए Aspose.Words for .NET का उपयोग कर सकता हूँ?
 हां, आप प्रकार के संरचित दस्तावेज़ टैग जोड़कर नए चेकबॉक्स बना सकते हैं`SdtType.Checkbox` अपने दस्तावेज़ में जोड़ें.
