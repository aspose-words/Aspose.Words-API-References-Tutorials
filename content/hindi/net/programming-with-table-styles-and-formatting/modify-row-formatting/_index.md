...
यहाँ, हम दस्तावेज़ में पहली तालिका पुनः प्राप्त कर रहे हैं।`GetChild` तालिका नोड को खोजने के लिए विधि का उपयोग किया जाता है,`NodeType.Table` हम जिस प्रकार के नोड की तलाश कर रहे हैं, उसे निर्दिष्ट करना।`0` यह दर्शाता है कि हम पहली तालिका चाहते हैं, और`true` यह सुनिश्चित करता है कि हम संपूर्ण दस्तावेज़ की खोज करें।
...
### मैं किसी पंक्ति में बॉर्डर कैसे जोड़ूं?
 आप सेटिंग करके बॉर्डर जोड़ सकते हैं`LineStyle` की संपत्ति`Borders` किसी वांछित शैली पर आपत्ति जताना, जैसे`LineStyle.Single`.
