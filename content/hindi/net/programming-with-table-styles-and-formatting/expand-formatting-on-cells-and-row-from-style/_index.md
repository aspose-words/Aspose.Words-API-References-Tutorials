...
- नमूना दस्तावेज़: एक तालिका सहित Word दस्तावेज़ तैयार रखें, या आप कोड उदाहरण में दी गई तालिका का उपयोग कर सकते हैं।
...
अंत में, हम स्टाइल्स को विस्तारित करने के बाद सेल के शेडिंग रंग की जांच करेंगे और प्रिंट करेंगे। आपको टेबल स्टाइल से लागू अपडेटेड फ़ॉर्मेटिंग दिखनी चाहिए।
