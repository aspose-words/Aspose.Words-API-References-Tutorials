...
#### Q3. मैं दिनांक समय मान प्रदर्शित करने के लिए अक्ष को कैसे कॉन्फ़िगर कर सकता हूं?
 आप उपयुक्त गुण सेट करके दिनांक समय मान प्रदर्शित करने के लिए चार्ट की धुरी को कॉन्फ़िगर कर सकते हैं। उदाहरण के लिए, आप का उपयोग करके अक्ष के लिए न्यूनतम और अधिकतम मान निर्दिष्ट कर सकते हैं`Scaling.Minimum` और`Scaling.Maximum` गुण, क्रमशः. इसके अतिरिक्त, आप अंतराल को परिभाषित करने और अक्ष के लिए टिक चिह्न निर्धारित करने के लिए प्रमुख और छोटी इकाइयाँ सेट कर सकते हैं।
