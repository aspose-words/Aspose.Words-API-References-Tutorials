...
-  FieldTA fieldTA = (FieldTA) para.AppendField(FieldType.FieldTOAEntry, false);: पैराग्राफ़ में एक TA फ़ील्ड जोड़ता है।`FieldType.FieldTOAEntry` निर्दिष्ट करता है कि यह एक TOA प्रविष्टि फ़ील्ड है.
