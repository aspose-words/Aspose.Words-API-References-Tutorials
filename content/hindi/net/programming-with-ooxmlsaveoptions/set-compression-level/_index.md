...
description: .NET के लिए Aspose.Words के साथ दस्तावेज़ सहेजते समय संपीड़न स्तर सेट करना सीखें।
type: docs
weight: 10
...
```
 ...
 इस चरण में, हम OOXML सेव विकल्पों को कॉन्फ़िगर करते हैं`OoxmlSaveOptions` वर्ग। हमने संपीड़न स्तर को सेट किया`SuperFast` तेजी से संपीड़न पाने के लिए.
...
`OoxmlSaveOptions` वर्ग संपीड़न के स्तर को नियंत्रित करने के लिए लचीलापन प्रदान करता है`CompressionLevel` संपत्ति को उचित मूल्य पर बेचना, जैसे`SuperFast`यह आपको अपनी विशिष्ट आवश्यकताओं के आधार पर फ़ाइल आकार और बैकअप गति के बीच सही संतुलन बनाने की अनुमति देता है।
