...
Aspose.Words for .NET लचीले और शक्तिशाली बैकअप विकल्प प्रदान करके अंतिम बैकअप समय प्रॉपर्टी को स्वचालित रूप से अपडेट करना आसान बनाता है। आप यह सुविधा अपने प्रोजेक्ट में एकीकृत कर सकते हैं ताकि यह सुनिश्चित हो सके कि जेनरेट किए गए दस्तावेज़ों में सटीक बैकअप जानकारी हो।