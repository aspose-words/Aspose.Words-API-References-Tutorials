...
अब, आइए इस प्रक्रिया को कई चरणों में विभाजित करें ताकि आप प्रत्येक भाग को अच्छी तरह से समझ सकें।
...
```
 ...
 यहाँ,`RasterizeTransformedElements` इसके लिए सेट है`false` , जिसका अर्थ है कि रूपांतरित तत्वों को रास्टराइज़ नहीं किया जाएगा। आप इसे सेट कर सकते हैं`true` यदि आप चाहते हैं कि उन्हें रेखापुंजित किया जाए।
...
Aspose.Words कई तरह के फॉर्मेट को सपोर्ट करता है, जिसमें PDF, HTML, EPUB और बहुत कुछ शामिल है।[प्रलेखन](https://reference.aspose.com/words/net/) पूरी सूची के लिए यहां क्लिक करें.
