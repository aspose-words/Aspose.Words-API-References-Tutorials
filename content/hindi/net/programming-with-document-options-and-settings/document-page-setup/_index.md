...
description: .NET के लिए Aspose.Words के साथ दस्तावेज़ लेआउट स्थापित करने के लिए चरण-दर-चरण मार्गदर्शिका।
type: docs
weight: 10
url: /hi/net/programming-with-document-options-and-settings/document-page-setup/
---

इस ट्यूटोरियल में, हम आपको .NET के लिए Aspose.Words के साथ दस्तावेज़ लेआउट को कॉन्फ़िगर करने के लिए C# स्रोत कोड के बारे में बताएंगे। यह सुविधा आपको लेआउट मोड, प्रति पंक्ति वर्णों की संख्या और प्रति पृष्ठ पंक्तियों की संख्या सेट करने की अनुमति देती है।
...
इस चरण में, हम उस Word दस्तावेज़ को लोड करेंगे जिसे हम कॉन्फ़िगर करना चाहते हैं। दस्तावेज़ लोड करने के लिए निम्नलिखित कोड का उपयोग करें:
...
अब दस्तावेज़ लेआउट को कॉन्फ़िगर करें। लेआउट मोड, प्रति पंक्ति वर्णों की संख्या और प्रति पृष्ठ पंक्तियों की संख्या सेट करने के लिए निम्नलिखित कोड का उपयोग करें:
...
अब आपने सीख लिया है कि .NET के लिए Aspose.Words का उपयोग करके दस्तावेज़ के लेआउट को कैसे कॉन्फ़िगर किया जाए। इस ट्यूटोरियल में दिए गए चरण-दर-चरण मार्गदर्शिका का पालन करके, आप आसानी से अपने दस्तावेज़ों के लेआउट को अनुकूलित कर सकते हैं।