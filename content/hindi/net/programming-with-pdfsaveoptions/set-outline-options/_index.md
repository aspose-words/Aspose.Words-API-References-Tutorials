...
description: .NET के लिए Aspose.Words का उपयोग करके PDF दस्तावेज़ में आउटलाइन विकल्प सेट करना सीखें। हेडिंग लेवल और विस्तारित आउटलाइन कॉन्फ़िगर करके PDF नेविगेशन को बेहतर बनाएँ।
type: docs
weight: 10
...
## चरण 2: पीडीएफ सेव विकल्प कॉन्फ़िगर करें
 ...
 इसके बाद, आपको PDF सेव विकल्पों को कॉन्फ़िगर करना होगा। इसमें यह सेट करना शामिल है कि PDF आउटपुट में आउटलाइन को कैसे हैंडल किया जाना चाहिए। आप इसका उपयोग करेंगे`PdfSaveOptions` कक्षा में ऐसा करने के लिए कहा गया।
...
`ExpandedOutlineLevels`प्रॉपर्टी यह नियंत्रित करती है कि पीडीएफ को खोलने पर डिफ़ॉल्ट रूप से आउटलाइन के कितने लेवल विस्तारित होने चाहिए। इसे 1 पर सेट करने से शीर्ष-स्तरीय शीर्षक विस्तारित हो जाएँगे, जिससे मुख्य अनुभागों का स्पष्ट दृश्य दिखाई देगा।
...
## चरण 3: दस्तावेज़ को PDF के रूप में सहेजें
 ...
 विकल्पों को कॉन्फ़िगर करने के बाद, आप दस्तावेज़ को PDF के रूप में सहेजने के लिए तैयार हैं।`Save` की विधि`Document` क्लास में फ़ाइल पथ और सेव विकल्प पास करें।
