...
| शीर्षक | विवरण |
| --- | --- |
| [विंडो टाइटलबार में दस्तावेज़ का शीर्षक प्रदर्शित करें](./display-doc-title-in-window-titlebar/) | इस चरण-दर-चरण मार्गदर्शिका के साथ .NET के लिए Aspose.Words का उपयोग करके अपने PDF के विंडो शीर्षक बार में दस्तावेज़ शीर्षक प्रदर्शित करना सीखें। |
...
| [पीडीएफ दस्तावेज़ में सबसेट फ़ॉन्ट एम्बेड करें](./embedded-subset-fonts/) | .NET के लिए Aspose.Words का उपयोग करके केवल आवश्यक फ़ॉन्ट सबसेट एम्बेड करके PDF फ़ाइल का आकार कम करें। अपने PDF को कुशलतापूर्वक अनुकूलित करने के लिए हमारे चरण-दर-चरण मार्गदर्शिका का पालन करें। |
...
| [PDF दस्तावेज़ में आउटलाइन विकल्प सेट करें](./set-outline-options/) | .NET के लिए Aspose.Words का उपयोग करके PDF दस्तावेज़ में आउटलाइन विकल्प सेट करना सीखें। हेडिंग लेवल और विस्तारित आउटलाइन कॉन्फ़िगर करके PDF नेविगेशन को बेहतर बनाएँ। |
