...
description: .NET के लिए Aspose.Words का उपयोग करके Word दस्तावेज़ टेक्स्ट बॉक्स में लिंक को आगे कैसे ले जाएँ, यह जानें। दस्तावेज़ प्रबंधन के बेहतर अनुभव के लिए हमारी गाइड का पालन करें।
type: docs
weight: 10
...
ये नामस्थान वे क्लास और विधियां प्रदान करते हैं जिनका उपयोग हम Word दस्तावेज़ों और टेक्स्ट बॉक्स आकृतियों में परिवर्तन करने के लिए करेंगे।
...
### फॉरवर्ड लिंक को तोड़ना
 ...
 फॉरवर्ड लिंक को तोड़ने के लिए, आप इसका उपयोग कर सकते हैं`BreakForwardLink` विधि। यहाँ कोड है:
...
```
 ...
 कोड की यह पंक्ति लिंक को सेट करके अलग करती है`Next`संपत्ति को`null`, यह सुनिश्चित करते हुए कि यह टेक्स्ट बॉक्स किसी अन्य टेक्स्ट बॉक्स पर नहीं जाता है।
