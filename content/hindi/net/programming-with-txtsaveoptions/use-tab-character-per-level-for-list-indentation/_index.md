...
#### प्रश्न: .NET के लिए Aspose.Words के साथ सूची इंडेंटेशन के लिए मैं किन अन्य वर्णों का उपयोग कर सकता हूं?
 टैब वर्णों के अलावा, आप .NET के लिए Aspose.Words के साथ सूची इंडेंटेशन के लिए अन्य वर्णों का भी उपयोग कर सकते हैं। आप सेट कर सकते हैं`ListIndentation.Character` किसी भी वांछित वर्ण की संपत्ति, जैसे कि स्थान (`' '`), इंडेंटिंग सूचियों के लिए।
