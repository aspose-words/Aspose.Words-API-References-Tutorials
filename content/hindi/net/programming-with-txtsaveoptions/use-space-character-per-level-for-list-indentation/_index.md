...
## चरण 2: इंडेंटेशन के कई स्तरों के साथ एक सूची बनाएं
 ...
 साथ`DocumentBuilder` उदाहरण के लिए, अब आप अलग-अलग इंडेंटेशन लेवल वाली सूची बना सकते हैं।`ListFormat` सूची आइटमों को आवश्यकतानुसार क्रमांकित करने और इंडेंट करने के लिए संपत्ति।
...
### क्या मैं इंडेंटेशन के लिए रिक्त स्थानों की संख्या को गतिशील रूप से समायोजित कर सकता हूँ?
 हां, आप इसे समायोजित कर सकते हैं`ListIndentation.Count` अपनी आवश्यकताओं के आधार पर रिक्त स्थानों की संख्या निर्धारित करने के लिए संपत्ति का उपयोग करें।
