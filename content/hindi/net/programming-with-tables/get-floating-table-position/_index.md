...
3. नमूना दस्तावेज़: आपको फ़्लोटिंग टेबल वाला एक वर्ड दस्तावेज़ चाहिए होगा। आप एक बना सकते हैं या किसी मौजूदा दस्तावेज़ का उपयोग कर सकते हैं। 
...
यह स्थिति जाँचती है कि क्या तालिका की टेक्स्ट रैपिंग शैली “अराउंड” पर सेट है, जो यह दर्शाता है कि यह एक फ़्लोटिंग तालिका है।
...
### मैं .NET के लिए Aspose.Words का उपयोग करके कैसे बता सकता हूं कि कोई तालिका फ्लोटिंग है या नहीं?
 आप इसकी जांच करके यह पता लगा सकते हैं कि कोई टेबल फ्लोटिंग है या नहीं।`TextWrapping` संपत्ति। यदि इसे सेट किया गया है`TextWrapping.Around`, मेज तैर रही है.
