...
क्यों? हमें TOC बनाने वाले पैराग्राफ़ों को चिन्हित करने की आवश्यकता है। 
...
कैसे? मूल दस्तावेज़ को बरकरार रखने के लिए उसे नए नाम से सहेजें:
...
### क्या मैं अलग-अलग TOC स्तरों के लिए टैब स्टॉप को अलग-अलग संशोधित कर सकता हूँ?
हाँ, आप कर सकते हैं! बस प्रत्येक विशिष्ट TOC स्तर (Toc1, Toc2, आदि) की जाँच करें और उसके अनुसार समायोजन करें।

### यदि मेरे दस्तावेज़ में एकाधिक TOCs हों तो क्या होगा?
...
### क्या TOC प्रविष्टि में एकाधिक टैब स्टॉप जोड़ना संभव है?
 बिल्कुल! आप आवश्यकतानुसार टैब स्टॉप जोड़ सकते हैं`para.ParagraphFormat.TabStops` संग्रह।
...
### क्या मुझे .NET के लिए Aspose.Words का उपयोग करने के लिए लाइसेंस की आवश्यकता है?
 हां, आपको परीक्षण अवधि से परे .NET के लिए Aspose.Words का उपयोग करने के लिए एक वैध लाइसेंस की आवश्यकता है। आप एक प्राप्त कर सकते हैं[अस्थायी लाइसेंस](https://purchase.aspose.com/temporary-license/) या[एक खरीदें](https://purchase.aspose.com/buy).