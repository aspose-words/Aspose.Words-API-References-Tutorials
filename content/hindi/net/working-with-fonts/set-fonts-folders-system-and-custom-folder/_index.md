...
#### प्रश्न: मैं Aspose.Words में कस्टम फ़ॉन्ट फ़ोल्डर कैसे सेट कर सकता हूं?
 ...
 A: Aspose.Words में कस्टम फ़ॉन्ट फ़ोल्डर्स सेट करने के लिए, आप इसका उपयोग कर सकते हैं`SetFontsFolders` की विधि`Fonts` क्लास कस्टम फ़ॉन्ट फ़ोल्डरों के स्थान निर्दिष्ट करता है।
