---
title: टेक्स्ट इनपुट फॉर्म फ़ील्ड को टेक्स्ट के रूप में निर्यात करें
linktitle: टेक्स्ट इनपुट फॉर्म फ़ील्ड को टेक्स्ट के रूप में निर्यात करें
...
इस ट्यूटोरियल में, हम आपको .NET के लिए Aspose.Words के साथ टेक्स्ट इनपुट फॉर्म फ़ील्ड को सादे टेक्स्ट के रूप में निर्यात करने के लिए C# स्रोत कोड के बारे में बताएंगे। यह सुविधा आपको टेक्स्ट इनपुट फॉर्म फ़ील्ड को HTML इनपुट तत्वों के रूप में निर्यात करने के बजाय पठनीय टेक्स्ट के रूप में निर्यात करने की अनुमति देती है।
...
अब हम टेक्स्ट इनपुट फॉर्म फ़ील्ड को सादे टेक्स्ट के रूप में निर्यात करने के लिए HTML सेव विकल्पों को कॉन्फ़िगर करेंगे। निम्नलिखित कोड का प्रयोग करें:
...
```
 ...
 यह कोड एक उदाहरण बनाता है`HtmlSaveOptions`और सेट करता है`ExportTextInputFormFieldAsText` का विकल्प`true` टेक्स्ट इनपुट फॉर्म फ़ील्ड को सादे टेक्स्ट के रूप में निर्यात करने के लिए। इसके अलावा, यह उस फ़ोल्डर को निर्दिष्ट करता है जहां निकाली गई छवियां सहेजी जाएंगी।
...
यह कोड टेक्स्ट इनपुट फॉर्म फ़ील्ड को सादे टेक्स्ट के रूप में निर्यात करके दस्तावेज़ को HTML में परिवर्तित करता है, और निर्यात की गई HTML फ़ाइल को निर्दिष्ट निर्देशिका में सहेजता है।
...
```csharp
	...
	// प्रपत्र फ़ील्ड को सादे पाठ के रूप में निर्यात करने का विकल्प सेट करें, HTML इनपुट तत्वों के रूप में नहीं।
	HtmlSaveOptions saveOptions = new HtmlSaveOptions(SaveFormat.Html)
	{
