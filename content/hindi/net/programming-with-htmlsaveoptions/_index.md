...
| शीर्षक | विवरण |
| --- | --- |
| [राउंडट्रिप जानकारी निर्यात करें](./export-roundtrip-information/) | .NET के लिए Aspose.Words के साथ HTML के रूप में दस्तावेज़ सहेजते समय राउंडट्रिप जानकारी निर्यात करने के लिए चरण-दर-चरण मार्गदर्शिका। |
| [फ़ॉन्ट को बेस 64 के रूप में निर्यात करें](./export-fonts-as-base-64/) | .NET के लिए Aspose.Words के साथ दस्तावेज़ सहेजते समय बेस 64 फ़ॉन्ट्स को निर्यात करने के लिए चरण-दर-चरण मार्गदर्शिका। |
| [संसाधन निर्यात करें](./export-resources/) | .NET के लिए Aspose.Words के साथ HTML के रूप में सहेजते समय दस्तावेज़ संसाधनों को निर्यात करने के लिए चरण-दर-चरण मार्गदर्शिका। |
...
| [मेटाफ़ाइल्स को Svg में बदलें](./convert-metafiles-to-svg/) | .NET के लिए Aspose.Words के साथ दस्तावेज़ को HTML में परिवर्तित करते समय मेटाफ़ाइलों को SVG प्रारूप में परिवर्तित करने के लिए चरण-दर-चरण मार्गदर्शिका। |
| [सीएसएस क्लास नाम उपसर्ग जोड़ें](./add-css-class-name-prefix/) | .NET के लिए Aspose.Words के साथ किसी दस्तावेज़ को HTML में परिवर्तित करते समय CSS वर्ग नाम उपसर्ग जोड़ने के लिए चरण-दर-चरण मार्गदर्शिका। |
| [Mhtml संसाधनों के लिए Cid URL निर्यात करें](./export-cid-urls-for-mhtml-resources/) | .NET के लिए Aspose.Words के साथ दस्तावेज़ सहेजते समय MHTML संसाधनों के CID URL को निर्यात करने के लिए चरण-दर-चरण मार्गदर्शिका। |
| [फ़ॉन्ट नाम हल करें](./resolve-font-names/) | .NET के लिए Aspose.Words के साथ HTML में कनवर्ट करते समय गायब फ़ॉन्ट नामों को हल करने के लिए चरण-दर-चरण मार्गदर्शिका। |
| [टेक्स्ट इनपुट फ़ॉर्म फ़ील्ड को टेक्स्ट के रूप में निर्यात करें](./export-text-input-form-field-as-text/) | .NET के लिए Aspose.Words के साथ टेक्स्ट इनपुट फॉर्म फ़ील्ड को सादे टेक्स्ट के रूप में निर्यात करने के लिए चरण दर चरण मार्गदर्शिका। |