...
```
 ...
 यह कोड लाइसेंस को आरंभ करता है और इसे सेट करने का प्रयास करता है। सुनिश्चित करें कि आप प्रतिस्थापित करें`"Aspose.Words.lic"` अपनी लाइसेंस फ़ाइल का पथ बताएं.
