...
आकृतियाँ सरल आयतों से लेकर जटिल आरेखों तक हो सकती हैं। Java के लिए Aspose.Words कई प्रकार की आकृतियाँ प्रदान करता है, जिसमें रेखाएँ, आयतें और वृत्त शामिल हैं। अपने दस्तावेज़ में आकृति जोड़ने के लिए, निम्न कोड का उपयोग करें:
