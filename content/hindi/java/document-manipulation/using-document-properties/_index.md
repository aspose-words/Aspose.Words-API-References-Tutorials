...
### मैं Aspose.Words for Java में विभिन्न माप इकाइयों के बीच कैसे रूपांतरण कर सकता हूं?
 ...
 आप Aspose.Words for Java में विभिन्न मापन इकाइयों के बीच रूपांतरण कर सकते हैं`ConvertUtil` वर्ग। यह इंच को पॉइंट में, पॉइंट को सेंटीमीटर में, आदि इकाइयों को परिवर्तित करने के तरीके प्रदान करता है।