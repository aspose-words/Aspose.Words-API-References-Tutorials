...
## Προσθήκη κεφαλίδων και υποσέλιδων σε πίνακες:
 ...
 Οι πίνακες μπορούν να επωφεληθούν από την ύπαρξη κεφαλίδων και υποσέλιδων που παρέχουν περιεχόμενο ή πρόσθετες πληροφορίες. Μπορείτε να προσθέσετε κεφαλίδες και υποσέλιδα σε πίνακες χρησιμοποιώντας το`Table.title` και`Table.description` σκηνικά θέατρου.
