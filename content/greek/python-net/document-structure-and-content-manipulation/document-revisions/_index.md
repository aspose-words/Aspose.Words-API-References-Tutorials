...
Ναι, μπορείτε να απενεργοποιήσετε επιλεκτικά την παρακολούθηση αναθεωρήσεων για συγκεκριμένες ενότητες του εγγράφου προσαρμόζοντας μέσω προγραμματισμού την`TrackRevisions` ιδιοκτησίας για αυτά τα τμήματα.
