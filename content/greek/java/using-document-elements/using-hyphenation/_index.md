...
Ο συλλαβισμός είναι η διαδικασία διαχωρισμού των λέξεων σε συλλαβές και προσθήκης παύλων στο τέλος των γραμμών για τη βελτίωση της ευθυγράμμισης του κειμένου στα έγγραφα. Είναι ιδιαίτερα σημαντικό όταν έχουμε να κάνουμε με γλώσσες που έχουν πολύπλοκες δομές λέξεων.
