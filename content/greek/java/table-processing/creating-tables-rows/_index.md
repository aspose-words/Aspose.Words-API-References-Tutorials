...
### Μπορώ να εξαγάγω το έγγραφο σε διαφορετικές μορφές;
 Το Aspose.Words για Java σάς επιτρέπει να αποθηκεύετε το έγγραφό σας σε διάφορες μορφές, όπως DOCX, PDF, HTML και άλλα. Χρησιμοποιήστε το`Document.save` μέθοδος για να καθορίσετε την επιθυμητή μορφή.
