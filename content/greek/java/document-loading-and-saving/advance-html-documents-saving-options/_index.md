...
## 3. Εξαγωγή γραμματοσειρών ως Base64
 Με την`exportFontsAsBase64` Με τη μέθοδο, μπορείτε να εξάγετε γραμματοσειρές που χρησιμοποιούνται στο έγγραφο ως δεδομένα κωδικοποιημένα με Base64 σε HTML. Αυτό διασφαλίζει ότι η αναπαράσταση HTML διατηρεί τα ίδια στυλ γραμματοσειράς με το αρχικό έγγραφο του Word.
...
## 7. Προσθέστε το πρόθεμα ονόματος κλάσης CSS
 Με την`addCssClassNamePrefix` μέθοδο, μπορείτε να προσθέσετε ένα πρόθεμα σε ονόματα κλάσεων CSS στο εξαγόμενο HTML. Αυτό βοηθά στην αποφυγή διενέξεων με υπάρχοντα στυλ.
