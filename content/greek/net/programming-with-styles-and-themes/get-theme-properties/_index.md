...
### Πώς μπορώ να εφαρμόσω ένα νέο θέμα σε ένα έγγραφο του Word;
 ...
 Για να εφαρμόσετε ένα νέο θέμα, θα πρέπει να ορίσετε τις ιδιότητες θέματος στο δικό σας`Document` αντικείμενο. Ελεγξε το[Aspose.Words Documentation](https://reference.aspose.com/words/net/) για λεπτομέρειες σχετικά με την εφαρμογή θεμάτων.
