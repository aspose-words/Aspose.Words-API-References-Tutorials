...
Α: Εκτός από τις δυνατότητες OpenType, το Aspose.Words για .NET υποστηρίζει επίσης άλλες δυνατότητες μορφοποίησης κειμένου όπως μορφοποίηση παραγράφων, δημιουργία πινάκων, προσθήκη εικόνων κ.λπ.
