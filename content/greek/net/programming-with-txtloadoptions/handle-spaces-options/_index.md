...
### Μπορώ να διατηρήσω κύρια κενά στο έγγραφό μου;  
 Ναι, μπορείτε να διαμορφώσετε το`TxtLoadOptions` για να κρατήσει προπορευόμενους χώρους με ρύθμιση`LeadingSpacesOptions` προς την`TxtLeadingSpacesOptions.None`.
