...
Τώρα θα διαμορφώσουμε τις επιλογές αποθήκευσης HTML για την επίλυση ονομάτων γραμματοσειρών που λείπουν κατά τη μετατροπή. Χρησιμοποιήστε τον ακόλουθο κώδικα:
