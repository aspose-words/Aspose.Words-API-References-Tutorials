...
```
 ...
 ο`MetafileRenderingOptions` Η class παρέχει επιλογές για τον τρόπο απόδοσης των μετα-αρχείων (όπως το WMF). Με ρύθμιση`ScaleWmfFontsToMetafileSize` προς την`false`, δίνετε εντολή στο Aspose.Words να μην κλιμακώνει τις γραμματοσειρές σύμφωνα με το μέγεθος του μετα-αρχείου, κάτι που μπορεί να βοηθήσει στη μείωση του συνολικού μεγέθους PDF.
