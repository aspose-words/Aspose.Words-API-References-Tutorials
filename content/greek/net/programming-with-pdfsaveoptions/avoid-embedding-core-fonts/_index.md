...
```
 ...
 Σύνθεση`UseCoreFonts` να`true` διασφαλίζει ότι οι βασικές γραμματοσειρές όπως το Arial και το Times New Roman δεν ενσωματώνονται στο PDF, γεγονός που μειώνει σημαντικά το μέγεθος του αρχείου.
