...
```
 ...
 Με ρύθμιση`FontEmbeddingMode` να`EmbedNone`, δίνουμε εντολή στο Aspose.Words να μην συμπεριλάβει αυτές τις γραμματοσειρές στο PDF, μειώνοντας το μέγεθος του αρχείου.
