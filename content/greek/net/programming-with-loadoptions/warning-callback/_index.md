...
### Πώς μπορώ να ρυθμίσω τη δυνατότητα προειδοποίησης επανάκλησης;
 Πρέπει να διαμορφώσετε το`LoadOptions` με το`WarningCallback` ιδιοκτησία και εφαρμόστε μια κλάση που χειρίζεται τις προειδοποιήσεις εφαρμόζοντας το`IWarningCallback` διεπαφή.
