...
2.  Χρησιμοποιήστε έναν βρόχο για επανάληψη μέσω του`DigitalSignatures` συλλογή των εγγράφων. Κάθε επανάληψη αντιπροσωπεύει μια ψηφιακή υπογραφή.
...
1.  Πρόσβαση στο`DigitalSignatures` συλλογή των εγγράφων.
