...
| [Διαγραφή σειράς ανά σελιδοδείκτη στο έγγραφο του Word](./delete-row-by-bookmark/) | Μάθετε πώς μπορείτε να διαγράψετε μια σειρά πίνακα με βάση έναν συγκεκριμένο σελιδοδείκτη στο έγγραφο του Word χρησιμοποιώντας το Aspose.Words για .NET. |