...
Για κάθε σελιδοδείκτη, ανακτούμε τη γονική σειρά και της αρχής του σελιδοδείκτη (`bookmark.BookmarkStart`) και το τέλος του σελιδοδείκτη (`bookmark.BookmarkEnd` ) χρησιμοποιώντας την`GetAncestor` μέθοδος.
