...
#### Πώς να καθορίσετε τον κατάλογο που περιέχει τα έγγραφα στα οποία θα αναζητήσετε την ψηφιακή υπογραφή;
 ...
 Για να καθορίσετε τον κατάλογο που περιέχει τα έγγραφα στα οποία θέλετε να αναζητήσετε την ψηφιακή υπογραφή, πρέπει να τροποποιήσετε το`dataDir` μεταβλητή στον κώδικα. Αντικαθιστώ`"YOUR DOCUMENT DIRECTORY"` με την πραγματική διαδρομή προς τον κατάλογο των εγγράφων σας.
