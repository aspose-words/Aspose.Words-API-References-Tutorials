...
```
 ...
 Σε αυτή τη γραμμή κώδικα, ορίζουμε το`LineStyle` των συνόρων προς`None`, αφαιρώντας ουσιαστικά τυχόν περιθώρια από την πρώτη σειρά. Αυτό μπορεί να είναι χρήσιμο εάν θέλετε μια καθαρή, χωρίς περιθώρια εμφάνιση για τη σειρά κεφαλίδας.
