...
### Δείγμα πηγαίου κώδικα για τον στόχο σύγκρισης χρησιμοποιώντας το Aspose.Words για .NET
...
4.  Διαμορφώστε τις επιλογές σύγκρισης δημιουργώντας ένα`CompareOptions` αντικείμενο και ιδιότητες ρύθμισης όπως`IgnoreFormatting` και`Target` (π.χ,`ComparisonTargetType.New` για στόχο σύγκρισης).
