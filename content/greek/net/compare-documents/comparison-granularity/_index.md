...
4.  Διαμορφώστε τις επιλογές σύγκρισης δημιουργώντας ένα`CompareOptions` αντικείμενο και τη ρύθμιση του`Granularity` ιδιοκτησία στο επιθυμητό επίπεδο (π.χ.`Granularity.CharLevel` για σύγκριση σε επίπεδο χαρακτήρων).
