...
Στη συνέχεια, θα ορίσουμε τη σχετική οριζόντια ή κάθετη θέση του πίνακα. Χρησιμοποιήστε τον ακόλουθο κώδικα:
...
Τέλος, πρέπει να αποθηκεύσουμε το τροποποιημένο έγγραφο με καθορισμένη τη σχετική θέση του πίνακα. Χρησιμοποιήστε τον ακόλουθο κώδικα:
