...
Για να διατηρήσουμε τον πίνακα μαζί και να αποτρέψουμε τον διαχωρισμό του σε πολλές σελίδες, πρέπει να ενεργοποιήσουμε την επιλογή "KeepWithNext" για κάθε παράγραφο του πίνακα εκτός από τις τελευταίες παραγράφους της τελευταίας σειράς του πίνακα. Χρησιμοποιήστε τον ακόλουθο κώδικα:
...
Τέλος, πρέπει να αποθηκεύσουμε το τροποποιημένο έγγραφο με τον πίνακα συγκρατημένο. Χρησιμοποιήστε τον ακόλουθο κώδικα:
