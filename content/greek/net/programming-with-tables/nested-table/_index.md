...
Στη συνέχεια, θα δημιουργήσουμε τον ένθετο πίνακα εισάγοντας κελιά στον εξωτερικό πίνακα και δημιουργώντας έναν νέο πίνακα μέσα στο πρώτο κελί. Χρησιμοποιήστε τον ακόλουθο κώδικα:
...
Τέλος, πρέπει να αποθηκεύσουμε το τροποποιημένο έγγραφο με τον ένθετο πίνακα. Χρησιμοποιήστε τον ακόλουθο κώδικα:
