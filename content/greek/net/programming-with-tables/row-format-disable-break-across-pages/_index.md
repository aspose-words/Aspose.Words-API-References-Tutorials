...
### Λειτουργεί αυτή η μέθοδος για πίνακες με συγχωνευμένα κελιά;  
 Ναι, αυτή η μέθοδος λειτουργεί για πίνακες με συγχωνευμένα κελιά. Η ιδιοκτησία`AllowBreakAcrossPages` ισχύει για ολόκληρη τη σειρά, ανεξάρτητα από τη συγχώνευση κελιών.
