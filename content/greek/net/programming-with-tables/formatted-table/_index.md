...
Στη συνέχεια, θα δημιουργήσουμε τον μορφοποιημένο πίνακα χρησιμοποιώντας τις μεθόδους που παρέχονται από το πρόγραμμα δημιουργίας εγγράφων. Χρησιμοποιήστε τον παρακάτω κώδικα:
...
Τέλος, πρέπει να αποθηκεύσουμε το έγγραφο που περιέχει τον μορφοποιημένο πίνακα. Χρησιμοποιήστε τον παρακάτω κώδικα:
