...
Στη συνέχεια θα συγχωνεύσουμε τα κελιά κάθετα στον πίνακα. Χρησιμοποιήστε τον παρακάτω κώδικα:
...
Τέλος, πρέπει να αποθηκεύσουμε το τροποποιημένο έγγραφο με τα συγχωνευμένα κελιά. Χρησιμοποιήστε τον παρακάτω κώδικα:
