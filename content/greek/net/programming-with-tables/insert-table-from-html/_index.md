...
Στη συνέχεια, θα εισαγάγουμε τον πίνακα στο έγγραφο χρησιμοποιώντας κώδικα HTML. Χρησιμοποιήστε τον ακόλουθο κώδικα:
...
Τέλος, πρέπει να αποθηκεύσουμε το τροποποιημένο έγγραφο με τον πίνακα που έχει εισαχθεί από HTML. Χρησιμοποιήστε τον ακόλουθο κώδικα:
