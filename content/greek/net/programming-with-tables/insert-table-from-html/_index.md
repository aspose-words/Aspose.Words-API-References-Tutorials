...
Ας αναλύσουμε τη διαδικασία εισαγωγής πίνακα από HTML σε έγγραφο του Word βήμα προς βήμα.
...
### Είναι δυνατή η εισαγωγή πολλών πινάκων HTML σε ένα μόνο έγγραφο του Word;
 Ναι, μπορείτε να εισαγάγετε πολλούς πίνακες HTML καλώντας το`InsertHtml` μέθοδο πολλές φορές με διαφορετικό κώδικα πίνακα HTML.
