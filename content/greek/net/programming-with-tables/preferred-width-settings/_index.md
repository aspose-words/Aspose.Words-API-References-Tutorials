...
Στη συνέχεια, θα δημιουργήσουμε έναν πίνακα με τρία κελιά που έχουν διαφορετικά προτιμώμενα πλάτη. Χρησιμοποιήστε τον παρακάτω κώδικα:
...
Τέλος, πρέπει να αποθηκεύσουμε το τροποποιημένο έγγραφο με τις προτιμώμενες ρυθμίσεις πλάτους που έχουν οριστεί για τα κελιά του πίνακα. Χρησιμοποιήστε τον παρακάτω κώδικα:
