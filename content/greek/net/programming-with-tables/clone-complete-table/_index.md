...
Στη συνέχεια, θα κλωνοποιήσουμε ολόκληρο τον πίνακα και θα τον εισαγάγουμε στο έγγραφο μετά το πρωτότυπο. Χρησιμοποιήστε τον ακόλουθο κώδικα:
...
Τέλος, πρέπει να αποθηκεύσουμε το τροποποιημένο έγγραφο με τον κλωνοποιημένο πίνακα. Χρησιμοποιήστε τον ακόλουθο κώδικα:
