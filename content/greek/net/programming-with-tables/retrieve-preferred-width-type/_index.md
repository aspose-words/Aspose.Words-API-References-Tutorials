...
```
 ...
 Σύνθεση`AllowAutoFit` προς την`true` διασφαλίζει ότι οι στήλες του πίνακα αλλάζουν το μέγεθος με βάση το περιεχόμενό τους, δίνοντας μια δυναμική αίσθηση στον πίνακά μας.
