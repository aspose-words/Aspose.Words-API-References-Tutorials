...
## Βήμα 2: Αρχικοποιήστε το Document και το DocumentBuilder
 ...
 Το επόμενο βήμα είναι η προετοιμασία ενός νέου`Document` και ένα`DocumentBuilder` . ο`DocumentBuilder` είναι μια βοηθητική κλάση που μας επιτρέπει να κατασκευάσουμε το περιεχόμενο του εγγράφου.
