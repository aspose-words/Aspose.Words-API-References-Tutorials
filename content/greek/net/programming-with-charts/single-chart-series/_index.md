...
Τώρα, ας έχουμε πρόσβαση στη σειρά γραφημάτων. Εδώ θα ξεκινήσουμε την προσαρμογή.
...
### Πού μπορώ να βρω περισσότερα έγγραφα;
 Ελέγξτε το[τεκμηρίωση](https://reference.aspose.com/words/net/) για πιο λεπτομερείς οδηγούς και παραδείγματα.