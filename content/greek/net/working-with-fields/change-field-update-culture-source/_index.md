...
Και εκεί το έχετε! Αλλάξατε με επιτυχία την πηγή πολιτισμού ενημέρωσης πεδίου στο Aspose.Words για .NET. Ακολουθώντας αυτά τα βήματα, μπορείτε να βεβαιωθείτε ότι τα έγγραφα Word εμφανίζουν ημερομηνίες και άλλες τιμές πεδίων σύμφωνα με τις καθορισμένες ρυθμίσεις πολιτισμού. Αυτό μπορεί να είναι ιδιαίτερα χρήσιμο κατά τη δημιουργία εγγράφων για ένα διεθνές κοινό.
...
### Είναι δυνατή η ενημέρωση πεδίων με βάση την κουλτούρα του εγγράφου αντί για τον κωδικό πεδίου;
 Ναι, μπορείτε να ρυθμίσετε`FieldUpdateCultureSource` προς την`FieldUpdateCultureSource.Document` για να χρησιμοποιήσετε τις ρυθμίσεις πολιτισμού του εγγράφου.
