...
Α: Ναι, το πεδίο ASK μπορεί να χρησιμοποιηθεί για να ζητήσει πολλές πληροφορίες από τον χρήστη. Μπορείτε να εισαγάγετε πολλά πεδία ASK στο έγγραφό σας, το καθένα με διαφορετική ερώτηση. Όταν ανοίξει το έγγραφο, ο χρήστης θα κληθεί για τις αντίστοιχες απαντήσεις.