...
```
 ...
 Εδώ, δημιουργούμε`CommentRangeStart`και`CommentRangeEnd` αντικείμενα, συνδέοντάς τα με το σχόλιο μέσω του αναγνωριστικού του. Στη συνέχεια, εισάγουμε αυτές τις περιοχές στο έγγραφο, ουσιαστικά αγκυρώνοντας το σχόλιό μας στο καθορισμένο κείμενο.
