...
```
 ...
 Χρησιμοποιώντας το`InsertDocument` μέθοδο, μπορούμε να εισάγουμε ολόκληρο το έγγραφο προέλευσης στο έγγραφο προορισμού. Ο`ImportFormatMode.KeepSourceFormatting` διασφαλίζει ότι διατηρείται η μορφοποίηση του εγγράφου προέλευσης.
