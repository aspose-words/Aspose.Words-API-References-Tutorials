...
Και εκεί το έχετε! Ακολουθώντας αυτά τα βήματα, μπορείτε να προσαρτήσετε απρόσκοπτα ένα έγγραφο σε ένα άλλο ενώ χρησιμοποιείτε τα στυλ του εγγράφου προορισμού. Αυτή η τεχνική είναι ιδιαίτερα χρήσιμη όταν χρειάζεται να διατηρήσετε μια συνεπή εμφάνιση και αίσθηση σε πολλά έγγραφα.
