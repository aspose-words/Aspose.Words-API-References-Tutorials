...
### Τι γίνεται αν τα έγγραφά μου έχουν διαφορετική μορφοποίηση;
 ...
 Μπορείτε να ελέγξετε τον τρόπο χειρισμού της μορφοποίησης χρησιμοποιώντας το`ImportFormatMode` παράμετρος. Οι επιλογές περιλαμβάνουν`KeepSourceFormatting`, `UseDestinationStyles`, κι αλλα.
