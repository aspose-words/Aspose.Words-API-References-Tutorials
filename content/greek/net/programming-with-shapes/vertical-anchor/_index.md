...
```
 ...
 Σε αυτή την περίπτωση,`TextBoxAnchor.Bottom`διασφαλίζει ότι το κείμενο θα αγκυρωθεί στο κάτω μέρος του πλαισίου κειμένου. Εάν το θέλατε κεντραρισμένο ή ευθυγραμμισμένο στην κορυφή, θα το χρησιμοποιούσατε`TextBoxAnchor.Center` ή`TextBoxAnchor.Top`, αντίστοιχα.
