...
Και εκεί το έχετε! Το έγγραφό σας με σχήματα ομάδων είναι έτοιμο.
...
### Πώς τοποθετώ το GroupShape μέσα στο έγγραφο;
 Μπορείτε να τοποθετήσετε το`GroupShape` με τη ρύθμιση του`Left`και`Top` ιδιότητες.
