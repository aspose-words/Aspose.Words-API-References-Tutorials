...
```
 ...
 Με ρύθμιση`PreferredControlType` να`HtmlControlType.StructuredDocumentTag`, διασφαλίζουμε ότι το σύνθετο πλαίσιο αποδίδεται ως ετικέτα δομημένου εγγράφου (SDT) στο έγγραφο του Word.
