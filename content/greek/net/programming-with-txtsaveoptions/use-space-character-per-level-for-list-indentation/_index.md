...
Σε αυτό το παράδειγμα, δημιουργούμε ένα νέο έγγραφο και χρησιμοποιούμε το DocumentBuilder για να προσθέσουμε κείμενο και να δημιουργήσουμε μια λίστα με τρία επίπεδα εσοχής. Προσθέσαμε τρία στοιχεία στη λίστα, με κάθε στοιχείο να υποδεικνύει ένα επιπλέον επίπεδο.
