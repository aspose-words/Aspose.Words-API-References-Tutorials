...
#### Ε: Ποιους άλλους χαρακτήρες μπορώ να χρησιμοποιήσω για την εσοχή λίστας με το Aspose.Words για .NET;
 Εκτός από τους χαρακτήρες καρτελών, μπορείτε επίσης να χρησιμοποιήσετε άλλους χαρακτήρες για εσοχή λίστας με το Aspose.Words για .NET. Μπορείτε να ορίσετε το`ListIndentation.Character` ιδιότητα σε οποιονδήποτε επιθυμητό χαρακτήρα, όπως το διάστημα (`' '`), για αναγνώριση λιστών.
