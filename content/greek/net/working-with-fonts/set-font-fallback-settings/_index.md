...
## Βήμα 3: Διαμόρφωση ρυθμίσεων γραμματοσειράς
 ...
 Δημιουργήστε ένα νέο`FontSettings` αντικείμενο και φορτώστε τις εναλλακτικές ρυθμίσεις γραμματοσειράς από ένα αρχείο XML. Αυτό το αρχείο XML περιέχει τους κανόνες για την εναλλακτική γραμματοσειρά.
