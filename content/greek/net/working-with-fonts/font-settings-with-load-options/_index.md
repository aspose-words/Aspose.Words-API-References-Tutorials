...
## Βήμα 2: Διαμορφώστε τις επιλογές φόρτωσης με τις ρυθμίσεις γραμματοσειράς
 Στη συνέχεια, θα δημιουργήσουμε ένα παράδειγμα του`LoadOptions` και καθορίστε τις ρυθμίσεις γραμματοσειράς δημιουργώντας μια νέα παρουσία του`FontSettings` και την ανάθεση σε`loadOptions.FontSettings`.
