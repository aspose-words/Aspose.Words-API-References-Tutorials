...
## Βήμα 3: Καθορίστε τα όρια παραγράφου
...
### Πώς μπορώ να αλλάξω το χρώμα του περιγράμματος;  
 Μπορείτε να ορίσετε το χρώμα του περιγράμματος χρησιμοποιώντας το`Color` ιδιοκτησία για κάθε περίγραμμα. Για παράδειγμα,`borders[BorderType.Left].Color = Color.Red;`.
