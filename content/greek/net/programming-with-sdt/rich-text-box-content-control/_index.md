...
## Βήμα 2: Δημιουργήστε ένα νέο έγγραφο
 ...
 Δημιούργησε ένα νέο`Document` αντικείμενο, το οποίο θα χρησιμεύσει ως βάση για το έγγραφο Word σας.
...
## Βήμα 4: Προσθέστε περιεχόμενο στο πλαίσιο εμπλουτισμένου κειμένου
 ...
 Δημιουργώ ένα`Paragraph` και ένα`Run` αντικείμενο να κρατήσει το περιεχόμενο που θέλετε να εμφανίσετε στο πλαίσιο εμπλουτισμένου κειμένου. Προσαρμόστε το κείμενο και τη μορφοποίηση όπως απαιτείται.
...
## Βήμα 5: Προσθέστε το πλαίσιο εμπλουτισμένου κειμένου στο έγγραφο
 ...
 Πρόσθεσε το`StructuredDocumentTag` στο σώμα του εγγράφου.
