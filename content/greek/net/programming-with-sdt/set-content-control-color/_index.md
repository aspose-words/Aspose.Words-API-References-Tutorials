...
## Βήμα 2: Φορτώστε το έγγραφο
 ...
 Δημιουργώ ένα`Document` αντικείμενο φορτώνοντας το αρχείο Word:
...
### Μπορώ να χρησιμοποιήσω διαφορετικά χρώματα για SDT;
 ...
 Ναι, μπορείτε να χρησιμοποιήσετε οποιοδήποτε χρώμα είναι διαθέσιμο στο`System.Drawing.Color` τάξη. Για παράδειγμα, μπορείτε να χρησιμοποιήσετε`Color.Blue`, `Color.Green`, και τα λοιπά.
