...
Ναι, το Aspose.Words είναι διαθέσιμο για Java, C++ και άλλες πλατφόρμες. Ελέγξτε τους[τεκμηρίωση](https://reference.aspose.com/words/net/) Για περισσότερες πληροφορίες.