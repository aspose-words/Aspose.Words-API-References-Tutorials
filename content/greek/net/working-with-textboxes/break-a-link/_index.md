...
### Σπάζοντας εισερχόμενους συνδέσμους
 ...
 Για να σπάσετε έναν εισερχόμενο σύνδεσμο, ελέγξτε εάν το`Previous` υπάρχει πλαίσιο κειμένου και καλέστε`BreakForwardLink` πάνω του:
