...
## 1. lépés: Töltse be a dokumentumot
 ...
 Mielőtt elkezdené a szövegcsere használatát egy táblázatban, be kell töltenünk a dokumentumot az Aspose.Words for .NET-be. Ezt a`Document` osztályt, és adja meg a dokumentum fájl elérési útját:
