...
| [Conformità Ooxml Iso 29500_2008_Strict](./ooxml-compliance-iso-29500_2008_strict/) | Scopri come garantire la conformità OOXML ISO 29500_2008_Strict utilizzando Aspose.Words per .NET con questa guida passo passo. |
| [Aggiorna la proprietà dell'ultimo tempo salvato](./update-last-saved-time-property/) | Scopri come aggiornare l'ultima proprietà dell'ora salvata nei documenti di Word utilizzando Aspose.Words per .NET. Segui la nostra guida dettagliata passo dopo passo. |
| [Mantieni i caratteri di controllo legacy](./keep-legacy-control-chars/) | Scopri come preservare i caratteri di controllo legacy nei documenti Word utilizzando Aspose.Words per .NET con questa guida passo passo. |
