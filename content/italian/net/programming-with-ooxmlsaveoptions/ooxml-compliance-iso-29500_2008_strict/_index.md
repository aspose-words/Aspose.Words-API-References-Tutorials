...
```
 ...
 In questo passaggio, configuriamo le opzioni di salvataggio OOXML utilizzando il file`OptimizeFor` E`OoxmlSaveOptions`metodi. Ottimizziamo la compatibilità dei documenti per la versione di Word 2016 utilizzando`OptimizeFor` e impostare la conformità su`Iso29500_2008_Strict` utilizzando`Compliance`.
