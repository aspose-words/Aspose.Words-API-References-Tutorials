...
Dopo aver caricato il documento, controlleremo se la lingua predefinita è stata impostata correttamente sul russo. Utilizza il codice seguente per ottenere l'ID della lingua predefinita:
...
Il codice controlla se l'ID della lingua corrisponde a quello del russo. In base al risultato, viene visualizzato un messaggio corrispondente.

### Codice sorgente di esempio per Imposta russo come lingua di modifica predefinita utilizzando Aspose.Words per .NET
...
Ora hai imparato come impostare il russo come lingua di modifica predefinita per un documento utilizzando Aspose.Words per .NET. Seguendo la guida passo passo