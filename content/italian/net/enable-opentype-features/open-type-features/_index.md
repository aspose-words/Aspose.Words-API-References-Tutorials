...
R: Puoi verificare se una funzionalità OpenType è supportata in un font specifico utilizzando il file`Font.OpenTypeFeatures` metodo in Aspose.Words per .NET.
