...
```
 ...
 O`Compare` método compara o documento A com o documento B e salva as alterações no documento A. Você pode especificar o nome do autor e a data de comparação para referência.
