...
## Etapa 3: definir as configurações de página do documento de origem
 ...
 Ajuste as configurações de página do documento de origem para garantir a continuação e numeração adequadas. Neste exemplo, definimos o início da seção como`SectionStart.Continuous` reinicie a numeração de páginas. Também nos certificamos de que a largura, altura e orientação da página correspondam à última seção do documento de destino.
