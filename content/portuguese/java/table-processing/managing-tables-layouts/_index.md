...
Aspose.Words fornece opções extensivas para modificar propriedades de tabela. Você pode alterar o layout, o estilo e muito mais da tabela. Por exemplo, para definir a largura preferida da tabela, use o seguinte código:
