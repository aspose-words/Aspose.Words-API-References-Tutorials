...
### ฉันจะพิมพ์หลายหน้าไม่ติดต่อกันจากเอกสาร Word ได้อย่างไร
 ...
 หากต้องการพิมพ์หลายหน้าไม่ติดต่อกัน คุณสามารถสร้างได้หลายหน้า`PageRange` วัตถุและระบุช่วงหน้าที่ต้องการ จากนั้นเพิ่มสิ่งเหล่านี้`PageRange` วัตถุไปยัง`PageRanges` อาร์เรย์ใน`PrintOptions` วัตถุ วัตถุ
...
### ฉันสามารถพิมพ์ส่วนเฉพาะของเอกสาร Word ได้หรือไม่
 ...
 ได้ คุณสามารถพิมพ์ส่วนเฉพาะของเอกสาร Word ได้โดยระบุหน้าภายในส่วนเหล่านั้นโดยใช้`PageRange`ชั้นเรียน สิ่งนี้ช่วยให้คุณควบคุมสิ่งที่จะพิมพ์ได้อย่างละเอียด
