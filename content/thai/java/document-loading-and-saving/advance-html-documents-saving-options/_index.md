...
## 9. แก้ไขชื่อแบบอักษร
 ที่`resolveFontNames` วิธีการช่วยแก้ไขชื่อแบบอักษรเมื่อบันทึกเอกสารในรูปแบบ HTML การแสดงผลที่สอดคล้องกันบนแพลตฟอร์มต่างๆ
...
## 10. ส่งออกฟิลด์แบบฟอร์มป้อนข้อความเป็นข้อความ
 ที่`exportTextInputFormFieldAsText` วิธีการส่งออกช่องแบบฟอร์มเป็นข้อความธรรมดาใน HTML ทำให้อ่านและแก้ไขได้ง่าย
