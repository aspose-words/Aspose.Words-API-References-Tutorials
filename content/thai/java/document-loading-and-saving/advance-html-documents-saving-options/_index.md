...
## 3. ส่งออกแบบอักษรเป็น Base64
 ด้วยการ`exportFontsAsBase64` คุณสามารถส่งออกแบบอักษรที่ใช้ในเอกสารเป็นข้อมูลที่เข้ารหัส Base64 ใน HTML ได้ เพื่อให้แน่ใจว่าการแสดง HTML ยังคงรูปแบบตัวอักษรเหมือนกับเอกสาร Word ต้นฉบับ
...
## 7. เพิ่มคำนำหน้าชื่อคลาส CSS
 ด้วยการ`addCssClassNamePrefix` วิธีการคุณสามารถเพิ่มคำนำหน้าให้กับชื่อคลาส CSS ใน HTML ที่ส่งออกได้ ซึ่งจะช่วยป้องกันความขัดแย้งกับสไตล์ที่มีอยู่
