...
```
 ...
 รหัสนี้สาธิตวิธีการโหลดเอกสารข้อความที่มีรูปแบบรายการต่างๆ และใช้`DetectNumberingWithWhitespaces` ตัวเลือกในการตรวจหารายการอย่างถูกต้อง
...
### ฉันจะโหลดเอกสารข้อความโดยใช้ Aspose.Words สำหรับ Java ได้อย่างไร
 ...
 หากต้องการโหลดเอกสารข้อความโดยใช้ Aspose.Words สำหรับ Java คุณสามารถใช้`TxtLoadOptions` ชั้นเรียนและ`Document` ชั้นเรียน ตรวจสอบให้แน่ใจว่าคุณระบุตัวเลือกที่เหมาะสมสำหรับการจัดการช่องว่างและทิศทางของข้อความตามความจำเป็น ดูคำแนะนำทีละขั้นตอนในบทความนี้สำหรับตัวอย่างโดยละเอียด
