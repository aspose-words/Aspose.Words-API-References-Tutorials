...
### ฉันสามารถลบแถวตารางว่างออกจากเอกสารโดยใช้ Aspose.Words สำหรับ Java ได้หรือไม่
 ...
 ได้ คุณสามารถลบแถวตารางว่างออกจากเอกสารได้โดยตั้งค่า`MailMergeCleanupOptions.REMOVE_EMPTY_TABLE_ROWS`ตัวเลือกการล้างข้อมูลเป็นจริง การดำเนินการนี้จะลบแถวของตารางที่ไม่มีข้อมูลโดยอัตโนมัติ เพื่อให้มั่นใจว่าตารางมีโครงสร้างที่ดีในเอกสารของคุณ
