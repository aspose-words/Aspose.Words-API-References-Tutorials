...
## ขั้นตอนที่ 1: การลบพารามิเตอร์ว่าง
...
ในตัวอย่างนี้ เราเปิดเอกสารที่มีเขตข้อมูลผสาน ตั้งค่าตัวเลือกการล้างข้อมูลเพื่อลบเขตข้อมูล และดำเนินการจดหมายเวียนด้วยข้อมูล หลังจากการผสาน เขตข้อมูลต่างๆ จะถูกลบออกจากเอกสาร
...
###  จุดประสงค์ของ..คืออะไร.`REMOVE_UNUSED_REGIONS` cleanup option?
 ...
 ที่`MailMergeCleanupOptions.REMOVE_UNUSED_REGIONS` ตัวเลือกใช้เพื่อลบขอบเขตในเอกสารที่ไม่มีข้อมูลที่เกี่ยวข้องในระหว่างกระบวนการจดหมายเวียน ช่วยให้เอกสารของคุณเป็นระเบียบเรียบร้อยโดยการกำจัดตัวยึดตำแหน่งที่ไม่ได้ใช้
...
###  จะเกิดอะไรขึ้นเมื่อฉันตั้งค่า`REMOVE_CONTAINING_FIELDS` option?
 ...
 การตั้งค่า`MailMergeCleanupOptions.REMOVE_CONTAINING_FIELDS` ตัวเลือกจะลบเขตข้อมูลผสานทั้งหมด รวมถึงย่อหน้าที่มี ออกจากเอกสารในระหว่างกระบวนการจดหมายเวียน สิ่งนี้มีประโยชน์เมื่อคุณต้องการกำจัดฟิลด์และข้อความที่เกี่ยวข้อง
...
###  อะไรคือความแตกต่างระหว่าง`REMOVE_EMPTY_FIELDS` and `REMOVE_UNUSED_FIELDS` cleanup options?
 ...
 ที่`REMOVE_EMPTY_FIELDS` ตัวเลือกนี้จะลบเขตข้อมูลผสานที่ไม่มีข้อมูลหรือว่างเปล่าในระหว่างกระบวนการจดหมายเวียน ในทางกลับกัน`REMOVE_UNUSED_FIELDS`ตัวเลือกจะลบเขตข้อมูลผสานที่ไม่ได้เติมข้อมูลในระหว่างการผสาน ตัวเลือกระหว่างพวกเขาขึ้นอยู่กับว่าคุณต้องการลบเขตข้อมูลที่ไม่มีเนื้อหาหรือเขตข้อมูลที่ไม่ได้ใช้ในการดำเนินการผสานเฉพาะ
