...
คู่มือนี้ครอบคลุมพื้นฐานการทำงานกับสไตล์และธีมใน Aspose.Words สำหรับ Java คุณได้เรียนรู้วิธีดึงข้อมูลและคัดลอกสไตล์ จัดการธีม และแทรกตัวคั่นสไตล์เพื่อสร้างเอกสารที่มีรูปลักษณ์น่าสนใจและมีการจัดรูปแบบที่ดี ทดลองใช้เทคนิคเหล่านี้เพื่อปรับแต่งเอกสารของคุณตามความต้องการของคุณ
...
### ฉันจะใช้ตัวคั่นสไตล์เพื่อสลับสไตล์ภายในย่อหน้าเดียวกันได้อย่างไร
 ...
 คุณสามารถแทรกตัวคั่นสไตล์ได้โดยใช้`insertStyleSeparator` วิธีการของ`DocumentBuilder` ชั้นเรียน