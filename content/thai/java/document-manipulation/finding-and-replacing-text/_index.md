---
title: การค้นหาและการแทนที่ข้อความใน Aspose.Words สำหรับ Java
...
### ตัวเลือก UseLegacyOrder มีไว้เพื่ออะไร?
 ...
 ที่`UseLegacyOrder` ตัวเลือกใน`FindReplaceOptions` อนุญาตให้คุณใช้ลำดับเดิมเมื่อดำเนินการค้นหาและแทนที่ สิ่งนี้อาจมีประโยชน์ในบางสถานการณ์ที่ต้องการลักษณะการทำงานของใบสั่งแบบเดิม