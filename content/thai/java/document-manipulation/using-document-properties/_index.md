...
### ฉันจะเข้าถึงคุณสมบัติเอกสารในตัวได้อย่างไร
 ...
 หากต้องการเข้าถึงคุณสมบัติเอกสารในตัวใน Aspose.Words สำหรับ Java คุณสามารถใช้`getBuiltInDocumentProperties` วิธีการบน`Document` วัตถุ วัตถุ เมธอดนี้จะส่งคืนคอลเลกชันของคุณสมบัติบิวท์อินที่คุณสามารถวนซ้ำได้
...
### ฉันจะแปลงระหว่างหน่วยการวัดที่แตกต่างกันใน Aspose.Words สำหรับ Java ได้อย่างไร
 ...
 คุณสามารถแปลงระหว่างหน่วยการวัดต่างๆ ใน Aspose.Words สำหรับ Java ได้โดยใช้`ConvertUtil` ชั้นเรียน โดยมีวิธีการแปลงหน่วยต่างๆ เช่น นิ้วเป็นจุด จุดเป็นเซนติเมตร และอื่นๆ