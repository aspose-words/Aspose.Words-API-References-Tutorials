...
shape2.setZOrder(0); // ส่งกลับครับ
```
...
### ฉันจะจัดเรียงรูปร่างตามลำดับเฉพาะได้อย่างไร
 ...
 คุณสามารถควบคุมลำดับของรูปร่างได้โดยใช้คุณสมบัติลำดับ Z ตั้งค่า`ZOrder` คุณสมบัติของรูปร่างเพื่อกำหนดตำแหน่งในกองรูปร่าง ค่าที่ต่ำกว่าจะถูกส่งไปยังด้านหลัง ในขณะที่ค่าที่สูงกว่าจะถูกส่งไปด้านหน้า