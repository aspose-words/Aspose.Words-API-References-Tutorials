...
## การจัดรูปแบบข้อความพื้นฐาน
 ...
 การจัดรูปแบบข้อความในเอกสาร Word ถือเป็นสิ่งสำคัญสำหรับการเน้นย้ำประเด็นสำคัญและปรับปรุงการอ่าน Aspose.Words ช่วยให้คุณสามารถใช้ตัวเลือกการจัดรูปแบบต่างๆ เช่น**bold**, *italic*, ขีดเส้นใต้ และขนาดตัวอักษร:
