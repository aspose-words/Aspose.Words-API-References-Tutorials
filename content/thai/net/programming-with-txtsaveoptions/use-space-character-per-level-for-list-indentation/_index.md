...
ในตัวอย่างนี้ เราสร้างเอกสารใหม่และใช้ DocumentBuilder เพื่อเพิ่มข้อความและสร้างรายการที่มีการเยื้องสามระดับ เราได้เพิ่มสามรายการลงในรายการ โดยแต่ละรายการจะมีระดับเพิ่มเติม

## การใช้อักขระช่องว่างหนึ่งตัวต่อระดับเพื่อระบุรายการ
...
ในตัวอย่างนี้ เราสร้างอินสแตนซ์ของ TxtSaveOptions และตั้งค่าคุณสมบัติ ListIndentation.Count เป็น 3 เพื่อระบุว่ามีการเยื้องสามระดับในรายการ นอกจากนี้เรายังตั้งค่าคุณสมบัติ ListIndentation Character ให้เป็นอักขระเว้นวรรค (' ') ที่เราต้องการใช้สำหรับการเยื้อง
...
namespace Example
{
     class Program
     {
         static void Main(string[] args)
         {
             ...
             // ใช้อักขระเว้นวรรคหนึ่งตัวต่อระดับเพื่อระบุรายการ
             TxtSaveOptions saveOptions = new TxtSaveOptions();
             saveOptions.ListIndentation.Count = 3;
             saveOptions.ListIndentation.Character = ' ';
...
คุณสามารถใช้หนึ่งช่องว่างต่อระดับสำหรับการเยื้องรายการโดยทำตามขั้นตอนเหล่านี้:
 ...
 บันทึกเอกสารด้วยตัวเลือกที่ระบุโดยใช้`Save` วิธีการของ`Document` ชั้นเรียน
...
#### ถาม: เป็นไปได้ไหมที่จะปรับแต่งจำนวนช่องว่างต่อระดับสำหรับการจัดวางรายการ?
 ได้ คุณสามารถกำหนดจำนวนช่องว่างต่อระดับสำหรับการเยื้องรายการได้โดยการเปลี่ยนค่าของ`ListIndentation.Count` ทรัพย์สินใน`TxtSaveOptions` ชั้นเรียน คุณสามารถระบุจำนวนช่องว่างที่คุณต้องการสำหรับการเยื้องแต่ละระดับได้

#### ถาม: Aspose.Words มีคุณสมบัติอื่นใดอีกบ้างสำหรับการจัดการรายการ
Aspose.Words นำเสนอคุณสมบัติมากมายสำหรับการจัดการรายการในเอกสาร Word คุณสามารถสร้างรายการที่เรียงลำดับเลขหรือสัญลักษณ์แสดงหัวข้อย่อย ตั้งค่าระดับการเยื้อง ปรับแต่งลักษณะของรายการ เพิ่มรายการ และอื่นๆ อีกมากมาย