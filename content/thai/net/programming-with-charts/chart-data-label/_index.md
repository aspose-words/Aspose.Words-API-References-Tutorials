...
## ขั้นตอนที่ 3: แทรกและกำหนดค่าแผนภูมิ
 แทรกแผนภูมิลงในเอกสารโดยใช้`InsertChart` วิธีการของ`DocumentBuilder` วัตถุ วัตถุ ตั้งค่าประเภทแผนภูมิและขนาดที่ต้องการ
...
## บทสรุป
ในบทช่วยสอนนี้ คุณได้เรียนรู้วิธีเพิ่มและปรับแต่งป้ายข้อมูลในแผนภูมิโดยใช้ Aspose.Words สำหรับ .NET โดยทำตามคำแนะนำทีละขั้นตอน คุณสามารถแทรกแผนภูมิ เข้าถึงคอลเลกชันป้ายชื่อข้อมูล และแก้ไขคุณสมบัติเพื่อปรับแต่งลักษณะที่ปรากฏของป้ายชื่อข้อมูลได้ Aspose.Words สำหรับ .NET มอบ API ที่มีประสิทธิภาพสำหรับการประมวลผลคำด้วยเอกสารและแผนภูมิ Word ทำให้คุณสามารถสร้างแผนภูมิที่ให้ข้อมูลและน่าสนใจด้วยภาพพร้อมป้ายชื่อข้อมูลที่ปรับแต่งได้
