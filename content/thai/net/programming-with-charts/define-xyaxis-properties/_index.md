...
โดยเข้าไปที่`ChartAxis` ออบเจ็กต์ที่เกี่ยวข้องกับแผนภูมิ คุณสามารถแก้ไขคุณสมบัติได้ เช่น ประเภทหมวดหมู่ กากบาทของแกน เครื่องหมายถูก ตำแหน่งป้ายกำกับ การปรับขนาด และอื่นๆ ความยืดหยุ่นนี้ช่วยให้คุณสามารถปรับแต่งรูปลักษณ์และการทำงานของแกนของแผนภูมิเพื่อนำเสนอข้อมูลของคุณได้อย่างมีประสิทธิภาพ
...
ใช่ Aspose.Words สำหรับ .NET ช่วยให้คุณสามารถบันทึกเอกสารแผนภูมิในรูปแบบต่างๆ เช่น DOCX, PDF, HTML และอื่นๆ อีกมากมาย คุณสามารถเลือกรูปแบบที่เหมาะสมได้ตามความต้องการและการใช้งานของคุณ`Save` วิธีการของ`Document` วัตถุเพื่อบันทึกเอกสาร
