...
ใช่ Aspose.Words สำหรับ .NET อนุญาตให้คุณใช้รูปแบบตัวเลขที่แตกต่างกันกับป้ายกำกับข้อมูลแต่ละรายการภายในชุดข้อมูลเดียวกัน โดยเข้าไปที่`DataLabels` คอลเลกชันที่เกี่ยวข้องกับซีรีส์ คุณสามารถตั้งค่าได้`FormatCode` คุณสมบัติของแต่ละป้ายข้อมูลเพื่อระบุรูปแบบตัวเลขที่ต้องการ ซึ่งช่วยให้คุณสามารถนำเสนอค่าตัวเลขในรูปแบบที่แตกต่างกันภายในแผนภูมิเดียวกันได้
...
ใช่ Aspose.Words สำหรับ .NET ช่วยให้คุณสามารถบันทึกเอกสารที่มีแผนภูมิพร้อมป้ายข้อมูลที่จัดรูปแบบในรูปแบบต่างๆ เช่น DOCX, PDF, HTML และอื่นๆ คุณสามารถเลือกรูปแบบที่เหมาะสมได้ตามความต้องการและการใช้งานของคุณ`Save` วิธีการของ`Document` วัตถุเพื่อบันทึกเอกสาร ป้ายข้อมูลที่จัดรูปแบบจะถูกบันทึกลงในเอกสารที่บันทึกไว้