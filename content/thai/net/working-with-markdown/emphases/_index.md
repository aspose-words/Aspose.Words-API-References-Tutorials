...
## ขั้นตอนที่ 1: การเริ่มต้นเอกสาร
 ...
 ขั้นแรก เราจะเริ่มต้นเอกสารโดยการสร้างอินสแตนซ์ของ`Document` ระดับ.
...
#### ถาม: ฉันจะเน้นข้อความโดยใช้ Markdown ได้อย่างไร
 ...
 ตอบ: หากต้องการเน้นข้อความโดยใช้ Markdown เพียงล้อมรอบข้อความด้วยสัญลักษณ์ที่เหมาะสม ใช้`*` หรือ`_` สำหรับตัวเอียง`**` หรือ`__` สำหรับตัวหนาและ`~~` สำหรับการขีดทับ
