...
#### ถาม: ฉันจะปรับขนาดรูปภาพใน Aspose.Words ได้อย่างไร
 ...
 ตอบ: หากต้องการปรับขนาดรูปภาพใน Aspose.Words คุณสามารถใช้`Width` และ`Height` คุณสมบัติของ`Shape` วัตถุ.

#### ถาม: ฉันสามารถใช้ฟิลเตอร์กับรูปภาพใน Aspose.Words ได้หรือไม่

 ตอบ: ได้ คุณสามารถใช้ฟิลเตอร์กับรูปภาพใน Aspose.Words ได้ ตัวอย่างเช่น คุณสามารถใช้ฟิลเตอร์เบลอกับรูปภาพได้โดยใช้`ApplyGaussianBlur` วิธีการของ`Shape` วัตถุ.

#### ถาม: ฉันจะแทนที่รูปภาพหนึ่งด้วยรูปภาพอื่นใน Aspose.Words ได้อย่างไร

 ตอบ: หากต้องการแทนที่รูปภาพหนึ่งด้วยรูปภาพอื่นใน Aspose.Words คุณสามารถใช้`Replace` วิธีการของ`Shape` ระดับ. วิธีการนี้ใช้เป็นพารามิเตอร์`Shape` วัตถุของภาพที่จะถูกแทนที่และ`Shape` วัตถุของภาพใหม่