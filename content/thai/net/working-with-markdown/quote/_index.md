...
## ขั้นตอนที่ 3: การสร้างสไตล์สำหรับระดับที่ซ้อนกัน
 ...
 เราสามารถสร้างสไตล์สำหรับระดับที่ซ้อนกันโดยใช้`Styles.Add` วิธีการของ`Document` วัตถุ วัตถุ ในตัวอย่างนี้ เรากำลังสร้างสไตล์ที่เรียกว่า "Quote1" เพื่อแสดงระดับใบเสนอราคาที่ซ้อนกัน
