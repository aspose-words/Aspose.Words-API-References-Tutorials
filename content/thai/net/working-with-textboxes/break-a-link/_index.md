...
ตอบ: หรือคุณสามารถทำลายลิงก์เปลี่ยนเส้นทางได้โดยการตั้งค่า`Next` คุณสมบัติของกล่องข้อความถึง`null`- วิธีนี้จะลบการเชื่อมต่อกับรูปร่างถัดไปอย่างมีประสิทธิภาพ
