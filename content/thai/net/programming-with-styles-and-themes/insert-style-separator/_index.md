...
ในขั้นตอนนี้ เราจะสร้างใหม่`Document` วัตถุและสิ่งที่เกี่ยวข้อง`DocumentBuilder` วัตถุ วัตถุ
...
ในขั้นตอนนี้ เราตั้งค่าลักษณะย่อหน้าเป็น "หัวเรื่อง 1" เขียนข้อความด้วยลักษณะนี้ จากนั้นแทรกตัวคั่นลักษณะ จากนั้นเราตั้งค่าสไตล์ย่อหน้าเป็นสไตล์ที่เรากำหนดเอง “MyParaStyle” และเขียนข้อความด้วยสไตล์นี้
...
#### ฉันจะสร้างและกำหนดค่าสไตล์ที่กำหนดเองได้อย่างไร
 ...
 หากต้องการสร้างสไตล์ที่กำหนดเอง คุณสามารถใช้`Styles.Add` วิธีการของ`Document` วัตถุ วัตถุ ระบุประเภทสไตล์ (เช่น`StyleType.Paragraph`) และระบุชื่อสำหรับสไตล์ เมื่อสร้างแล้ว คุณสามารถแก้ไขคุณสมบัติแบบอักษรของวัตถุสไตล์เพื่อกำหนดค่าลักษณะที่ปรากฏได้

#### ฉันจะแทรกตัวคั่นสไตล์ได้อย่างไร

 หากต้องการแทรกตัวคั่นสไตล์ คุณสามารถใช้`InsertStyleSeparator` วิธีการของ`DocumentBuilder` วัตถุ วัตถุ วิธีนี้จะแทรกตัวคั่นที่ทำเครื่องหมายจุดสิ้นสุดของสไตล์ของย่อหน้าก่อนหน้าและจุดเริ่มต้นของสไตล์ของย่อหน้าถัดไป

#### ฉันจะใช้สไตล์ที่แตกต่างกันกับส่วนต่างๆ ของข้อความได้อย่างไร

 คุณสามารถใช้สไตล์ที่แตกต่างกันกับส่วนต่างๆ ของข้อความได้โดยการตั้งค่า`ParagraphFormat.StyleName` ทรัพย์สินของ`DocumentBuilder`วัตถุ วัตถุ ก่อนที่จะเขียนข้อความ คุณสามารถตั้งชื่อสไตล์ให้เป็นสไตล์ที่ต้องการได้ และข้อความต่อไปนี้จะถูกจัดรูปแบบตามนั้น
