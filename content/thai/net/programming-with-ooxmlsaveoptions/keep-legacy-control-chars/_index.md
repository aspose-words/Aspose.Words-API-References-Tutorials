---
title: เก็บแผนภูมิควบคุมแบบเดิม
linktitle: เก็บแผนภูมิควบคุมแบบเดิม
...
```
 ...
 ในขั้นตอนนี้ เรากำหนดค่าตัวเลือกการบันทึก OOXML โดยการสร้างตัวเลือกใหม่`OoxmlSaveOptions` วัตถุ วัตถุ เราระบุรูปแบบการบันทึกที่ต้องการ (ที่นี่`FlatOpc` ) และเปิดใช้งาน`KeepLegacyControlChars` ตัวเลือกในการเก็บอักขระควบคุมแบบเดิม
...
รู้สึกอิสระที่จะรวมฟังก์ชันนี้เข้ากับโปรเจ็กต์ Aspose.Words สำหรับ .NET ของคุณเพื่อความสมบูรณ์และการรักษาอักขระควบคุมแบบเดิมในเอกสารของคุณ