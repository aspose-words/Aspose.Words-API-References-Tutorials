...
```
 ...
 ในขั้นตอนนี้ เรากำหนดค่าตัวเลือกการบันทึก OOXML โดยการสร้างตัวเลือกใหม่`OoxmlSaveOptions` วัตถุ. เราระบุรหัสผ่านที่ต้องการเพื่อเข้ารหัสเอกสารโดยตั้งค่า`Password` คุณสมบัติเป็นรหัสผ่านที่คุณกำหนดเอง
