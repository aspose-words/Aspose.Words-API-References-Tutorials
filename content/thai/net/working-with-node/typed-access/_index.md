...
#### ถาม: การเข้าถึงแบบพิมพ์มีข้อดีมากกว่าการเข้าถึงแบบไม่ได้พิมพ์อย่างไร
...
ตอบ: ด้วยการเข้าถึงแบบพิมพ์ใน Node.js คุณสามารถเข้าถึงโหนดประเภทต่างๆ ได้ เช่น โหนดองค์ประกอบ โหนดข้อความ โหนดแอตทริบิวต์ ฯลฯ โหนดแต่ละประเภทมีวิธีการและคุณสมบัติเฉพาะของตนเองในการเข้าถึงคุณลักษณะและค่าของมัน
