...
1.  หลังจากแทรกบรรทัดลายเซ็นแล้ว ให้เข้าถึง`ProviderId` ทรัพย์สินของ`SignatureLine` วัตถุ.
...
ตอบ: ได้ คุณสามารถระบุ ID ผู้ให้บริการเฉพาะสำหรับแต่ละบรรทัดลายเซ็นในเอกสาร Word ได้ หลังจากแทรกบรรทัดลายเซ็นแต่ละบรรทัดแล้ว คุณสามารถตั้งค่า ID ผู้ให้บริการสำหรับบรรทัดลายเซ็นนั้นๆ ได้โดยเข้าไปที่`ProviderId` ทรัพย์สินของบุคคลนั้น ๆ`SignatureLine` วัตถุ.

#### ถาม: ฉันจะบันทึกเอกสารที่แก้ไขได้อย่างไรหลังจากสร้างบรรทัดลายเซ็นใหม่และตั้งค่า ID ผู้ให้บริการแล้ว

 ตอบ: หากต้องการบันทึกเอกสารที่แก้ไขหลังจากสร้างบรรทัดลายเซ็นใหม่และตั้งค่า ID ผู้ให้บริการ คุณสามารถใช้`Save` วิธีการของ`Document` วัตถุ. ระบุเส้นทางและชื่อไฟล์ที่ถูกต้องเพื่อบันทึกเอกสาร
