...
###  จำเป็นต้องใช้ก`.pfx` file for the certificate?
 ใช่`.pfx` ไฟล์เป็นรูปแบบทั่วไปสำหรับการจัดเก็บข้อมูลการเข้ารหัสรวมถึงใบรับรองและคีย์ส่วนตัว
