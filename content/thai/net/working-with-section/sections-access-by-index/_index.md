...
## ขั้นตอนที่ 2: โหลดเอกสารและข้ามไปยังส่วนตามดัชนี
 ต่อไปเราจะโหลดเอกสาร Word ลงในอินสแตนซ์ของ`Document` ชั้นเรียน ในการเข้าถึงส่วนใดส่วนหนึ่งโดยเฉพาะ เราใช้ดัชนีส่วน ในตัวอย่างนี้ เราเข้าถึงส่วนแรกโดยใช้ดัชนี 0
...
## ขั้นตอนที่ 3: แก้ไขการตั้งค่าส่วน
 หากต้องการแก้ไขการตั้งค่าส่วน เราใช้คุณสมบัติของส่วนนั้น`PageSetup`วัตถุ วัตถุ ในตัวอย่างนี้ เรากำลังเปลี่ยนระยะขอบ ระยะห่างของส่วนหัวและส่วนท้าย และระยะห่างของคอลัมน์ข้อความ
...
#### ถาม: ฉันจะเปลี่ยนการตั้งค่าส่วนใน Aspose.Words สำหรับ .NET ได้อย่างไร
 ...
 ตอบ: หากต้องการแก้ไขการตั้งค่าของส่วน คุณสามารถใช้คุณสมบัติของส่วนได้`PageSetup`วัตถุ วัตถุ ในตัวอย่างนี้ เรากำลังเปลี่ยนระยะขอบ ระยะห่างของส่วนหัวและส่วนท้าย และระยะห่างของคอลัมน์ข้อความ
