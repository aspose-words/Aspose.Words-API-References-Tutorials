...
### สร้างเอกสารใหม่
 ...
 ในไฟล์โปรแกรมหลักของคุณ ให้เริ่มต้นด้วยการสร้างอินสแตนซ์ใหม่ของ`Document`ชั้นเรียน นี่จะเป็นผืนผ้าใบเปล่าของเรา
...
### เริ่มต้น DocumentBuilder
 ...
 จากนั้นสร้างอินสแตนซ์ของ`DocumentBuilder` ชั้นเรียน เครื่องมือสร้างนี้จะช่วยให้เราแทรกองค์ประกอบลงในเอกสารของเรา
...
### บันทึกเอกสาร
 ...
 สุดท้ายให้บันทึกเอกสารโดยใช้ไฟล์`Save` วิธีการของ`Document` ชั้นเรียน
