...
-  Aspose.Words สำหรับ .NET: คว้ามันมาจาก[ลิงค์ดาวน์โหลด](https://releases.aspose.com/words/net/).
...
```
 ...
 ตอนนี้คุณสามารถเปิดเอกสารที่อัปเดตแล้วและดูข้อความ "นี่คือบุ๊กมาร์ก" หลังจากนั้น`MyBookmark1`.
