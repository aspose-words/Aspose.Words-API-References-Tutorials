...
-  Aspose.Words for .NET Library: หากคุณยังไม่ได้ดาวน์โหลด ให้ดาวน์โหลดจาก[ที่นี่](https://releases.aspose.com/words/net/) - คุณยังสามารถเลือกใช้ก[ทดลองใช้ฟรี](https://releases.aspose.com/) หากคุณกำลังสำรวจห้องสมุด
...
```
 ...
 บรรทัดนี้เริ่มต้นอินสแตนซ์ใหม่ของ`Document` ชั้นเรียนโดยให้เอกสารเปล่ามาให้เราทำงานด้วย
...
### ฉันจะรับ Aspose.Words สำหรับ .NET ได้อย่างไร
 ...
 คุณสามารถดาวน์โหลด Aspose.Words สำหรับ .NET ได้จาก[เว็บไซต์](https://releases.aspose.com/words/net/) - นอกจากนี้ยังมีตัวเลือกสำหรับ[ทดลองใช้ฟรี](https://releases.aspose.com/) หากคุณต้องการสำรวจคุณลักษณะต่างๆ ของมัน
