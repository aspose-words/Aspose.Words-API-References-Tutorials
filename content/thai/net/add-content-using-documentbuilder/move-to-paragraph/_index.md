...
## ขั้นตอนที่ 2: เริ่มต้น DocumentBuilder
 ...
 ต่อไปเราจะเริ่มต้น a`DocumentBuilder` วัตถุ วัตถุ ให้คิดว่านี่คือปากกาดิจิทัลของคุณที่จะช่วยคุณนำทางและปรับเปลี่ยนเอกสาร
...
### ฉันสามารถแทรกเนื้อหาประเภทอื่นหลังจากย้ายไปยังย่อหน้าได้หรือไม่
 อย่างแน่นอน! คุณสามารถแทรกข้อความ รูปภาพ ตาราง และอื่นๆ ได้โดยใช้`DocumentBuilder` ชั้นเรียน
