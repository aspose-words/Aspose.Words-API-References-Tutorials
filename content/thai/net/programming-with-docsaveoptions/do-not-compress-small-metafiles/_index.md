...
การบีบอัดข้อมูลเมตาในเอกสารเป็นคุณสมบัติทั่วไปเมื่อประมวลผล Words ด้วยไฟล์ในแอปพลิเคชัน C# อย่างไรก็ตาม อาจไม่จำเป็นต้องบีบอัดข้อมูลเมตาของไฟล์ขนาดเล็กเพื่อรักษาคุณภาพ ในคำแนะนำทีละขั้นตอนนี้ เราจะแสดงวิธีใช้ซอร์สโค้ด C# ของ Aspose.Words for .NET เพื่อเปิดใช้งานฟีเจอร์ "Do Not Compress Small Metafiles" ในตัวเลือกการบันทึกเอกสาร
