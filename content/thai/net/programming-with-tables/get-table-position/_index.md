...
```
 ...
 ที่นี่เราใช้เงื่อนไขเพื่อตรวจสอบว่าอาร์เรย์เป็นแบบโฟลตหรือไม่ ถ้าเป็นเช่นนั้นเราจะพิมพ์`RelativeHorizontalAlignment` และ`RelativeVerticalAlignment` คุณสมบัติในการรับการจัดแนวสัมพัทธ์ในแนวนอนและแนวตั้งของตาราง มิฉะนั้นเราจะพิมพ์`Alignment` คุณสมบัติเพื่อรับการจัดตำแหน่งอาร์เรย์
