...
```
 ...
 ในที่นี้เราใช้`GetChildNodes` วิธีการรับตารางทั้งหมดในเอกสาร แล้วเราก็ใช้`IndexOf` เพื่อค้นหาดัชนีของตารางเฉพาะในกลุ่มของตารางทั้งหมด เราก็ใช้เหมือนกัน`IndexOf` เพื่อค้นหาดัชนีของแถวสุดท้ายในตาราง และ`IndexOf` ภายในแถวเพื่อค้นหาดัชนีของเซลล์ที่ต้องการ
