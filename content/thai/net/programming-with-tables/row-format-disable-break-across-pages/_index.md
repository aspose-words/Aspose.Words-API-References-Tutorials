...
```
 ...
 ที่นี่เราใช้เอกสารเพื่อดึงข้อมูลตารางแรก จากนั้นวนซ้ำแถวทั้งหมดในตารางโดยใช้ foreach loop ภายในลูป เราปิดการใช้งานการแบ่งแถวสำหรับแต่ละแถวโดยตั้งค่า`RowFormat.AllowBreakAcrossPages`ทรัพย์สินเพื่อ`false`.
