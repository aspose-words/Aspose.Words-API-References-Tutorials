...
ที่นี่เราใช้เอกสารเพื่อดึงข้อมูลตารางแรก จากนั้นเราเปิดใช้งานตารางอัตโนมัติที่พอดีกับ`AllowAutoFit` คุณสมบัติ. จากนั้นเราจะดึงข้อมูลเซลล์แรกจากแถวแรกของตาราง จากเซลล์นี้ เราสามารถดึงข้อมูลประเภทความกว้างที่ต้องการได้ด้วย`PreferredWidth.Type` ทรัพย์สินและมูลค่าของมันด้วย`PreferredWidth.Value` คุณสมบัติ.
