...
```
 ...
 ในที่นี้เราใช้`AbsoluteHorizontalDistance` คุณสมบัติเพื่อกำหนดระยะห่างแนวนอนสัมบูรณ์ของตารางจากขอบด้านซ้ายของหน้า เรายังใช้`RelativeVerticalAlignment` คุณสมบัติในการตั้งค่าการจัดตำแหน่งแนวตั้งที่สัมพันธ์กันของตารางกับเนื้อหาโดยรอบ
