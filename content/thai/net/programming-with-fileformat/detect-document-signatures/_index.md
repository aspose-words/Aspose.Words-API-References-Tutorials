...
## ขั้นตอนที่ 3: ตรวจสอบลายเซ็นดิจิทัล
 ...
 เราตรวจสอบว่าเอกสารมีลายเซ็นดิจิทัลหรือไม่โดยใช้`HasDigitalSignature` ทรัพย์สินของ`FileFormatInfo` วัตถุ วัตถุ หากตรวจพบลายเซ็นดิจิทัล เราจะแสดงข้อความที่ระบุว่าลายเซ็นจะหายไปหากเอกสารถูกเปิด/บันทึกด้วย Aspose.Words
...
นั่นคือทั้งหมด! คุณตรวจพบลายเซ็นดิจิทัลในเอกสารโดยใช้ Aspose.Words สำหรับ .NET ได้สำเร็จ
...
เมื่อคุณเปิดหรือบันทึกเอกสารด้วย Aspose.Words ลายเซ็นดิจิทัลที่มีอยู่ในเอกสารจะหายไป นี่เป็นเพราะการเปลี่ยนแปลงที่เกิดขึ้นกับเอกสารขณะประมวลผลด้วย Aspose.Words หากคุณต้องการรักษาลายเซ็นดิจิทัล คุณควรนำสิ่งนี้ไปไว้ในบัญชีที่มีอยู่ของคุณ และใช้วิธีอื่นในการจัดการเอกสารลายเซ็นดิจิทัล
