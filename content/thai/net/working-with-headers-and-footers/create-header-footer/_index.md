...
### คำถามที่ 3: ฉันจะตั้งค่าส่วนหัวและส่วนท้ายที่แตกต่างกันสำหรับหน้าแรกได้อย่างไร
 ...
 คุณสามารถตั้งค่าส่วนหัวและส่วนท้ายที่แตกต่างกันสำหรับหน้าแรกได้โดยใช้`DifferentFirstPageHeaderFooter` ทรัพย์สินของ`PageSetup` ชั้นเรียน
...
### คำถามที่ 5: Aspose.Words รองรับหรือไม่
 ...
 ใช่ Aspose ให้การสนับสนุนผ่านพวกเขา[ฟอรั่มการสนับสนุน](https://forum.aspose.com/c/words/8).
