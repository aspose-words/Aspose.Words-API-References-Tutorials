...
บทความนี้ให้คำแนะนำทีละขั้นตอนเกี่ยวกับวิธีการใช้การบีบอัดรูปภาพในฟีเจอร์เอกสาร PDF ด้วย Aspose.Words สำหรับ .NET เราจะอธิบายโค้ดแต่ละส่วนอย่างละเอียด ในตอนท้ายของบทช่วยสอนนี้ คุณจะสามารถเข้าใจวิธีบีบอัดรูปภาพในเอกสารและสร้าง PDF ด้วยการบีบอัดรูปภาพที่เหมาะสม
...
## ขั้นตอนที่ 3: กำหนดค่าตัวเลือกบันทึกเป็น PDF ด้วยการบีบอัดรูปภาพ
 ...
 ในการบีบอัดรูปภาพเมื่อแปลงเป็น PDF เราจำเป็นต้องกำหนดค่า`PdfSaveOptions` วัตถุ. เราสามารถตั้งค่าประเภทการบีบอัดภาพ คุณภาพ JPEG และตัวเลือกการปฏิบัติตาม PDF อื่นๆ ได้ หากจำเป็น
...
นั่นคือทั้งหมดที่ ! คุณบีบอัดรูปภาพในเอกสารได้สำเร็จและสร้าง PDF ด้วยการบีบอัดรูปภาพที่เหมาะสมโดยใช้ Aspose.Words สำหรับ .NET
