...
บทความนี้ให้คำแนะนำทีละขั้นตอนเกี่ยวกับวิธีการใช้ฟีเจอร์นี้เพื่อปรับขนาด PDF ให้เหมาะสมโดยการข้ามฟอนต์ Arial และ Times Roman ที่ฝังไว้เป็นขนาด metafile ด้วย Aspose.Words สำหรับ .NET เราจะอธิบายโค้ดแต่ละส่วนอย่างละเอียด ในตอนท้ายของบทช่วยสอนนี้ คุณจะสามารถเข้าใจวิธีกำหนดค่าตัวเลือกโหมดการฝังแบบอักษรในเอกสาร และสร้าง PDF โดยไม่ต้องฝังแบบอักษร Arial และ Times Roman
