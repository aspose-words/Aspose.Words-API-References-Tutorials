...
บทความนี้ให้คำแนะนำทีละขั้นตอนเกี่ยวกับวิธีการใช้ตัวเลือกเค้าร่างการตั้งค่าคุณลักษณะขนาด metafile ด้วย Aspose.Words สำหรับ .NET เราจะอธิบายโค้ดแต่ละส่วนอย่างละเอียด ในตอนท้ายของบทช่วยสอนนี้ คุณจะสามารถเข้าใจวิธีตั้งค่าตัวเลือกเค้าร่างในเอกสารและสร้าง PDF ที่มีตัวเลือกเค้าร่างที่เกี่ยวข้องได้
