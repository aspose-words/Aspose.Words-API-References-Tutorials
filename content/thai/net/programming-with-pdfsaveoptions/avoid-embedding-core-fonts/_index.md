...
ในบทช่วยสอนนี้ เราจะอธิบายขั้นตอนต่างๆ ในการลดขนาดไฟล์ PDF โดยไม่ฝังแบบอักษรหลักด้วย Aspose.Words สำหรับ .NET คุณสมบัตินี้ช่วยให้คุณควบคุมได้ว่าจะใช้แบบอักษรพื้นฐานเช่น Arial, Times New Roman เป็นต้น จะต้องฝังอยู่ใน PDF เมื่อแปลงเอกสาร Word ทำตามขั้นตอนด้านล่าง:
...
การลดขนาดไฟล์ PDF: ด้วยการหลีกเลี่ยงการฝังแบบอักษรที่มีอยู่ทั่วไป เช่น Arial, Times New Roman ฯลฯ ขนาดไฟล์ PDF จะลดลง ทำให้จัดเก็บ แชร์ และถ่ายโอนไฟล์ได้ง่ายขึ้น
