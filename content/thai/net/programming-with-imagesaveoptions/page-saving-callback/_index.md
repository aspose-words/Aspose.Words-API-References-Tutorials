...
```
 ...
 ในขั้นตอนนี้ เรากำหนดค่าตัวเลือกการบันทึกรูปภาพโดยสร้างตัวเลือกใหม่`ImageSaveOptions` วัตถุ วัตถุ เราระบุรูปแบบการสำรองข้อมูลที่ต้องการ ที่นี่ "Png" สำหรับรูปแบบ PNG เราใช้`PageSet` หากต้องการระบุช่วงของหน้าที่จะบันทึก ที่นี่ตั้งแต่หน้าแรกจนถึงหน้าสุดท้ายของเอกสาร (`doc.PageCount - 1` เรายังตั้ง`PageSavingCallback` ถึงตัวอย่างของ`HandlePageSavingCallback`ซึ่งเป็นคลาสที่กำหนดเองเพื่อจัดการการโทรกลับการบันทึกเพจ
