...
```
 ...
 ในขั้นตอนนี้ เราจะกำหนดค่าตัวเลือกการสำรองข้อมูลสำหรับรูปภาพ เราสร้างใหม่`ImageSaveOptions` วัตถุที่ระบุรูปแบบการบันทึกที่ต้องการ ที่นี่ "Jpeg" สำหรับรูปแบบ JPEG นอกจากนี้เรายังกำหนดช่วงของหน้าที่จะแปลงโดยใช้`PageSet`วัตถุ วัตถุ สุดท้ายเราปรับความสว่างและคอนทราสต์ของภาพโดยใช้`ImageBrightness` และ`ImageContrast` คุณสมบัติตามลำดับ นอกจากนี้เรายังเปลี่ยนความละเอียดแนวนอนโดยใช้`HorizontalResolution` คุณสมบัติ.
