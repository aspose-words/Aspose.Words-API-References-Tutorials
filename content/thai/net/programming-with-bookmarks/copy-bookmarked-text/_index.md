...
#### ถาม: จะรับเนื้อหาของบุ๊กมาร์กเฉพาะในเอกสารต้นฉบับโดยใช้ Aspose.Words สำหรับ .NET ได้อย่างไร
 ...
 ตอบ: หากต้องการรับเนื้อหาของบุ๊กมาร์กเฉพาะในเอกสารต้นทางโดยใช้ Aspose.Words สำหรับ .NET คุณสามารถเข้าถึง`Bookmarks` คุณสมบัติของช่วงเอกสารต้นทาง และใช้ชื่อบุ๊กมาร์กเพื่อดึงข้อมูลบุ๊กมาร์กเฉพาะ นี่คือโค้ดตัวอย่าง:
