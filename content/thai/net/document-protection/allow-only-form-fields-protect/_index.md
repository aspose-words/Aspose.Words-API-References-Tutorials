...
2.  แทรกส่วนและข้อความลงในเอกสารของคุณโดยใช้`DocumentBuilder` ระดับ.
...
4.  บันทึกเอกสารที่ได้รับการป้องกันโดยใช้`Save` วิธีการของ`Document` ระดับ.
...
#### ถาม: ฉันสามารถลบการป้องกันเอกสารออกจากเอกสารที่ได้รับการป้องกันได้หรือไม่
 ...
 ตอบ: ได้ คุณสามารถลบการป้องกันเอกสารออกจากเอกสารที่ได้รับการป้องกันได้โดยใช้ Aspose.Words สำหรับ .NET หากต้องการลบการป้องกัน คุณสามารถใช้`Unprotect` วิธีการของ`Document` และระบุรหัสผ่านที่ถูกต้อง การดำเนินการนี้จะลบการป้องกันและอนุญาตให้แก้ไขเอกสารได้ไม่จำกัด
