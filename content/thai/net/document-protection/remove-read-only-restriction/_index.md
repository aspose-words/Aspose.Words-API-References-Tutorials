...
1.  สร้างอินสแตนซ์ของ`Document` class และตั้งรหัสผ่านสำหรับเอกสารโดยใช้`SetPassword` วิธีการของ`WriteProtection` วัตถุ วัตถุ
...
4.  บันทึกเอกสารโดยไม่มีข้อจำกัดแบบอ่านอย่างเดียวโดยใช้`Save` วิธีการของ`Document` วัตถุ วัตถุ
