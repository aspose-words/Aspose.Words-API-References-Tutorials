...
ในบทช่วยสอนนี้ เราจะแนะนำคุณตลอดกระบวนการทีละขั้นตอนเพื่อตั้งค่าระยะขอบของเซลล์ตารางโดยใช้ Aspose.Words สำหรับ .NET เราจะอธิบายซอร์สโค้ด C# ที่ให้มาและให้คำแนะนำที่ครอบคลุมเพื่อช่วยให้คุณเข้าใจและนำคุณสมบัตินี้ไปใช้ในโครงการของคุณเอง ในตอนท้ายของบทช่วยสอนนี้ คุณจะรู้วิธีปรับระยะขอบซ้าย บน ขวา และล่าง (ช่องว่าง) ของเนื้อหาเซลล์ในตารางในเอกสาร Word โดยใช้ Aspose.Words สำหรับ .NET
...
## ขั้นตอนที่ 4: ตั้งค่าระยะขอบของเซลล์
 ตอนนี้เราสามารถตั้งค่าระยะขอบของเซลล์โดยใช้`SetPaddings()` วิธีการของ`CellFormat` วัตถุ วัตถุ ขอบถูกกำหนดเป็นจุดและระบุตามลำดับซ้าย บน ขวา และล่าง
