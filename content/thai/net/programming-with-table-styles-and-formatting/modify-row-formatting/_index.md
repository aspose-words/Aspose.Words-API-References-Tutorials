...
## ขั้นตอนที่ 4: เปลี่ยนการจัดรูปแบบแถว
 ตอนนี้เราสามารถเปลี่ยนการจัดรูปแบบแถวโดยใช้คุณสมบัติของ`RowFormat` ระดับ. ตัวอย่างเช่น เราสามารถลบเส้นขอบ ตั้งค่าความสูงอัตโนมัติ และอนุญาตให้แบ่งบรรทัดได้
