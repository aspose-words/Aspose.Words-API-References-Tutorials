...
## ขั้นตอนที่ 2: โหลดเอกสารที่มีตาราง
 ถัดไป คุณจะต้องโหลดเอกสารที่มีตารางโดยใช้`Document` ชั้นเรียน อย่าลืมระบุเส้นทางเอกสารที่ถูกต้อง
...
## ขั้นตอนที่ 3: เข้าถึงตารางและตั้งชื่อและคำอธิบาย
 ตอนนี้คุณสามารถเข้าถึงตารางในเอกสารโดยใช้`GetChild()` วิธีการและ`Table` ชั้นเรียน จากนั้นตั้งชื่อตารางและคำอธิบายโดยใช้`Title` และ`Description` คุณสมบัติ.
...
## ขั้นตอนที่ 4: ตั้งค่าตัวเลือกการสำรองข้อมูล
 หากคุณต้องการระบุตัวเลือกการบันทึก คุณสามารถกำหนดค่าได้โดยใช้`OoxmlSaveOptions` ชั้นเรียน ในตัวอย่างนี้ เราได้ใช้`Compliance` ตัวเลือกในการระบุการปฏิบัติตามรูปแบบที่เข้มงวดของ ISO 29500:2008
...
## ขั้นตอนที่ 5: ปรับความเข้ากันได้ของเอกสารให้เหมาะสม
 คุณยังสามารถปรับความเข้ากันได้ของเอกสารให้เหมาะสมโดยใช้`OptimizeFor()` วิธีการของ`CompatibilityOptions` ชั้นเรียน ในตัวอย่างนี้ เราได้ปรับเอกสารให้เหมาะสมสำหรับ Word 2016
...
## ขั้นตอนที่ 6: บันทึกเอกสารที่แก้ไข
 สุดท้าย คุณสามารถบันทึกเอกสารที่แก้ไขลงในไฟล์ได้โดยใช้นามสกุลไฟล์`Save()` วิธีการของ`Document` ชั้นเรียน อย่าลืมระบุเส้นทางและชื่อไฟล์ที่ถูกต้อง
