...
## ขั้นตอนที่ 4: ตั้งค่าการจัดรูปแบบเซลล์
 ตอนนี้เราสามารถตั้งค่าการจัดรูปแบบเซลล์ได้โดยเข้าไปที่`CellFormat` วัตถุของ`DocumentBuilder` วัตถุ. เราสามารถกำหนดความกว้างของเซลล์และระยะขอบ (ช่องว่างภายใน) โดยใช้คุณสมบัติที่เกี่ยวข้อง
