...
## ขั้นตอนที่ 4: กำหนดการจัดรูปแบบเส้น
 ตอนนี้เราสามารถตั้งค่าการจัดรูปแบบแถวได้โดยเข้าไปที่`RowFormat` วัตถุของ`DocumentBuilder` วัตถุ วัตถุ เราสามารถตั้งค่าความสูงของเส้นและระยะขอบ (ช่องว่างภายใน) โดยใช้คุณสมบัติที่เกี่ยวข้อง
...
## ขั้นตอนที่ 5: ตั้งค่าระยะขอบของตาราง
 ต่อไปเราสามารถตั้งค่าช่องว่างภายในตารางได้โดยการเข้าถึงคุณสมบัติที่เกี่ยวข้องของ`Table` วัตถุ วัตถุ ระยะขอบเหล่านี้จะใช้กับทุกแถวของตาราง
