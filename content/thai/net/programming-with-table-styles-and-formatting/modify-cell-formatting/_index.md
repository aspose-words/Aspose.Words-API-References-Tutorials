...
## ขั้นตอนที่ 4: เปลี่ยนการจัดรูปแบบเซลล์
 ตอนนี้เราสามารถเปลี่ยนการจัดรูปแบบเซลล์โดยใช้คุณสมบัติของ`CellFormat` ระดับ. ตัวอย่างเช่น เราสามารถกำหนดความกว้างของเซลล์ การวางแนวข้อความ และสีพื้นหลังได้
