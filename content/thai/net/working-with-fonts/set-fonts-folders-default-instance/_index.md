...
#### ถาม: ฉันสามารถตั้งค่าโฟลเดอร์แบบอักษรเริ่มต้นหลายโฟลเดอร์ใน Aspose.Words ได้หรือไม่
 ...
 ตอบ: ได้ คุณสามารถตั้งค่าโฟลเดอร์แบบอักษรเริ่มต้นได้หลายโฟลเดอร์ใน Aspose.Words คุณเพียงแค่ต้องระบุตำแหน่งของโฟลเดอร์แบบอักษรที่กำหนดเองโดยใช้`SetFontsFolders` วิธีการของ`Fonts` ชั้นเรียน
...
ตอบ: ได้ โดยการตั้งค่าโฟลเดอร์ฟอนต์เริ่มต้น คุณสามารถใช้ฟอนต์แบบกำหนดเองในเอกสาร Word ของคุณได้ คุณเพียงแค่ต้องวางแบบอักษรในโฟลเดอร์ที่ระบุและ Aspose จะใช้แบบอักษรเหล่านี้เมื่อสร้างหรือจัดการเอกสาร