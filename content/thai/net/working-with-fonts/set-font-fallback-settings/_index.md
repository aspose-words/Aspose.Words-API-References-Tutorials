...
เมื่อทำงานกับเอกสารที่มีองค์ประกอบข้อความที่หลากหลาย เช่น ภาษาที่แตกต่างกันหรืออักขระพิเศษ จำเป็นอย่างยิ่งที่จะต้องแน่ใจว่าองค์ประกอบเหล่านี้แสดงอย่างถูกต้อง Aspose.Words สำหรับ .NET นำเสนอฟีเจอร์ที่มีประสิทธิภาพที่เรียกว่าการตั้งค่าทางเลือกแบบอักษร ซึ่งช่วยในการกำหนดกฎสำหรับการแทนที่แบบอักษรเมื่อแบบอักษรดั้งเดิมไม่รองรับอักขระบางตัว ในคู่มือนี้ เราจะสำรวจวิธีตั้งค่าการตั้งค่า Font Fallback โดยใช้ Aspose.Words สำหรับ .NET ในบทช่วยสอนทีละขั้นตอน
