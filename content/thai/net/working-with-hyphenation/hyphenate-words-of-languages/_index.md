...
description: เรียนรู้วิธีใส่ยัติภังค์คำในภาษาต่างๆในเอกสาร Word โดยใช้ Aspose.Words สำหรับ .NET
type: docs
weight: 10
url: /th/net/working-with-hyphenation/hyphenate-words-of-languages/
---

ในบทช่วยสอนทีละขั้นตอนนี้ เราจะแนะนำคุณเกี่ยวกับวิธีใส่ยัติภังค์ในภาษาต่างๆ ในเอกสาร Word โดยใช้ Aspose.Words สำหรับ .NET เราจะอธิบายซอร์สโค้ด C# ที่ให้มา และแสดงวิธีนำไปใช้ในโครงการของคุณเอง
...
ดังนั้น! คุณประมวลผลคำได้สำเร็จด้วยการใส่ยติภังค์ในภาษาต่าง ๆ ในเอกสาร Word โดยใช้ Aspose.Words สำหรับ .NET
