...
หากต้องการใช้ Aspose.Words สำหรับ .NET คุณต้องเพิ่มการอ้างอิงไปยังไลบรารีในโปรเจ็กต์ของคุณ คลิกขวาที่โฟลเดอร์ References ในโปรเจ็กต์ของคุณ เลือก “Add Reference” และเรียกดูตำแหน่งที่คุณติดตั้งไลบรารี Aspose.Words สำหรับ .NET เลือกเวอร์ชันที่เหมาะสมแล้วคลิก "ตกลง" เพื่อเพิ่มข้อมูลอ้างอิง
...
## ขั้นตอนที่ 5: บันทึกเอกสารที่แปลงแล้ว
 ...
 หากต้องการบันทึกเอกสารที่แปลงแล้วในรูปแบบ Docx คุณต้องเรียกไฟล์`Save` วิธีการบน`Document` วัตถุ วัตถุ ระบุเส้นทางและชื่อไฟล์สำหรับเอกสารเอาต์พุต ในตัวอย่างนี้ เราจะบันทึกเป็น`"BaseConversions.DocToDocx.docx"`- นี่คือข้อมูลโค้ด:
...
หากต้องการแปลงไฟล์ DOC เป็น DOCX โดยใช้ Aspose.Words สำหรับ .NET คุณสามารถทำตามขั้นตอนเหล่านี้:
 ...
 ติดตั้ง Aspose.Words สำหรับ .NET: เริ่มต้นด้วยการดาวน์โหลดและติดตั้ง Aspose.Words สำหรับ .NET จาก[กำหนด](https://releases.aspose.com/words/net/) หรือผ่านทาง NuGet
