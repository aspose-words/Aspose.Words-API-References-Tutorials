...
ตอบ: หากต้องการจัดสไตล์อ้างอิงท้ายเรื่องใน Aspose.Words คุณสามารถใช้`EndnoteOptions` ชั้นเรียนและ`SeparatorNoteTextStyle` คุณสมบัติ. คุณสามารถระบุรูปแบบตัวอักษร ขนาด สี ฯลฯ สำหรับอ้างอิงท้ายเรื่องโดยใช้คุณสมบัตินี้
...
#### ถาม: ฉันจะวางตำแหน่งอ้างอิงท้ายเรื่องในเอกสารได้อย่างไร
 ...
 ตอบ: หากต้องการวางตำแหน่งอ้างอิงท้ายเรื่องในเอกสาร คุณสามารถใช้`Position` ทรัพย์สินของ`EndnoteOptions` ชั้นเรียน คุณสามารถระบุได้ว่าควรวางอ้างอิงท้ายเรื่องไว้ที่ด้านล่างของแต่ละหน้า ที่ส่วนท้ายของแต่ละส่วน หรือที่ส่วนท้ายของเอกสาร
