...
ขณะนี้ เรากำลังใช้ตัวเลือกเริ่มต้น แต่คุณสามารถปรับแต่งตัวเลือกเหล่านี้ได้หากจำเป็น

## ขั้นตอนที่ 4: ดำเนินการเปลี่ยน Regex

 มาถึงส่วนที่สนุกแล้ว! เราจะใช้`Range.Replace` วิธีการแทนที่เหตุการณ์ "เศร้า" หรือ "บ้า" ทั้งหมดด้วย "ไม่ดี" โดยใช้นิพจน์ทั่วไป
