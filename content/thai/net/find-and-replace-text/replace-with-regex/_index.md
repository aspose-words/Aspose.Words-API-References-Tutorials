...
description: เรียนรู้วิธีดำเนินการแทนที่ข้อความด้วยนิพจน์ทั่วไปในเอกสาร Word ด้วย Aspose.Words สำหรับ .NET
type: docs
weight: 10
...
## ขั้นตอนที่ 3: การกำหนดค่าตัวเลือกค้นหาและแทนที่
 ...
 ตอนนี้เราจะกำหนดค่าตัวเลือกการค้นหาและแทนที่โดยใช้`FindReplaceOptions`วัตถุ วัตถุ ในตัวอย่างของเรา เราใช้ตัวเลือกเริ่มต้น:
...
ตอบ: ได้ คุณสามารถทำการแทนที่ข้อความที่ไม่คำนึงถึงขนาดตัวพิมพ์ได้โดยใช้นิพจน์ทั่วไปใน Aspose.Words สำหรับ .NET ตามค่าเริ่มต้น นิพจน์ทั่วไปใน .NET จะคำนึงถึงขนาดตัวพิมพ์ อย่างไรก็ตาม คุณสามารถแก้ไขลักษณะการทำงานได้โดยใช้การตั้งค่าสถานะ RegexOptions ที่เหมาะสมเมื่อสร้างวัตถุ Regex ของคุณ
