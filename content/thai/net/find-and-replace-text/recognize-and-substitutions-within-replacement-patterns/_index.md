...
## ขั้นตอนที่ 2: แทรกข้อความลงในเอกสาร
 ...
 เมื่อได้เอกสารแล้ว เราก็สามารถแทรกข้อความโดยใช้ a`DocumentBuilder` วัตถุ วัตถุ ในตัวอย่างของเรา เราใช้`Write` วิธีแทรกวลี "เจสันให้เงินแก่พอล" -
...
## ขั้นตอนที่ 3: การรับรู้และการทดแทนในรูปแบบการแทนที่
 ...
 ตอนนี้เราจะใช้`Range.Replace` ฟังก์ชั่นเพื่อค้นหาข้อความและแทนที่โดยใช้นิพจน์ทั่วไปเพื่อจดจำรูปแบบเฉพาะ ในตัวอย่างของเรา เราใช้นิพจน์ทั่วไป`([A-z]+) gives money to ([A-z]+)` เพื่อจดจำประโยคที่มีคนให้เงินกับคนอื่น เราใช้รูปแบบการแทนที่`$2 takes money from $1` เพื่อดำเนินการทดแทนโดยการกลับบทบาท การใช้งานของ`$1` และ`$2` หมายถึงกลุ่มที่ถูกจับโดยนิพจน์ทั่วไป:
...
#### ถาม: ฉันจะแทรกข้อความลงในเอกสารโดยใช้ Aspose.Words สำหรับ .NET ได้อย่างไร
 ...
 ตอบ: เมื่อคุณมีเอกสารแล้ว คุณสามารถแทรกข้อความโดยใช้ a`DocumentBuilder` วัตถุ วัตถุ ตัวอย่างเช่น หากต้องการแทรกวลี "Jason ให้เงินแก่ Paul" คุณสามารถใช้`Write` วิธี:
...
#### ถาม: ฉันจะใช้กลุ่มที่บันทึกไว้ในรูปแบบการแทนที่ระหว่างการค้นหาข้อความและแทนที่ใน Aspose.Words สำหรับ .NET ได้อย่างไร
 ...
 ตอบ: หากต้องการใช้กลุ่มที่บันทึกไว้ในรูปแบบการแทนที่ระหว่างการค้นหาข้อความและแทนที่ใน Aspose.Words สำหรับ .NET คุณสามารถเปิดใช้งาน`UseSubstitutions` ทรัพย์สินของ`FindReplaceOptions` วัตถุ วัตถุ ซึ่งจะทำให้คุณสามารถอ้างอิงถึงกลุ่มที่บันทึกไว้ได้โดยใช้`$1`, `$2`ฯลฯ ในรูปแบบการแทนที่:
...
#### ถาม: ซอร์สโค้ดตัวอย่างแสดงให้เห็นอะไรบ้างสำหรับฟีเจอร์ “รับรู้และการแทนที่ภายในรูปแบบการแทนที่” ใน Aspose.Words สำหรับ .NET
...
#### ถาม: ฉันสามารถใช้ฟีเจอร์ “รับรู้และการทดแทนภายในรูปแบบการแทนที่” กับภาษาอื่นที่ไม่ใช่ภาษาอังกฤษได้หรือไม่

ตอบ: ได้ คุณลักษณะ "การรับรู้และการทดแทนภายในรูปแบบการแทนที่" ใน Aspose.Words สำหรับ .NET สามารถใช้กับภาษาอื่นที่ไม่ใช่ภาษาอังกฤษได้ นิพจน์ทั่วไปไม่เชื่อเรื่องภาษาและสามารถสร้างให้ตรงกับรูปแบบเฉพาะในภาษาใดก็ได้ คุณสามารถปรับรูปแบบนิพจน์ทั่วไปให้เหมาะกับภาษาที่คุณต้องการและรูปแบบข้อความเฉพาะที่คุณต้องการจดจำและแทนที่ได้