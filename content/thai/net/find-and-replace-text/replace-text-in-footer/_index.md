...
## ขั้นตอนที่ 3: กำหนดค่าตัวเลือกการค้นหาและแทนที่
 ...
 ตอนนี้เราจะกำหนดค่าตัวเลือกการค้นหาและแทนที่โดยใช้`FindReplaceOptions` วัตถุ วัตถุ ในตัวอย่างของเรา เราได้ตั้งค่า`MatchCase` ถึง`false` เพื่อละเว้นตัวพิมพ์เมื่อค้นหาและ`FindWholeWordsOnly` ถึง`false` เพื่อให้สามารถค้นหาและแทนที่บางส่วนของคำได้:
...
#### ถาม: ฉันจะทำการแทนที่ข้อความในส่วนท้ายโดยใช้ Aspose.Words สำหรับ .NET ได้อย่างไร
...
ตอบ: ซอร์สโค้ดตัวอย่างสาธิตการใช้ฟีเจอร์ “แทนที่ข้อความในส่วนท้าย” ใน Aspose.Words สำหรับ .NET โดยจะแสดงวิธีการโหลดเอกสาร เข้าถึงส่วนท้าย กำหนดค่าตัวเลือกการค้นหาและแทนที่ ดำเนินการแทนที่ข้อความในส่วนท้าย และบันทึกเอกสารที่แก้ไข
