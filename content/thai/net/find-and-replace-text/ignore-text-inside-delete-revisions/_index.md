...
## ขั้นตอนที่ 2: การแทรกข้อความที่ไม่ได้รับการแก้ไขลงในเอกสาร
 ...
 เมื่อเรามีเอกสารแล้ว เราก็สามารถแทรกข้อความที่ยังไม่ได้ตรวจสอบได้โดยใช้`DocumentBuilder` วัตถุ วัตถุ ตัวอย่างเช่น หากต้องการแทรกข้อความ "ข้อความที่ถูกลบ" เราสามารถใช้`Writeln` และ`Write` วิธีการ:
...
## ขั้นตอนที่ 4: การใช้คุณสมบัติ "ละเว้นข้อความภายในการลบการแก้ไข"
 ...
 ตอนนี้เราได้เตรียมเอกสารของเราโดยการลบย่อหน้าแล้ว เราสามารถเปิดใช้งานฟีเจอร์ “ละเว้นข้อความภายในลบการแก้ไข” ได้โดยใช้`FindReplaceOptions` วัตถุ วัตถุ เราจะตั้งค่า`IgnoreDeleted`ทรัพย์สินเพื่อ`true`-
...
ต่อไปนี้เป็นซอร์สโค้ดตัวอย่างแบบเต็มเพื่อสาธิตการใช้งานฟีเจอร์ “ละเว้นข้อความภายในการลบการแก้ไข” กับ Aspose.Words สำหรับ .NET:
...
#### ถาม: จะสร้างเอกสารใหม่ใน Aspose.Words สำหรับ .NET ได้อย่างไร
 ...
 ตอบ: ก่อนที่คุณจะเริ่มจัดการข้อความในเอกสาร คุณต้องสร้างเอกสารใหม่โดยใช้ Aspose.Words สำหรับ .NET ซึ่งสามารถทำได้โดยการยกตัวอย่าง a`Document` วัตถุ วัตถุ นี่คือโค้ดตัวอย่างเพื่อสร้างเอกสารใหม่:
...
#### ถาม: จะแทรกข้อความที่ไม่ได้แก้ไขลงในเอกสารโดยใช้ Aspose.Words สำหรับ .NET ได้อย่างไร
 ...
 ตอบ: เมื่อคุณมีเอกสารแล้ว คุณสามารถแทรกข้อความที่ยังไม่ได้ตรวจสอบได้โดยใช้ a`DocumentBuilder` วัตถุ วัตถุ ตัวอย่างเช่น หากต้องการแทรกข้อความ "ข้อความที่ถูกลบ" คุณสามารถใช้`Writeln` และ`Write` วิธีการ:
...
ตอบ: เพื่อแสดงให้เห็นการใช้ฟังก์ชัน “ละเว้นข้อความภายในการลบการแก้ไข” เราจะลบย่อหน้าออกจากเอกสารโดยใช้การติดตามการแก้ไข สิ่งนี้จะทำให้เราเห็นว่าฟังก์ชันนี้ส่งผลต่อการดำเนินการครั้งต่อไปอย่างไร
...
#### ถาม: จะเปิดใช้งานฟีเจอร์ "ละเว้นข้อความภายในการลบการแก้ไข" ใน Aspose.Words สำหรับ .NET ได้อย่างไร
 ...
 ตอบ- ตอนนี้เราได้เตรียมเอกสารของเราโดยการลบย่อหน้าแล้ว เราสามารถเปิดใช้งานฟีเจอร์ "ละเว้นข้อความภายในลบการแก้ไข" ได้โดยใช้`FindReplaceOptions` วัตถุ วัตถุ เราจะตั้งค่า`IgnoreDeleted`ทรัพย์สินเพื่อ`true`:
