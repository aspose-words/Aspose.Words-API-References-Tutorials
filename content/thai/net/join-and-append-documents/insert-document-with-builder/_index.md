...
```
 ...
 ใช้`InsertDocument` วิธีเราสามารถแทรกเอกสารต้นทางทั้งหมดลงในเอกสารปลายทางได้ ที่`ImportFormatMode.KeepSourceFormatting` ช่วยให้มั่นใจได้ว่าการจัดรูปแบบของเอกสารต้นฉบับจะยังคงอยู่
...
หากต้องการข้อมูลเพิ่มเติม สามารถตรวจสอบได้ที่[เอกสารประกอบ](https://reference.aspose.com/words/net/) หรือเยี่ยมชมได้ที่[ฟอรั่มการสนับสนุน](https://forum.aspose.com/c/words/8) สำหรับความช่วยเหลือ.