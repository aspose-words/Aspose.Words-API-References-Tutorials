...
// บันทึกเอกสารที่มีฟิลด์ที่แปลงแล้วลงในดิสก์
doc.Save(dataDir + "WorkingWithFields.ConvertFieldsInDocument.docx");
```
...
ตอบ: ไม่ การแปลงฟิลด์ใน Aspose จะไม่ส่งผลต่อข้อมูลต้นฉบับในเอกสาร Word การแปลงจะถูกนำไปใช้เมื่ออัปเดตฟิลด์ แต่ข้อมูลเดิมยังคงอยู่ครบถ้วน เพื่อให้แน่ใจว่าคุณสามารถกลับสู่สถานะเดิมของเอกสารได้ตลอดเวลา
