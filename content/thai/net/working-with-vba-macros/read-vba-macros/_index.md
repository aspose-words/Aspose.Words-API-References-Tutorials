...
ตอบ: ในการเข้าถึงซอร์สโค้ดของแมโคร VBA ในเอกสาร Word คุณสามารถใช้ไฟล์`SourceCode` ทรัพย์สินที่เกี่ยวข้อง`VbaModule` วัตถุ. คุณสามารถวนซ้ำโมดูลทั้งหมดในโครงการ VBA และดูซอร์สโค้ดสำหรับแต่ละโมดูลได้
