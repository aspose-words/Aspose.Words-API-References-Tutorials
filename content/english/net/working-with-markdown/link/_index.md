...
We can insert a link using the `InsertHyperlink` method of the document generator. We need to specify the link text, here "Aspose", as well as the destination URL.
