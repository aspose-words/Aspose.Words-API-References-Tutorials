...
ドキュメントを操作するには、まずドキュメントを Python アプリケーションに読み込む必要があります。次のコード スニペットを使用してドキュメントを読み込み、そのコンテンツを表示します。
...
ドキュメントに変更が加えられると、Aspose.Words はそれを自動的にリビジョンとして追跡します。たとえば、特定の単語を置き換えたい場合、変更を追跡しながら置き換えることができます。
