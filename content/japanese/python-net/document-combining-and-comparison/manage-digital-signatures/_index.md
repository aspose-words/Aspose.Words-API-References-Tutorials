...
デジタル署名は、手書きの署名の電子版として機能します。デジタル署名は、電子文書の真正性、整合性、および出所を確認する手段を提供します。文書がデジタル署名されると、文書の内容に基づいて暗号化ハッシュが生成されます。このハッシュは、署名者の秘密キーを使用して暗号化され、デジタル署名が作成されます。対応する公開キーを持つ人なら誰でも、署名を検証して文書の真正性を確認できます。
