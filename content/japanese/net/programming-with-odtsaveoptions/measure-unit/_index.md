...
さて、ODT変換の測定単位を設定しましょう。ここで魔法が起こります。`OdtSaveOptions`測定単位としてインチを使用します。
...
これで完了です。これらの手順に従うことで、Aspose.Words for .NET の測定単位機能を簡単に構成し、変換中にドキュメントのレイアウトが保持されるようにすることができます。インチ、センチメートル、ポイントのいずれで作業する場合でも、このチュートリアルではドキュメントの書式設定を簡単に制御する方法を説明しました。
