...
これで完了です。これらの手順に従うことで、Aspose.Words for .NET の測定単位機能を簡単に構成し、変換中にドキュメントのレイアウトが保持されるようにすることができます。インチ、センチメートル、ポイントのいずれの場合でも、このチュートリアルでは、ドキュメントの書式設定を簡単に制御する方法を説明しました。
