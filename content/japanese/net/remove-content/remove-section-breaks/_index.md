...
A: セクション区切りを削除するには、ドキュメントのセクションを逆順に、最後のセクションの 1 つ前から最初のセクションまで移動する必要があります。ループ内で、各セクションの内容を最後のセクションの先頭にプレフィックスとして追加し、コピーしたセクションを削除する必要があります。サンプル コードは次のとおりです。
