...
A: Aspose.Words の音節化は、言語固有の音節化ルールに依存します。 Aspose.Words は幅広い言語をサポートしていますが、一部の言語はサポートされていないか、音節化が利用できない場合があります。 Aspose.Words のドキュメントを参照して、音節化がサポートされている言語を確認してください。