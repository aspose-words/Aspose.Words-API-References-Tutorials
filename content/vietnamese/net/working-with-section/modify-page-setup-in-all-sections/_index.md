...
2.  Aspose.Words cho .NET: Bạn có thể[tải nó ở đây](https://releases.aspose.com/words/net/) Nếu bạn chỉ đang thử nó, một[dùng thử miễn phí](https://releases.aspose.com/) có sẵn.
...
## Phần kết luận
 ...
 Và bạn có nó! Bạn đã sửa đổi thành công thiết lập trang cho tất cả các phần trong tài liệu Word bằng Aspose.Words for .NET. Hướng dẫn này đã hướng dẫn bạn cách tạo tài liệu, thêm các phần và điều chỉnh thống nhất cách thiết lập trang của chúng. Aspose.Words cung cấp một bộ tính năng phong phú, vì vậy hãy thoải mái khám phá[Tài liệu API](https://reference.aspose.com/words/net/) để có những khả năng nâng cao hơn.
...
### 3. Làm cách nào để sửa đổi các thuộc tính thiết lập trang khác?
 ...
 Aspose.Words cho phép bạn sửa đổi các thuộc tính thiết lập trang khác nhau như hướng, lề và kích thước giấy. Tham khảo[Tài liệu API](https://reference.aspose.com/words/net/) để được hướng dẫn chi tiết.
