---
title: Xử lý từ với hình mờ
linktitle: Xử lý từ với hình mờ
second_title: API xử lý tài liệu Aspose.Words
description: Tìm hiểu cách lập trình với hình mờ trong Aspose.Words cho .NET. Tìm hiểu cách thêm hình mờ văn bản hoặc hình ảnh, tùy chỉnh giao diện của chúng, đặt chúng trên các trang, v.v. bằng hướng dẫn từng bước và mã C# mẫu.
type: docs
weight: 1570
