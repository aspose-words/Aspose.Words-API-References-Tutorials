...
Trả lời: Trường bao gồm văn bản không trực tiếp tùy chỉnh hình thức của nó trong tài liệu Word. Tuy nhiên, bạn có thể định dạng văn bản được bao gồm bằng cách sử dụng thuộc tính đoạn văn, thuộc tính phông chữ và các đối tượng định dạng khác có sẵn trong Aspose.Words cho .NET.