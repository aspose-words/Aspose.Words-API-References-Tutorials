...
4. Lưu tài liệu: Lưu tài liệu có phần đầu trang và phần chân trang.
...
2. Thêm bảng: Thêm bảng để có thông tin dạng bảng.
...
3. Tùy chỉnh theo nhu cầu: Tùy chỉnh từng đầu trang và chân trang theo yêu cầu của bạn.
