...
### Как расположить фигуры в определенном порядке?
 ...
 Вы можете управлять порядком фигур, используя свойство Z-order. Установите`ZOrder` свойство фигуры определять ее положение в стопке фигур. Более низкие значения отправляются на задний план, а более высокие значения выводятся на передний план.