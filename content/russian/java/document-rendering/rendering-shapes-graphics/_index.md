...
### Как изменить размер фигуры в документе?
 ...
 Чтобы изменить размер фигуры, используйте`setWidth` и`setHeight` методы объекта формы. Например, чтобы создать фигуру шириной 150 пикселей и высотой 75 пикселей:
...
### Как расположить фигуры в определенном порядке?
 ...
 Вы можете управлять порядком фигур, используя свойство Z-order. Установить`ZOrder` свойство фигуры определять ее положение в стопке фигур. Более низкие значения отправляются на задний план, а более высокие значения выводятся на передний план.