...
Если вы еще не установили JDK, зайдите на официальный сайт Oracle и загрузите последнюю версию JDK, подходящую для вашей операционной системы. Установите его, следуя инструкциям мастера установки.
...
Перед печатью документа вы можете настроить параметры принтера.
