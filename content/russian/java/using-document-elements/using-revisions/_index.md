...
Assert.assertEquals(para.getRuns().getCount(), 0); //был пуст.
...
### 4. Существуют ли какие-либо лицензионные требования для использования Aspose.Words для Java?
 ...
 Да, вам потребуется приобрести лицензию для использования Aspose.Words for Java в ваших проектах. Ты можешь[Получите доступ к лицензии здесь](https://purchase.aspose.com/buy).
