...
description: Научитесь использовать объекты OLE и элементы управления ActiveX в Aspose.Words для Java. Легко создавайте интерактивные документы. Начните прямо сейчас!
type: docs
weight: 21
