...
### Как защитить документ без пароля?
 ...
 Если вы хотите защитить документ без пароля, вы можете использовать другие типы защиты, например`ProtectionType.NO_PROTECTION` или`ProtectionType.READ_ONLY`.
