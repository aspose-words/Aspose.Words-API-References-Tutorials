...
### Как получить доступ к встроенным свойствам документа?
 ...
 Чтобы получить доступ к встроенным свойствам документа в Aspose.Words для Java, вы можете использовать команду`getBuiltInDocumentProperties` метод на`Document` Объект Object. Этот метод возвращает коллекцию встроенных свойств, которые можно перебирать.
...
### Как я могу конвертировать различные единицы измерения в Aspose.Words для Java?
 ...
 Вы можете конвертировать различные единицы измерения в Aspose.Words для Java, используя`ConvertUtil` класс. Он предоставляет методы для преобразования таких единиц, как дюймы в пункты, точки в сантиметры и т. д.