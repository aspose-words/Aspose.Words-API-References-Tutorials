...
### Могу ли я настроить вывод HTML?
 ...
 Да, вы можете настроить вывод HTML, настроив параметры сохранения в`HtmlSaveOptions` класс. Это позволяет вам контролировать форматирование и внешний вид создаваемых HTML-файлов.
