...
Теперь, когда у нас настроена библиотека, приступим к добавлению водяных знаков.
...
### Можно ли повернуть водяной знак?
 ...
 Да, вы можете повернуть водяной знак, установив`setRotation` недвижимость в`Shape` Объект Object. Положительные значения вращают водяной знак по часовой стрелке, а отрицательные — против часовой стрелки.
