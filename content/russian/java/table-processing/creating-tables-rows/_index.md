...
### Могу ли я экспортировать документ в другие форматы?
 Aspose.Words for Java позволяет сохранять документы в различных форматах, включая DOCX, PDF, HTML и другие. Используйте`Document.save` метод для указания желаемого формата.
