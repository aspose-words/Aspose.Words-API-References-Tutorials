...
## Управление параметрами сохранения PDF
 ...
 Вы можете управлять различными параметрами сохранения PDF с помощью`PdfSaveOptions` сорт. Например, вы можете установить отображаемый заголовок для PDF-документа следующим образом:
