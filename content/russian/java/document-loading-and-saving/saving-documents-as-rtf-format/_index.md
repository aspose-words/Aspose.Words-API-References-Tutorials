...
## Шаг 3. Сохраните документ в формате RTF.
...
### Как изменить другие параметры сохранения RTF?
 ...
 Вы можете изменить различные параметры сохранения RTF, используя`RtfSaveOptions` класс. Полный список доступных опций см. в документации Aspose.Words for Java.
