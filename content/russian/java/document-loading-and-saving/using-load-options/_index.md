...
```
 ...
 Здесь мы загружаем зашифрованный документ с использованием пароля.`LoadOptions` конструктор принимает пароль документа, а также вы можете указать новый пароль при сохранении документа с помощью`OdtSaveOptions`.
