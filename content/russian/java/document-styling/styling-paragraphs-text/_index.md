...
В этом примере мы установили выравнивание абзаца на
 ...
 Выравнивание по правому краю и добавление интервалов до и после абзаца.
...
Вы можете установить поля страницы для определенных разделов вашего документа, используя`PageSetup` класс. Вот пример:
