...
description: Научитесь легко объединять документы Word с помощью Aspose.Words для Java. Эффективно комбинируйте, форматируйте и разрешайте конфликты всего за несколько шагов. Начать сейчас!
type: docs
weight: 10
...
- `doc1.appendDocument(doc2, ImportFormatMode.KEEP_SOURCE_FORMATTING);`:
Объедините документы без разрывов.
