...
// Сравнение документов с изменениями вызовет исключение.
...
Сравнивайте документы с высокой точностью, используя передовые методы, предоставляемые Aspose.Words для Java.
