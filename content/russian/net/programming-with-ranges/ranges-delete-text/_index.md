...
### Часто задаваемые вопросы по диапазонам для удаления текста в документе Word

#### Вопрос: Какова цель функции «Удалить текст по диапазонам в документе Word» в Aspose.Words for .NET?
...
#### Вопрос: Как сохранить измененный документ после удаления текста в определенных диапазонах с помощью Aspose.Words for .NET?
 ...
 О: Чтобы сохранить измененный документ после удаления текста в определенных диапазонах с помощью Aspose.Words for .NET, вы можете использовать команду`Save` метод`Document` класс. Этот метод позволяет сохранить документ в указанном пути к файлу или потоке. Вот пример:
