...
О: Да, функция «Диапазоны удаления текста в документе Word» в Aspose.Words for .NET безвозвратно удаляет текст из указанных диапазонов в документе. Текстовое содержимое удаляется, и документ соответствующим образом обновляется.
