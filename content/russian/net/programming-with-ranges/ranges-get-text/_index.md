...
О: При извлечении текста из диапазонов с помощью Aspose.Words for .NET форматирование и структура извлеченного текста сохраняются. Извлеченный текст сохранит исходное форматирование, например стили шрифта, размеры, цвета и другие атрибуты форматирования. Однако обратите внимание, что извлеченный текст может не включать определенные невидимые элементы или свойства, связанные с исходным содержимым, например скрытый текст или отслеживаемые изменения.
