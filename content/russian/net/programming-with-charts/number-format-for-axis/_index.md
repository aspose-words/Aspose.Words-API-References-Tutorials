...
Далее давайте добавим диаграмму в ваш документ. Вот здесь и начинается волшебство. Мы вставим столбчатую диаграмму, которая будет служить нашим чистым холстом.
