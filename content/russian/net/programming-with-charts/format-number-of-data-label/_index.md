...
```csharp
	...
	//В этом случае NumberFormat будет сброшен до общего и унаследован от исходной ячейки.
