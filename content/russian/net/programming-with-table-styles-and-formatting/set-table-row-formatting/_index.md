...
## Шаг 4. Определите форматирование строки.
 Теперь мы можем установить форматирование строки, обратившись к`RowFormat` объект`DocumentBuilder` Объект Object. Мы можем установить высоту строки и поля (отступы), используя соответствующие свойства.
...
## Шаг 5. Установите поля таблицы.
 Далее мы можем установить отступы таблицы, обратившись к соответствующим свойствам таблицы.`Table` Объект Object. Эти поля будут применены ко всем строкам таблицы.
