...
## Шаг 3. Получите доступ к строке, чтобы изменить ее.
 Чтобы изменить форматирование строки таблицы, нам нужно перейти к определенной строке таблицы. Мы используем`GetChild()` и`FirstRow` Методы получения ссылки на первую строку таблицы.
...
## Шаг 4. Измените форматирование строки
 Теперь мы можем изменить форматирование строк, используя свойства`RowFormat` класс. Например, мы можем удалить границы строк, установить автоматическую высоту и разрешить разрыв строки.
