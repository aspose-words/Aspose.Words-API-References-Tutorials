...
## Шаг 3. Перейдите к ячейке, чтобы изменить ее.
 Чтобы изменить форматирование ячейки, нам нужно перейти к определенной ячейке таблицы. Мы используем`GetChild()` и`FirstRow.FirstCell` Методы получения ссылки на первую ячейку первого массива.
...
## Шаг 4. Измените форматирование ячейки
 Теперь мы можем изменить форматирование ячейки, используя свойства`CellFormat` класс. Например, мы можем установить ширину ячейки, ориентацию текста и цвет фона.
