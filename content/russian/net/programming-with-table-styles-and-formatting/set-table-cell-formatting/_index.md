...
## Шаг 4. Установите форматирование ячейки
 Теперь мы можем установить форматирование ячейки, открыв`CellFormat` объект`DocumentBuilder` Объект Object. Мы можем установить ширину ячейки и поля (отступы), используя соответствующие свойства.
