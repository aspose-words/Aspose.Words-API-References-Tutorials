...
## Шаг 3. Обработка слов с помощью свойств полей формы
 ...
 Вы можете манипулировать различными свойствами поля формы в зависимости от его типа. В этом примере мы проверяем, имеет ли поле формы тип`FieldType.FieldFormTextInput` и установи его`Result` имущество соответственно:
