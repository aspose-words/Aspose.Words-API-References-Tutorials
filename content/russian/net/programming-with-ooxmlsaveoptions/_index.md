...
| [Сохраните устаревшие управляющие символы](./keep-legacy-control-chars/) | Узнайте, как сохранить устаревшие управляющие символы при сохранении документа с помощью Aspose.Words для .NET. |
