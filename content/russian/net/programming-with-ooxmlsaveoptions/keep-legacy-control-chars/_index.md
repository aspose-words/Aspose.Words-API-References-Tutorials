...
В этом руководстве мы рассмотрим предоставленный исходный код C# для сохранения устаревших управляющих символов при сохранении документа с помощью Aspose.Words для .NET. Эта функция позволяет сохранять специальные управляющие символы при преобразовании или сохранении документа.
