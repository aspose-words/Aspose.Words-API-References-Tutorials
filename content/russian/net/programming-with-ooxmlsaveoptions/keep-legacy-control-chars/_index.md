---
title: Сохраните устаревшие контрольные диаграммы
linktitle: Сохраните устаревшие контрольные диаграммы
...
```
 ...
 На этом этапе мы настраиваем параметры сохранения OOXML, создавая новый`OoxmlSaveOptions` Объект Object. Указываем желаемый формат сохранения (здесь`FlatOpc` ) и включите`KeepLegacyControlChars` Возможность сохранить устаревшие управляющие символы.
...
Не стесняйтесь включать эту функцию в свои проекты Aspose.Words for .NET для обеспечения целостности и сохранения устаревших управляющих символов в ваших документах.