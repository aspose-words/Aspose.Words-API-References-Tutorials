...
#### Вопрос: Как получить доступ к закладкам в документе Word?
 ...
 О: Вы можете получить доступ к закладкам в документе Word, используя`Bookmarks` собственность`Range` объект. Вы можете получить доступ к закладкам по индексу или по имени. Вот пример кода:
