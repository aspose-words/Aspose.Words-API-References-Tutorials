...
description: Пошаговое руководство по устранению пропущенных имен шрифтов при преобразовании в HTML с помощью Aspose.Words для .NET.
type: docs
weight: 10
...
```
 ...
 Этот код создает экземпляр`HtmlSaveOptions`и устанавливает`ResolveFontNames` возможность`true`для устранения отсутствующих имен шрифтов при преобразовании в HTML. Так же`PrettyFormat` опция установлена на`true` чтобы получить красиво отформатированный HTML-код.
