...
В этом руководстве мы познакомим вас с исходным кодом C# для экспорта URL-адресов CID для ресурсов MHTML с помощью Aspose.Words для .NET. Эта функция позволяет экспортировать URL-адреса CID ресурсов MHTML при сохранении документа в формате MHTML.
