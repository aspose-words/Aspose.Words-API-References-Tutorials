...
- `CssStyleSheetType` установлено на`CssStyleSheetType.External`для экспорта таблицы стилей CSS во внешний файл.
- `ExportFontResources` установлено на`true` для экспорта ресурсов шрифтов.
