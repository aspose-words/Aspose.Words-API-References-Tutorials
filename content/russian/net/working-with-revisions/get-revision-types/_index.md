...
В этом уроке мы узнали, как получить типы редакций слов в документе Word с помощью Aspose.Words для .NET. Мы выполнили шаги, чтобы загрузить документ, просмотреть абзацы и проверить словесные обзоры, связанные с каждым абзацем. Теперь вы можете применить эти знания для анализа обзоров слов в своих собственных документах Word, используя Aspose.Words для .NET.

### Часто задаваемые вопросы по получению типов ревизий слов
