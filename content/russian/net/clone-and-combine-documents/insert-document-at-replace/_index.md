...
Теперь мы говорим нашему основному документу искать определенный текст-заполнитель и ничем его не заменять, одновременно используя наш собственный обратный вызов для вставки другого документа.
...
## Шаг 5. Создайте собственный обработчик обратного вызова репликации
...
private class InsertDocumentAtReplaceHandler : IReplacingCallback
{
    ReplaceAction IReplacingCallback.Replacing(ReplacingArgs args)
    {
        ...
        // Вставьте документ после абзаца, содержащего соответствующий текст.
