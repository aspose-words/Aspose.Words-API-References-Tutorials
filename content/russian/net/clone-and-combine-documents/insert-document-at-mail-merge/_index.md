...
1.  Aspose.Words для .NET: вы можете[скачайте последнюю версию здесь](https://releases.aspose.com/words/net/) . Если вам необходимо приобрести лицензию, вы можете это сделать[здесь](https://purchase.aspose.com/buy) . В качестве альтернативы вы можете получить[временная лицензия](https://purchase.aspose.com/temporary-license/) или попробуйте это с[бесплатная пробная версия](https://releases.aspose.com/).
...
Да, вы можете. Просто укажите соответствующие поля слияния и соответствующие пути к документам в`MailMerge.Execute` метод.
