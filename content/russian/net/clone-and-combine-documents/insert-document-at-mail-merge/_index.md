...
---
В этом уроке мы покажем вам, как вставить документ в другой документ во время слияния почты с помощью функции «Вставить документ во время слияния почты» в Aspose.Words для .NET. Выполните следующие действия, чтобы понять исходный код и выполнить вставку документа.
