...
#### Вопрос: Как вставить поле с текстом в документ с помощью Aspose.Words for .NET?
 ...
 О: Если у вас есть документ, вы можете вставить поле с текстом внутри него, используя`DocumentBuilder` объект. Например, чтобы вставить поле «INCLUDETEXT» с текстом «Текст в поле», вы можете использовать команду`InsertField` метод:
