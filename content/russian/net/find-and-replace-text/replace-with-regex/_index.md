...
Да, вы можете. Вы можете использовать разные методы для таргетинга на определенные разделы, абзацы или даже верхние и нижние колонтитулы вашего документа.
