...
## Шаг 2. Создайте список с несколькими уровнями отступов
 ...
 С`DocumentBuilder` Например, теперь вы можете создать список с разными уровнями отступов. Использовать`ListFormat` свойство, позволяющее применять нумерацию и отступы для элементов списка по мере необходимости.
...
Наконец, сохраните документ, используя настроенные параметры. Это применит настройки отступа и сохранит файл в нужном формате.
