...
---
Безопасность документов важна при обработке слов с файлами в приложении C#. С помощью библиотеки Aspose.Words для .NET вы можете легко защитить свои документы, зашифровав их паролем. В этом пошаговом руководстве мы расскажем, как использовать исходный код Aspose.Words для .NET C# для шифрования документа с помощью параметров сохранения DocSaveOptions.
