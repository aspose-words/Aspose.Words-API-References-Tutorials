...
#### Вопрос: Какой формат файлов поддерживает Aspose.Words for .NET для подписи документов?
 ...
 О: Aspose.Words for .NET поддерживает подпись документов Word в формате DOCX. Вы можете подписывать файлы DOCX, используя`DigitalSignatureUtil` класс и соответствующий сертификат.
