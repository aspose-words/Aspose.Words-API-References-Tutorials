...
#### Вопрос: Как я могу подписать документ после создания строки подписи?
 ...
 О: Чтобы подписать документ после создания строки подписи, вам необходимо задать параметры подписи и использовать`DigitalSignatureUtil` класс. Вот шаги:
...
3.  Загрузите сертификат подписи, используя`CertificateHolder` класс.
