...
О: Нет, преобразование полей в Aspose не влияет на исходные данные в документе Word. Преобразование применяется при обновлении полей, но исходные данные остаются нетронутыми. Это гарантирует, что вы сможете вернуться к исходному состоянию документа в любой момент.
