...
Теперь, когда ваши поля обновлены, вы можете получить доступ к их результатам и отобразить их. Это полезно для отладки или создания отчетов, включающих значения полей.
...
### Нужно ли сохранять документ после обновления полей?  
 Нет, звоню`UpdateFields` не сохраняет документ автоматически. Использовать`Save` метод сохранения любых изменений.
