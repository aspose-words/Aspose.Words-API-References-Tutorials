...
1. Базовые знания C#: вы должны хорошо разбираться в программировании на C#.
2. Установленная Visual Studio. Убедитесь, что на вашем компьютере установлена Visual Studio или любая другая интегрированная среда разработки C#.
...
2. Создайте новый проект: выберите «Файл» > «Создать» > «Проект». Выберите консольное приложение C#.
3. Назовите свой проект. Дайте проекту осмысленное имя и нажмите «Создать».
...
1. Откройте диспетчер пакетов NuGet. Щелкните правой кнопкой мыши свой проект в обозревателе решений и выберите «Управление пакетами NuGet».
...
## Шаг 6. Вставьте поле слияния
 ...
 Вставить поле слияния очень просто. Мы будем использовать`InsertField` метод`DocumentBuilder` сорт.
