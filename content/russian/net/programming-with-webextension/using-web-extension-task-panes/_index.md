...
## Шаг 2. Создайте и настройте область задач.
 ...
 Мы создаем`TaskPane` объект и добавьте его в документ`s `Коллекция WebExtensionTaskPanes. Далее мы настраиваем свойства панели задач, такие как ее закрепленное состояние, видимость и ширина.
