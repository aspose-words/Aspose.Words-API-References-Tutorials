...
## Шаг 2. Создайте новый документ и проект VBA.
 Далее мы создадим новый документ, создав экземпляр`Document` класс и пустой проект VBA, создав экземпляр`VbaProject` класс.
...
О: Да, вы можете добавить несколько модулей VBA в проект VBA в документе Word, создав несколько экземпляров.`VbaModule` объекты и добавление их в`Modules` коллекция`VbaProject` Объект Object. Это позволяет вам организовать код VBA в различные модули для лучшего управления и повторного использования.