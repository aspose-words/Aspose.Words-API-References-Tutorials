...
О: Для доступа к исходному коду макросов VBA в документе Word вы можете использовать команду`SourceCode` собственность соответствующего`VbaModule` Объект Object. Вы можете перебирать все модули проекта VBA и просматривать исходный код каждого модуля.
