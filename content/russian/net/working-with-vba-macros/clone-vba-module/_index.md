...
#### Вопрос: Как сохранить целевой документ с клонированным модулем VBA?
 ...
 О: Чтобы сохранить целевой документ с помощью клонированного модуля VBA, вы можете использовать`Save` метод`Document` class, указав желаемый путь назначения и имя файла.