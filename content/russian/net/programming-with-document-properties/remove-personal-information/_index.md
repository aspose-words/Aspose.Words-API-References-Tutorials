...
В этом руководстве мы познакомим вас с исходным кодом C# для удаления личной информации из документа с помощью Aspose.Words для .NET. Эта функция позволяет удалить из документа конфиденциальную личную информацию, например идентификационные данные автора.
...
На этом этапе мы загрузим документ Word, из которого хотим удалить личную информацию. Используйте следующий код для загрузки документа:
...
## Шаг 3. Удалите личную информацию
 ...
 Теперь мы включим удаление личной информации, установив`RemovePersonalInformation`собственность`true`. Используйте следующий код:
...
Теперь вы узнали, как удалить личную информацию из документа с помощью Aspose.Words для .NET. Следуя пошаговому руководству, представленному в этом руководстве, вы сможете легко удалить конфиденциальную информацию из своих документов.