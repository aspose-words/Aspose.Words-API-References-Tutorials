...
3.  Установите пароль для документа с помощью`SetPassword` метод`WriteProtection` Объект Object.
...
6.  Сохраните защищенный документ с помощью`Save` метод`Document` Объект Object.
