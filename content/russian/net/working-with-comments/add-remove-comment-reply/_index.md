...
#### Вопрос: Как я могу получить доступ к существующим комментариям в Aspose.Words для .NET?
 ...
 О: Вы можете получить доступ к существующим комментариям в Aspose.Words для .NET, используя`CommentCollection` собственность`Document`объект. Это позволит вам просмотреть все комментарии, присутствующие в документе.
