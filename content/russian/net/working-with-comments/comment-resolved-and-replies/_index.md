...
#### Вопрос: Как мне разрешить комментарий в Aspose.Words для .NET?
 ...
 О: Чтобы разрешить комментарий в Aspose.Words для .NET, вы можете использовать команду`Comment.Resolve` метод, определяющий`Comment` объект, который вы хотите разрешить. Комментарий будет помечен как решенный и скроется в итоговом документе.
...
#### Вопрос: Могу ли я редактировать текст разрешенного комментария в Aspose.Words for .NET?
 ...
 О: Да, вы можете редактировать текст разрешенного комментария в Aspose.Words for .NET, открыв`Comment.Text` собственность соответствующего`Comment` объект и изменив текст по мере необходимости.