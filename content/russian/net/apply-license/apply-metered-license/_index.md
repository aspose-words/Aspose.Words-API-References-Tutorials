...
Вы можете проверить лимитированную лицензию, выполнив любую операцию с документом Word (например, распечатав количество страниц) и убедившись, что она выполняется без ошибок лицензирования.