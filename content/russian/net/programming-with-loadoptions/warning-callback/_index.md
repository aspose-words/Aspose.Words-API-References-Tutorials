...
О: Использование обратного вызова с предупреждением позволяет вам быть в курсе любых предупреждений, выдаваемых в процессе загрузки документа. Предупреждения могут указать на потенциальные проблемы с документом и помочь вам предпринять соответствующие действия для их устранения или устранения.
...
#### Вопрос: Используется ли обязательное предупреждение обратного вызова при загрузке документа?
