...
| Заголовок | Описание |
| --- | --- |
| [Вставьте первый объект в документ Word](./insert-ole-object/) | Узнайте, как вставить объект OLE в документ Word с помощью Aspose.Words для .NET. |
...
| [Вставить первый объект в документ Word как значок](./insert-ole-object-as-icon/) | Узнайте, как вставить объект OLE в документ Word в виде значка с помощью Aspose.Words для .NET. |
| [Вставьте первый объект как значок, используя поток](./insert-ole-object-as-icon-using-stream/) | Узнайте, как вставить объект OLE в виде значка с помощью потока с помощью Aspose.Words для .NET. |
