---
title: Очистить управление содержимым
linktitle: Очистить управление содержимым
...
## Шаг 4. Сохраните документ
 Сохраните измененный документ с помощью`Save`метод. Укажите желаемое имя файла с соответствующим расширением. В этом примере мы сохраняем документ как «WorkingWithSdt.ClearContentsControl.doc».
