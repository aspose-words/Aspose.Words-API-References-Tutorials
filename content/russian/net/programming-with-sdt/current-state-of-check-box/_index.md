...
Aspose.Words для .NET позволяет вам манипулировать различными элементами документа, включая абзацы, таблицы, изображения, верхние и нижние колонтитулы и структурированные теги документа, такие как флажки.
