...
О: Чтобы убрать разрывы разделов, вам необходимо пройтись по разделам документа задом наперед, начиная с предпоследнего раздела и переходя к первому разделу. Внутри цикла вам необходимо прикрепить содержимое каждого раздела к началу последнего раздела, а затем удалить скопированный раздел. Вот пример кода:
