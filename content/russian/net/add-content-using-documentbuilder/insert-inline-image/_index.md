...
## Шаг 3. Сохраните документ
 ...
 Наконец, сохраните документ в нужном месте, используя`Save` метод`Document` класс.
...
В заключение отметим, что интеграция встроенных изображений в документы Word с помощью Aspose.Words for .NET — это простой процесс, который улучшает визуализацию и функциональность документа. Следуя шагам, описанным выше, вы сможете эффективно манипулировать изображениями в ваших документах программным способом, используя возможности Aspose.Words.
...
### Как изменить размер онлайн-изображения, вставленного с помощью Aspose.Words для .NET?
