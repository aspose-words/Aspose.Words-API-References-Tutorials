...
## Шаг 3. Создайте новый документ
 ...
 Теперь давайте создадим новый экземпляр`Document` класс. Это представляет собой документ Word, с которым мы собираемся работать.
...
## Шаг 4. Инициализируйте DocumentBuilder
 ...
 Чтобы добавить контент в наш документ, мы будем использовать`DocumentBuilder` класс. Этот класс предоставляет удобный способ вставки различных элементов в документ Word.
