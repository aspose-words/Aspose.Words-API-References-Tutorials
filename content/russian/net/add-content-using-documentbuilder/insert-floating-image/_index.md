...
Когда все настроено, давайте вставим плавающее изображение в документ.
 ...
 Использовать`InsertImage` метод`DocumentBuilder` класс для вставки изображения:
...
### Какие еще типы переноса доступны для изображений?
 ...
 Aspose.Words поддерживает различные типы переноса, такие как`Inline`, `TopBottom`, `Tight`, `Through`, и более. Вы можете выбрать тот, который лучше всего соответствует макету вашего документа.
