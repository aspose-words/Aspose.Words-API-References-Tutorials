...
## Шаг 2. Инициализируйте DocumentBuilder
 ...
 Далее мы инициализируем`DocumentBuilder` объект. Думайте об этом как о цифровой ручке, которая поможет вам перемещаться по документу и изменять его.
...
### Могу ли я вставить другие типы контента после перехода к абзацу?
 Абсолютно! Вы можете вставлять текст, изображения, таблицы и многое другое, используя`DocumentBuilder` сорт.
