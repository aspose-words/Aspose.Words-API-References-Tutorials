...
```
 ...
 На этом этапе вы создаете новый экземпляр`Document` класс и`DocumentBuilder` сорт.`dataDir` Переменная используется для указания каталога, в котором вы хотите сохранить документ.
