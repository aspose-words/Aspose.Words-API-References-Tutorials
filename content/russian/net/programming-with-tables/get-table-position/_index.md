...
```
 ...
 Здесь мы используем условие, чтобы проверить, имеет ли массив тип float. Если да, то мы распечатываем`RelativeHorizontalAlignment` и`RelativeVerticalAlignment` Свойства для получения относительного горизонтального и вертикального выравнивания таблицы. В противном случае мы печатаем`Alignment` свойство для выравнивания массива.
