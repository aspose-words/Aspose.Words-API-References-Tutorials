...
```
 ...
 Здесь мы используем`InsertHtml` метод построителя документов для вставки HTML-кода, содержащего таблицу. Указанный HTML создает таблицу с двумя строками и двумя ячейками в каждой строке. Вы можете настроить содержимое таблицы, изменив HTML-код в соответствии с вашими потребностями.
