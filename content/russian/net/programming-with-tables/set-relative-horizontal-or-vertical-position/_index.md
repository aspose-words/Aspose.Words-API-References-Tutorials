...
```
 ...
 Здесь мы используем документ для получения первой таблицы из тела первого раздела. Далее мы устанавливаем относительное горизонтальное положение стола с помощью`HorizontalAnchor` имущество, используя`RelativeHorizontalPosition.Column` ценность. Аналогичным образом мы устанавливаем относительное вертикальное положение стола с помощью`VerticalAnchor` имущество, используя`RelativeVerticalPosition.Page` ценность.
