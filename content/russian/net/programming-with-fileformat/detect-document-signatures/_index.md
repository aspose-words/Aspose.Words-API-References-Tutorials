...
Когда вы открываете или сохраняете документ с помощью Aspose.Words, цифровые подписи, присутствующие в документе, будут потеряны. Это связано с изменениями, внесенными в документ при обработке с помощью Aspose.Words. Если вам необходимо сохранить ЭЦП, следует принять это во внимание и использовать другой метод управления документами, содержащими ЭЦП.
