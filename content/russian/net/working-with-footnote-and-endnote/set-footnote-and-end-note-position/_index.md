...
В этом пошаговом руководстве мы покажем вам, как использовать Aspose.Words для .NET для установки положения сносок и концевых сносок в документе Word. Мы объясним предоставленный исходный код C# и покажем, как реализовать его в ваших собственных проектах.
...
О: Да, вы можете настроить сноски и концевые сноски с использованием определенного шрифта или стилей форматирования в Aspose.Words. Вы можете использовать доступные методы и свойства для применения стилей, цветов, размеров шрифтов и т. д. сноски и концевые примечания.