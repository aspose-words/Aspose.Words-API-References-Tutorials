...
### Вопрос 3. Как настроить разные верхние и нижние колонтитулы для первой страницы?
 ...
 Вы можете установить разные верхние и нижние колонтитулы для первой страницы, используя`DifferentFirstPageHeaderFooter` собственность`PageSetup` класс.
...
### Вопрос 5: Доступна ли поддержка Aspose.Words?
 ...
 Да, Aspose предлагает поддержку через них.[форум поддержки](https://forum.aspose.com/c/words/8).
