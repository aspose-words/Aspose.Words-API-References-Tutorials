...
## Шаг 1. Загрузите документ DOCX
 ...
 Сначала вам нужно загрузить документ DOCX, который вы хотите конвертировать. Используйте`Document` класс из Aspose.Words, чтобы загрузить файл DOCX.
...
Поздравляем! Вы успешно преобразовали документ DOCX в MHTML и отправили его по электронной почте с помощью Aspose.Words для .NET. Этот процесс включает в себя загрузку документа, преобразование его в MHTML, создание сообщения электронной почты и его отправку с помощью SMTP-клиента. С помощью этих шагов вы можете легко автоматизировать преобразование и отправку документов по электронной почте в ваших приложениях.
