...
Далее вам нужно будет просмотреть коллекцию стилей, чтобы получить доступ и отобразить имя каждого стиля. Здесь вы можете настроить вывод в соответствии с вашими потребностями.
