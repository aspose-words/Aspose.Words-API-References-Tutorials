...
Теперь вы можете запустить исходный код для копирования стилей из исходного документа в целевой документ. Эта функция позволяет поддерживать единообразие стиля в нескольких документах, что упрощает управление внешним видом и форматированием ваших документов.
