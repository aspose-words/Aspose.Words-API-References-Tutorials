...
#### Как применить разные стили к разным разделам текста?
 ...
 Вы можете применять разные стили к разным частям текста, установив`ParagraphFormat.StyleName` собственность`DocumentBuilder` объект. Прежде чем писать текст, вы можете установить имя стиля в желаемый стиль, и следующий за ним текст будет отформатирован соответствующим образом.
