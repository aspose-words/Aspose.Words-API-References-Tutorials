...
| Заголовок | Описание |
| --- | --- |
| [Использовать шрифт с целевой машины](./use-font-from-target-machine/) | Узнайте, как преобразовать документ Word в фиксированный HTML, используя шрифты целевого компьютера с помощью Aspose.Words для .NET. |
| [Запишите все правила CSS в одном файле](./write-all-css-rules-in-single-file/) | Узнайте, как преобразовать документ Word в фиксированный HTML, записав все правила CSS в одном файле с помощью Aspose.Words для .NET. |