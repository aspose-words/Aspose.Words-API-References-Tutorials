...
1.  Aspose.Words для .NET: убедитесь, что у вас установлен Aspose.Words для .NET. Если нет, вы можете[скачайте последнюю версию здесь](https://releases.aspose.com/words/net/).
...
## Шаг 3. Сохраните документ в формате PDF.
 ...
 После настройки параметров вы готовы сохранить документ в формате PDF. Используйте`Save` метод`Document` class, передайте путь к файлу и параметры сохранения.
