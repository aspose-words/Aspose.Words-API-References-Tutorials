...
## Шаг 3. Настройте параметры сохранения в формате PDF со сжатием изображений.
 ...
 Чтобы сжимать изображения при конвертации в PDF, нам необходимо настроить`PdfSaveOptions` Объект Object. При необходимости мы можем установить тип сжатия изображения, качество JPEG и другие параметры соответствия PDF.
