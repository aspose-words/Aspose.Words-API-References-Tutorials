...
### 3. Как обнаружить в документе другие типы фигур?
 ...
 Вы можете изменить запрос LINQ, чтобы проверить наличие других свойств или типов фигур. Обратитесь к[документация](https://reference.aspose.com/words/net/) для более подробной информации.
...
### 5. Могу ли я программно манипулировать фигурами SmartArt?
 ...
 Да, Aspose.Words позволяет вам программно манипулировать фигурами SmartArt. Проверьте[документация](https://reference.aspose.com/words/net/) для получения подробных инструкций.