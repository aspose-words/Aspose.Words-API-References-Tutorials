...
О: Функция «Пробел» между азиатским и латинским текстом в документе Word означает возможность автоматической регулировки интервала между письменным текстом, написанным различными алфавитами, например азиатским (например, китайским, японским) и латинским (например, английским).
