...
Далее мы откорректируем пространство до и после абзаца. Это помогает управлять вертикальным пространством и гарантирует, что документ не будет выглядеть тесным.
