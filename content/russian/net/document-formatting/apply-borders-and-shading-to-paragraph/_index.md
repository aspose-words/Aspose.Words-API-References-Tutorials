...
### Какие еще текстуры затенения доступны?  
 Вы можете использовать несколько текстур, например сплошную, горизонтальную полосу, вертикальную полосу и т. д. Проверьте[Aspose документация](https://reference.aspose.com/words/net/) для полного списка.
