...
Учебники также фокусируются на удалении и изменении существующих разделов. Вы узнаете, как удалять определенные разделы, переставлять разделы, изменять настройки макета и выполнять другие расширенные операции, чтобы адаптировать документы Word к вашим конкретным потребностям.
