...
#### Вопрос: Как добавить содержимое и разделы в документ в Aspose.Words for .NET?
 ...
 О: Чтобы добавить содержимое и разделы в документ в Aspose.Words for .NET, вы можете использовать`DocumentBuilder` конструктор. В этом примере мы добавляем две строки текста и два раздела:
