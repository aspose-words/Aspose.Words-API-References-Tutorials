...
## Шаг 2. Добавьте стиль для встроенного кода
 ...
 Мы добавим собственный стиль для онлайн-кода, используя`Styles.Add` метод`Document` Объект Object. В этом примере мы создаем стиль InlineCode для встроенного кода с обратной кавычкой по умолчанию.
