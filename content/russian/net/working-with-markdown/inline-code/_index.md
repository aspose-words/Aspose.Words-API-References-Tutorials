...
#### Вопрос: Как я могу использовать встроенный код в Aspose.Words?
 ...
 О: Чтобы использовать встроенный код в Aspose.Words, вы можете использовать соответствующие теги для окружения текста, который будет отформатирован как встроенный код. Например, вы можете использовать`<code>` или`<kbd>` тег для окружающего текста, который будет отформатирован как встроенный код.
