...
## Шаг 3. Создание стилей для вложенных уровней
 ...
 Мы можем создавать стили для вложенных уровней, используя команду`Styles.Add` метод`Document` Объект Object. В этом примере мы создаем стиль под названием «Quote1», который представляет собой вложенный уровень котировок.
...
#### Вопрос: Поддерживает ли цитата Markdown атрибуты?
