...
#### Вопрос: Могу ли я изменить стиль оглавления в существующем документе Word с помощью Aspose.Words for .NET?
 ...
 О: Да, вы можете изменить стиль оглавления в существующем документе Word, используя Aspose.Words для .NET. Просто загрузите документ, используя`Document` класс, измените свойства стиля, используя`Styles` свойство и сохраните документ, чтобы применить изменения.
