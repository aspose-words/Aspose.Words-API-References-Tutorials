...
5.  Используйте`Compare`метод для одного документа, передавая другой документ и`CompareOptions` объект в качестве параметров. Этот метод сравнит документы на основе указанной детализации и сохранит изменения в первом документе.
