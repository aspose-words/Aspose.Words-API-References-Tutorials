...
Вы можете взаимодействовать с веб-расширениями, используя механизм обработки событий Aspose.Words. Регистрируйте события, вызванные взаимодействиями с пользователем, и соответствующим образом настраивайте поведение документа.
