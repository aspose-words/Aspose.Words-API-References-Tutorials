...
### Добавление текста-заполнителя
 ...
 Текст-заполнитель в полях ввода текста помогает пользователям выбрать ожидаемый формат ввода. Используйте`PlaceholderText` свойство для добавления заполнителей:
