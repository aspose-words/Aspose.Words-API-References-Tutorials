...
Флажки и переключатели используются для выбора множественного выбора. Вот как вы можете их создать:
...
Поля текстового ввода предоставляют простой способ ввода текстовых данных, что делает их важным инструментом при сборе данных на основе документов.
