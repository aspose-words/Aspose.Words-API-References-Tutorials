...
Aspose.Words for Python предоставляет широкий спектр возможностей для стилизации шрифтов и текста. Используя эти методы, вы можете создавать визуально интересные и привлекательные документы Word, которые эффективно передают ваше сообщение.
...
Да, Aspose. Words позволяет регулировать расстояние между символами с помощью кнопки`kerning` собственность`Font` класс.

### Поддерживает ли Aspose.Words импорт шрифтов из внешних источников?

Да, убедитесь, что Aspose.Words поддерживает встраивание шрифтов из внешних источников для единообразного рендеринга в разных системах.
