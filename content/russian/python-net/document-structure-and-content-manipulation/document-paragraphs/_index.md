...
## Базовое форматирование текста
 ...
 Форматирование текста в документе Word необходимо для подчеркивания важных моментов и улучшения читаемости. Aspose.Words позволяет применять различные параметры форматирования, такие как**bold**, *italic*, подчеркивание и размер шрифта:
