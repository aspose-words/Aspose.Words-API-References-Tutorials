...
Поля — это заполнители в документе, которые динамически отображают данные. Их можно использовать для различных целей, таких как отображение текущей даты, перекрестные ссылки на контент или выполнение вычислений.

## Вставка простых полей

 Чтобы вставить поле, вы можете использовать`FieldBuilder` сорт. Например, чтобы вставить поле текущей даты:
...
### Как обновить значения полей вручную?
 ...
 Чтобы обновить значения поля вручную, выберите поле и нажмите`F9`.
