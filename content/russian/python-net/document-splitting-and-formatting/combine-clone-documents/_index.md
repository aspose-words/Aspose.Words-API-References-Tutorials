...
DocumentBuilder — это универсальный инструмент, который позволяет создавать, изменять и манипулировать документами программными средствами. Чтобы объединить документы с помощью DocumentBuilder, выполните следующие действия:
...
### Глубокий клон против. Мелкий клон
