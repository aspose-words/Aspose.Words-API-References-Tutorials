...
### Могу ли я заменить текст только в пределах определенного диапазона страниц?
 ...
 Да, вы можете. Перед выполнением замены укажите диапазон страниц с помощью значка`doc.get_child_nodes()` метод для получения содержимого определенных страниц.
