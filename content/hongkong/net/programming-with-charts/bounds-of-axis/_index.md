...
本教學介紹如何使用 Aspose.Words for .NET 設定圖表中軸的邊界。透過插入圖表、新增系列資料和配置軸縮放，您可以定義軸的最小值和最大值。
...
若要安裝 Aspose.Words for .NET，您可以使用 Visual Studio 中的 NuGet 套件管理器。只需在 NuGet 套件管理器中搜尋“Aspose.Words”並將其安裝到您的專案中即可。
