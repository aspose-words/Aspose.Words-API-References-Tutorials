...
###  Co się stanie, gdy ustawię`REMOVE_CONTAINING_FIELDS` option?
 ...
 Ustawianie`MailMergeCleanupOptions.REMOVE_CONTAINING_FIELDS` Opcja ta usunie całe pole korespondencji seryjnej, łącznie z akapitem zawierającym, z dokumentu podczas procesu korespondencji seryjnej. Jest to przydatne, gdy chcesz wyeliminować pola scalania i powiązany z nimi tekst.
