...
```
 ...
 En este paso, configuramos las opciones de guardado de OOXML usando el`OptimizeFor` y`OoxmlSaveOptions`métodos. Optimizamos la compatibilidad de documentos para la versión Word 2016 usando`OptimizeFor` y establecer el cumplimiento en`Iso29500_2008_Strict` usando`Compliance`.
