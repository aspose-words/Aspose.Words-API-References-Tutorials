...
| [Sección múltiple](./multi-section/) | Aprenda a recuperar y procesar etiquetas de documentos estructurados de varias secciones en un documento de Word utilizando Aspose.Words para .NET. |
| [Asignación Xml de inicio de rango de etiquetas de documento estructurado](./structured-document-tag-range-start-xml-mapping/) | Aprenda a configurar la asignación XML para un rango de etiquetas de documento estructurado que comienza en un documento de Word usando Aspose.Words para .NET. |