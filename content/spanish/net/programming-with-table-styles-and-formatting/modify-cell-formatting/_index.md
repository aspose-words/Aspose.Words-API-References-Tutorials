...
## Paso 4: cambiar el formato de celda
 Ahora podemos cambiar el formato de la celda usando las propiedades del`CellFormat` clase. Por ejemplo, podemos establecer el ancho de la celda, la orientación del texto y el color de fondo.
...
### Código fuente de muestra para modificar el formato de celda usando Aspose.Words para .NET 
