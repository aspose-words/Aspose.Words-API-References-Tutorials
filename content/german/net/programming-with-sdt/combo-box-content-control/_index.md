...
## Schritt 2: Erstellen Sie ein Dokument und ein StructuredDocumentTag
 Erstellen Sie eine neue Instanz des`Document` Klasse und eine`StructuredDocumentTag` um das Inhaltssteuerelement des Kombinationsfelds darzustellen. Geben Sie`SdtType.ComboBox` als Typ und`MarkupLevel.Block` als Markup-Ebene, um ein Kombinationsfeld auf Blockebene zu erstellen.
