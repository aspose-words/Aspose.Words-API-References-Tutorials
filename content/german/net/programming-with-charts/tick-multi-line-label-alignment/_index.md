...
Aspose.Words für .NET bietet leistungsstarke Funktionen zum Bearbeiten von Diagrammen in Word-Dokumenten. Mehrzeilige Häkchenbeschriftungen sind nützlich, wenn Achsenbeschriftungen langen Text enthalten, der einen Umbruch oder eine Aufteilung über mehrere Zeilen erfordert. Durch Festlegen der Ausrichtung der Teilstrichbeschriftung können Sie die horizontale Ausrichtung mehrzeiliger Beschriftungen innerhalb der Diagrammachse steuern und so eine optimale Darstellung und Lesbarkeit gewährleisten.
