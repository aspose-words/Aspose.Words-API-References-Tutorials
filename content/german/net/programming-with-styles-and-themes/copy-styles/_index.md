...
```
 ...
 In diesem Schritt erstellen wir zwei`Document` Objekte:`doc` welches das leere Quelldokument darstellt und`target` das das Zieldokument darstellt, aus dem wir die Stile kopieren werden.
