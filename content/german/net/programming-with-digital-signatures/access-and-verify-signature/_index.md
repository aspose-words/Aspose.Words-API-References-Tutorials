...
2.  Verwenden Sie eine Schleife, um die zu durchlaufen`DigitalSignatures` Sammlung der Dokumente. Jede Iteration stellt eine digitale Signatur dar.
...
1.  Greife auf ... zu`DigitalSignatures` Sammlung der Dokumente.
