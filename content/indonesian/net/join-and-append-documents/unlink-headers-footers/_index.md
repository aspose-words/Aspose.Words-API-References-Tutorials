...
## Langkah 5: Tambahkan Dokumen Sumber
 ...
 Setelah membatalkan tautan header dan footer, Anda dapat menambahkan dokumen sumber ke dokumen tujuan. Gunakan`AppendDocument` metode dan atur mode format impor ke`KeepSourceFormatting` untuk mempertahankan format asli dokumen sumber.
