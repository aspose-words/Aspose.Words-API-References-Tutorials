...
## Étape 2 : Insérer un lien
 ...
 Nous pouvons insérer un lien en utilisant le`Insertlink` méthode du générateur de documents. Nous devons préciser le texte du lien, ici "Aspose", ainsi que l'URL de destination.
