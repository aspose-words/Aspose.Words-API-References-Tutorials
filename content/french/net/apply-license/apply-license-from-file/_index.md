...
Vous avez maintenant appliqué avec succès la licence à partir d’un fichier à l’aide d’Aspose.Words for .NET. Vous pouvez continuer vos tâches de traitement de documents en utilisant toutes les fonctionnalités de la bibliothèque.
...
R : Aspose.Words for .NET prend en charge les fichiers de licence au format XML. Assurez-vous que votre fichier de licence est au format XML approprié reconnu par Aspose.Words for .NET.
