...
Vous pouvez vérifier la licence limitée en effectuant n'importe quelle opération sur un document Word (comme l'impression du nombre de pages) et en vous assurant qu'il s'exécute sans erreurs de licence.