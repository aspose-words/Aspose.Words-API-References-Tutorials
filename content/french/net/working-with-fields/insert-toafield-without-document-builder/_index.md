...
: Oui, vous pouvez ajouter plusieurs champs TOA dans un seul document Word à l'aide d'Aspose.Words pour .NET. Répétez simplement les étapes d'insertion pour chaque champ.
