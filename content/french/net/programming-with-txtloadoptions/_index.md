...
| Titre | Description |
| --- | --- |
| [Détecter la numérotation avec des espaces](./detect-numbering-with-whitespaces/) | Découvrez comment utiliser Aspose.Words for .NET pour détecter la numérotation avec des espaces dans les documents en texte brut et garantir que vos listes sont correctement reconnues. |
| [Options des espaces de gestion](./handle-spaces-options/) | Apprenez à gérer les espaces de début et de fin dans les documents texte avec Aspose.Words for .NET. Ce didacticiel fournit un guide pour nettoyer le formatage du texte. |
| [Direction du texte du document](./document-text-direction/) | Découvrez comment définir la direction du texte d'un document dans Word à l'aide d'Aspose.Words pour .NET avec ce guide étape par étape. Parfait pour gérer les langues de droite à gauche. |