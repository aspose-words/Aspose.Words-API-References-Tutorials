...
description: Découvrez comment insérer un objet OLE sous forme d'icône à l'aide d'un flux avec Aspose.Words pour .NET.
type: docs
weight: 10
...
A.  Pour enregistrer le document dans un fichier, vous pouvez utiliser le`Save` méthode du document précisant le chemin de destination :
