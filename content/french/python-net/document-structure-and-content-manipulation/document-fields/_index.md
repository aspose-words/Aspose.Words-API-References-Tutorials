...
## Insertion de champs simples
 ...
 Pour insérer un champ, vous pouvez utiliser le`FieldBuilder` classe. Par exemple, pour insérer un champ de date actuelle :
...
## Extraction de données à partir de champs
 ...
 Vous pouvez extraire des données de terrain à l'aide de l'outil`Field` classe:
