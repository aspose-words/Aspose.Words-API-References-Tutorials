...
### كيف يمكنني إدراج صور من عناوين URL باستخدام Aspose.Words for Python؟
 ...
 يمكنك استخدام`add_remote_image` طريقة لإدراج الصور من عناوين URL. ما عليك سوى تقديم عنوان URL والموضع المطلوب.

### هل يمكنني إضافة تسميات توضيحية إلى الصور التي أقوم بإدراجها؟

 نعم، يمكنك إضافة تسميات توضيحية إلى الصور باستخدام Aspose.Words. استخدم`add_caption` طريقة وتخصيص مظهر التسمية التوضيحية.
