...
### إضافة نص العنصر النائب
 ...
 يقوم نص العنصر النائب في حقول إدخال النص بإرشاد المستخدمين إلى تنسيق الإدخال المتوقع. استخدم ال`PlaceholderText` الخاصية لإضافة العناصر النائبة:
...
تابعونا بينما نتعمق أكثر في خصائص حقل النموذج والتخصيص المتقدم.
