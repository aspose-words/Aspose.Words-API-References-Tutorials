...
## إزالة النص
 ...
 تعد إزالة نص معين من مستند Word أمرًا سهلاً باستخدام Aspose.Words. يمكنك استخدام`Range.replace` طريقة تحقيق ذلك:
...
### كيف يمكنني حفظ الوثيقة المعدلة؟
 ...
 استخدم`save` طريقة على كائن المستند، مع تحديد مسار ملف الإخراج لحفظ المستند المعدل.
