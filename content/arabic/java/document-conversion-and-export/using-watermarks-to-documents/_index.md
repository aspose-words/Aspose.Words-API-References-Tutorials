...
### هل من الممكن تدوير العلامة المائية؟
 ...
 نعم، يمكنك تدوير العلامة المائية عن طريق ضبط`setRotation` الممتلكات في`Shape` هدف. القيم الموجبة تدور العلامة المائية في اتجاه عقارب الساعة، والقيم السالبة تدورها عكس اتجاه عقارب الساعة.
