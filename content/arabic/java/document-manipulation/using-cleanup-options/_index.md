...
###  ماذا يحدث عندما أقوم بتعيين`REMOVE_CONTAINING_FIELDS` option?
 ...
 وضع`MailMergeCleanupOptions.REMOVE_CONTAINING_FIELDS` سيؤدي الخيار إلى إزالة حقل الدمج بالكامل، بما في ذلك الفقرة التي تحتوي عليه، من المستند أثناء عملية دمج المراسلات. يعد هذا مفيدًا عندما تريد إزالة حقول الدمج والنص المرتبط بها.
