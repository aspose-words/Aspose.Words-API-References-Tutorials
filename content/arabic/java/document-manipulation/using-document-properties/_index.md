...
يتيح لك الارتباط بالمحتوى داخل المستند إنشاء مراجع ديناميكية لأجزاء محددة من المستند. يمكن أن يكون هذا مفيدًا لإنشاء مستندات تفاعلية أو إسناد تبادلي بين الأقسام.
