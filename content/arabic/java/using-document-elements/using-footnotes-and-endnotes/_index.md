...
يمكنك تعديل خيارات الحواشي السفلية لتخصيص مظهرها وسلوكها. وإليك الطريقة:
```java
@Test
...
يمكنك أيضًا تخصيص إعدادات التعليقات الختامية لتلبية متطلبات المستند.
...
### 2. كيف يمكنني تغيير موضع الحواشي السفلية أو التعليقات الختامية؟
 يمكنك استخدام`setPosition` طريقة لتغيير موضع الحواشي السفلية أو التعليقات الختامية.
