...
Aspose.Words for Java عبارة عن واجهة برمجة تطبيقات قوية تتيح للمطورين العمل مع مستندات Word في تطبيقات Java. فهو يوفر ميزات متنوعة لمعالجة وإنشاء مستندات Word، بما في ذلك تشكيل النص. في هذا البرنامج التعليمي خطوة بخطوة، سوف نستكشف كيفية استخدام HarfBuzz لتشكيل النص في Aspose.Words لـ Java.
