...
### كيف يمكنني اكتشاف المستندات المشفرة باستخدام Aspose.Words لـ Java؟
 ...
 يمكنك استخدام ال`FileFormatUtil.detectFileFormat()` طريقة للكشف عن المستندات المشفرة، كما هو موضح في هذا الدليل.
...
نعم، يمكنك أتمتة الكشف عن تنسيق المستند عن طريق دمج الكود المقدم في تطبيق Java الخاص بك. يتيح لك ذلك معالجة المستندات بناءً على تنسيقاتها المكتشفة.