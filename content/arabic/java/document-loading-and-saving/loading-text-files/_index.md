...
### هل يمكنني تحويل مستند نصي محمل إلى تنسيقات أخرى؟
 ...
 نعم، يسمح لك Aspose.Words for Java بتحويل مستند نصي محمل إلى تنسيقات مختلفة، بما في ذلك DOCX وPDF والمزيد. يمكنك استخدام`Document` فئة لإجراء التحويلات. تحقق من الوثائق للحصول على أمثلة تحويل محددة.
