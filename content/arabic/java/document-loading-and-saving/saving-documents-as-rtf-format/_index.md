...
لقد أوضحنا في هذا الدليل كيفية حفظ المستندات بتنسيق RTF باستخدام Aspose.Words لـ Java. باتباع هذه الخطوات وتكوين خيارات الحفظ، يمكنك تحويل مستندات Word الخاصة بك إلى تنسيق RTF بسهولة.
