...
```java
shape1.setZOrder(1); // اجلب للمقدمة
...
### هل يمكنني إضافة نص داخل الشكل؟
 ...
 نعم، يمكنك إضافة نص داخل الشكل. استخدم ال`getTextPath` خاصية الشكل لتعيين النص وتخصيص تنسيقه.

### كيف يمكنني ترتيب الأشكال بترتيب معين؟

 يمكنك التحكم في ترتيب الأشكال باستخدام خاصية الترتيب Z. تعيين`ZOrder` خاصية الشكل لتحديد موضعه في كومة الأشكال. يتم إرسال القيم الدنيا إلى الخلف، بينما يتم إحضار القيم الأعلى إلى الأمام.