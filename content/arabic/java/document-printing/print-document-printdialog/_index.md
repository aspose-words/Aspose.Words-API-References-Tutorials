...
```
 ...
 في هذا الكود، نقوم أولاً بتحميل المستند باستخدام Aspose.Words ثم نقوم بتهيئة إعدادات الطابعة. نحن نستخدم`showPrintDialog()` طريقة لعرض PrintDialog للمستخدم. بمجرد قيام المستخدم بتحديد إعدادات الطباعة الخاصة به، نقوم بطباعة المستند باستخدام`doc.print(settings)`.
