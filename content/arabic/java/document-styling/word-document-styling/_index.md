...
لاستخدام Aspose.Words for Java في مشروعك، تحتاج إلى إضافة المكتبة باعتبارها تبعية. في معظم الحالات، يمكنك القيام بذلك عن طريق تضمين ملف JAR في مسار بناء مشروعك. راجع وثائق IDE الخاصة بك للحصول على إرشادات محددة حول إضافة مكتبات خارجية.
...
لإضافة نص إلى المستند الخاص بك، استخدم فئة DocumentBuilder. توفر هذه الفئة طرقًا متنوعة لإدراج نص في مواقع مختلفة في المستند.
