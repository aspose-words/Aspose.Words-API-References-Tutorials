...
نعم، يمكنك إضافة تعليقات متعددة إلى قسم النص نفسه عن طريق تحديد نطاقات تعليق متعددة.
