...
تعد التعليقات مفيدة للتعاون أو توفير معلومات إضافية أو تدوين الملاحظات داخل المستند. قم بتجربة أسماء المؤلفين والأحرف الأولى ومحتويات التعليقات المختلفة لتلبية متطلباتك المحددة.
...
#### س: كيف يمكنني استرداد جميع التعليقات الموجودة في المستند؟
 ...
 ج: يمكنك استرداد جميع التعليقات المقدمة في المستند باستخدام الملف`Document.Comments` ملكية.
