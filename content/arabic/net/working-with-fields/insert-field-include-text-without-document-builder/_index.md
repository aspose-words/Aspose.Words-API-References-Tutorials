...
ج: لا يؤدي تضمين حقل النص إلى تخصيص مظهره في مستند Word مباشرةً. ومع ذلك، يمكنك تنسيق النص المضمن باستخدام خصائص الفقرة، وخصائص الخط، وكائنات التنسيق الأخرى المتوفرة في Aspose.Words for .NET.