...
للبدء، تحتاج إلى استيراد مساحات الأسماء الضرورية في كود C# الخاص بك. هذا هو المكان الذي تخبر فيه تطبيقك بمكان العثور على الفئات والأساليب التي ستستخدمها. هيريس كيفية القيام بذلك:
...
هنا يحدث السحر! يمكنك ضبط المحاذاة العمودية للنص داخل مربع النص. يحدد هذا ما إذا كان النص مرتبطًا بأعلى مربع النص أو وسطه أو أسفله.
...
### أين يمكنني العثور على مزيد من المعلومات حول Aspose.Words لـ .NET؟
 تفحص ال[Aspose.توثيق الكلمات](https://reference.aspose.com/words/net/) لمزيد من التفاصيل والأدلة.