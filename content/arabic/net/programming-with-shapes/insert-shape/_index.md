...
وهنا لديك! لقد نجحت في إدراج الأشكال ومعالجتها في مستند Word باستخدام Aspose.Words لـ .NET. غطى هذا البرنامج التعليمي الأساسيات، لكن Aspose.Words يقدم العديد من الميزات المتقدمة للتعامل مع الأشكال، مثل الأنماط المخصصة والموصلات وأشكال المجموعات.
...
يمكنك تغيير`ShapeType` في`InsertShape` طريقة لإدراج أنواع مختلفة من الأشكال مثل الدوائر والمستطيلات والأسهم.
