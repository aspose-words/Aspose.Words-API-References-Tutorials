...
- نموذج مستند Word: قم بإنشاء مستند Word بسيط (مثل "Bookmarks.docx") يحتوي على بعض النصوص وقم بإدراج إشارة مرجعية (سنغطي كيفية القيام بذلك لاحقًا) للتدرب عليها.
...
```
 ...
 يسترد هذا السطر الإشارة المرجعية المسماة`"MyBookmark1"` من الوثيقة. تذكر أن تحل محل`"MyBookmark1"` بالاسم الفعلي للإشارة المرجعية التي تريد استهدافها في مستندك. إذا لم تكن الإشارة المرجعية موجودة، فسيتم طرح استثناء، لذا تأكد من حصولك على الاسم الصحيح.
