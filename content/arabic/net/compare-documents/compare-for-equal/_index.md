...
#### س: هل يمكنني إجراء مقارنة أكثر تفصيلاً لتحديد الاختلافات المحددة بين المستندات؟
 ...
 ج: نعم، يمكنك إجراء مقارنة أكثر تفصيلاً لتحديد الاختلافات المحددة بين المستندات من خلال التكرار خلال ملف`Revisions` جمع الوثائق الأصلية. تمثل كل مراجعة تغييرًا أو اختلافًا بين المستندات. يمكنك الوصول إلى تفاصيل كل مراجعة، مثل نوع التغيير (الإدراج، الحذف، تغيير التنسيق) والنطاق المتأثر بالمستند.