...
وهنا لديك! لقد نجحت في تنظيف مستند Word الخاص بك عن طريق إزالة الأنماط والقوائم غير المستخدمة باستخدام Aspose.Words for .NET. إنه مثل تنظيم مكتبك الرقمي، مما يجعل مستنداتك أكثر قابلية للإدارة وأكثر كفاءة. امنح نفسك تربيتة على ظهرك مقابل العمل الجيد الذي قمت به!
...
نعم، يمكنك تعيين كليهما`UnusedLists`و`UnusedStyles` ل`true` في`CleanupOptions` لإزالة كليهما.
