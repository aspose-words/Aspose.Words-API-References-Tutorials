...
في هذا البرنامج التعليمي، سنرشدك عبر التعليمات البرمجية المصدر لـ C# لإعداد التخطيط وتنسيق الأقسام باستخدام Aspose.Words for .NET. تتيح لك هذه الميزة ضبط اتجاه الصفحة والهوامش وحجم الورق.
