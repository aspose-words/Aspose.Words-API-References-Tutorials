...
### 3. كيف أتأكد من الحفاظ على التنسيق عند إلحاق المستندات؟
 ...
 استخدم ال`ImportFormatMode.KeepSourceFormatting` المعلمة في`AppendDocument` طريقة للحفاظ على تنسيق المستند المصدر.
