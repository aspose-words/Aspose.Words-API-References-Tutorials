...
1.  Aspose.Words for .NET: قم بتنزيل المكتبة من الموقع الرسمي[رابط التحميل](https://releases.aspose.com/words/net/) . يمكنك استكشاف نسخة تجريبية مجانية[رابط تجريبي مجاني](https://releases.aspose.com/) أو شراء ترخيص[شراء الرابط](https://purchase.aspose.com/buy) بناء على احتياجاتك.
...
## الخطوة 1: تحميل مستندات المصدر والوجهة:
 ...
 إنشاء اثنين`Document` الكائنات باستخدام`Aspose.Words.Document`منشئ. الأول (`srcDoc`) سيحتفظ بالمستند المصدر الذي يحتوي على المحتوى المراد إلحاقه. الثاني (`dstDoc`) يمثل المستند الوجهة حيث سنقوم بدمج المحتوى المصدر مع ترقيم الصفحات المعاد تشغيله.
...
## الخطوة 2: إعداد الفاصل المقطعي:
 ...
 تعيين`SectionStart` ملكية`PageSetup` ل`SectionStart.NewPage`. يضمن ذلك إنشاء صفحة جديدة قبل إلحاق المحتوى المصدر بالمستند الوجهة.
...
### هل يمكنني تطبيق تنسيقات ترقيم مختلفة (مثل الأرقام الرومانية)؟
 ...
 قطعاً! يوفر Aspose.Words تحكمًا شاملاً في تنسيقات ترقيم الصفحات. استكشف`NumberStyle` ملكية`HeaderFooter` كائن للاختيار من بين أنماط الترقيم المختلفة مثل الأرقام الرومانية أو الحروف أو التنسيقات المخصصة.
