...
#### س:. هل يمكنني حذف محتوى النص ضمن فقرات معينة أو نطاقات مخصصة أخرى باستخدام وظيفة "نطاقات حذف النص في مستند Word" في Aspose.Words for .NET؟
