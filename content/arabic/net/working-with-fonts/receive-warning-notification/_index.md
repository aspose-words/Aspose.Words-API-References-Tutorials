...
-  نموذج مستند: احصل على نموذج مستند (على سبيل المثال،`Rendering.docx`) للعمل بها.
...
## الخطوة 3: إعداد رد الاتصال التحذيري
 ...
 لالتقاط التحذيرات والتعامل معها، قم بإنشاء فئة تنفذ`IWarningCallback` واجهة. ستقوم هذه الفئة بتسجيل أي تحذيرات تحدث أثناء معالجة المستندات.
