...
ج: تتضمن أنواع تأثيرات النص DrawML الشائعة الاستخدام في مستندات Word الظلال والانعكاسات والتوهجات والتدرجات وما إلى ذلك. ويمكن تطبيق هذه التأثيرات لتحسين مظهر النص وتنسيقه.
