...
---
في هذا البرنامج التعليمي، سنوضح لك كيفية تعيين دليل الخطوط في Aspose.Words لـ .NET. سوف تتعلم كيفية تحديد الدليل الذي يحتوي على الخطوط المستخدمة في مستند Word الخاص بك.
...
ج: نعم، مجلدات الخطوط المحددة في Aspose.Words لها الأسبقية على الخطوط المثبتة على النظام. وهذا يعني أنه في حالة وجود خط بنفس الاسم في مجلدات الخطوط المحددة وفي خطوط النظام، فسيتم استخدام الإصدار الموجود في مجلد الخطوط عند معالجة مستندات Word.