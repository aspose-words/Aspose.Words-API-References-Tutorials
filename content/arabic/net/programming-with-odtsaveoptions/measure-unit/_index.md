...
## الخطوة 3: تكوين وحدة القياس
 ...
 الآن، لنقم بتكوين وحدة القياس لتحويل ODT. هذا هو المكان الذي يحدث السحر. سنقوم بإعداد`OdtSaveOptions` لاستخدام البوصة كوحدة القياس.
...
وهناك لديك! باتباع هذه الخطوات، يمكنك بسهولة تكوين ميزة وحدة القياس في Aspose.Words لـ .NET لضمان الحفاظ على تخطيط المستند أثناء التحويل. سواء كنت تستخدم البوصات أو السنتيمترات أو النقاط، فقد أوضح لك هذا البرنامج التعليمي كيفية التحكم في تنسيق المستند بسهولة.
