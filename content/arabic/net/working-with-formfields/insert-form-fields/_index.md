...
#### س: كيف يمكنني إدخال حقل نموذج نوع النص في Aspose.Words؟
 ...
 ج: لإدراج حقل نموذج نوع النص في Aspose.Words ، يمكنك استخدام`FormField` فئة وضبطها`Type` الملكية ل`FormFieldType.Text`. يمكنك أيضًا تخصيص خصائص أخرى مثل الاسم والتسمية والخيارات.

#### س: هل من الممكن إنشاء حقل نموذج نوع خانة الاختيار في وثيقة؟

 ج: نعم ، من الممكن إنشاء حقل نموذج نوع مربع الاختيار في وثيقة Aspose.Words. يمكنك استخدام ال`FormField` فئة وضبطها`Type` الملكية ل`FormFieldType.CheckBox` لإنشاء مربع اختيار. يمكنك بعد ذلك تخصيص خصائص مربع الاختيار حسب الحاجة.

#### س: كيف يمكنني إضافة حقل نموذج نوع القائمة المنسدلة إلى مستند؟

 ج: لإضافة حقل نموذج من القائمة المنسدلة في مستند Aspose.Words ، استخدم`FormField` فئة وضبطها`Type` الملكية ل`FormFieldType.DropDown` . يمكنك بعد ذلك تعيين خيارات القائمة المنسدلة باستخدام ملف`DropDownItems` ملكية.
