...
### كيف أتعامل مع الخلايا التي تمتد عبر صفوف أو أعمدة متعددة؟
 يمكنك استخدام`RowSpan`و`ColSpan` خصائص`Cell` فئة لإدارة الخلايا المدمجة.
...
### كيف أحفظ الوثيقة المعدلة؟
 استخدم`Save` طريقة`Document` فئة لحفظ التغييرات الخاصة بك. على سبيل المثال:`doc.Save(dataDir + "UpdatedTables.docx");`
