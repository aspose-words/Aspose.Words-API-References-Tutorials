...
#### س: هل من الممكن إضافة تنسيق إضافي للعناوين في جدول المحتويات؟
 ...
 ج: نعم، يمكنك إضافة تنسيق إضافي إلى العناوين الموجودة في جدول المحتويات، مثل أنماط الخطوط أو الألوان أو الخصائص الأخرى. عن طريق ضبط`Font` خصائص`DocumentBuilder`، يمكنك تطبيق تنسيق مخصص على العناوين.