...
فيما يلي دليل خطوة بخطوة لشرح كود مصدر C# أدناه والذي يوضح كيفية إنشاء عقدة فقرة وإضافتها باستخدام Aspose.Words for .NET.
...
#### س: كيفية تحديد محتوى عقدة الفقرة؟
 ...
 ج: لتعيين محتوى عقدة الفقرة، يمكنك استخدام الخيار`createTextNode` طريقة لإنشاء عقدة نصية تحتوي على المحتوى المطلوب، ثم استخدم`appendChild` طريقة لإضافة تلك العقدة النصية كفرع لعقدة الفقرة.
