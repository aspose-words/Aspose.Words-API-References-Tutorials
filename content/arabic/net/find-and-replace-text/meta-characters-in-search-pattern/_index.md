...
## الخطوة 4: إدراج فاصل صفحات في المستند
 ...
 لتوضيح استخدام حرف أولي آخر، سنقوم بإدراج فاصل صفحات في المستند باستخدام الأمر`InsertBreak` الطريقة مع`BreakType.PageBreak` حدود. نقوم أولاً بتحريك المؤشر من`DocumentBuilder` إلى نهاية المستند، ثم نقوم بإدراج فاصل الصفحات وسطرًا جديدًا من النص:
...
ج: لتوضيح استخدام حرف أولي آخر، سنقوم بإدراج فاصل صفحات في المستند باستخدام الأمر`InsertBreak` الطريقة مع`BreakType.PageBreak` حدود. نقوم أولاً بتحريك المؤشر من`DocumentBuilder` إلى نهاية المستند، ثم نقوم بإدراج فاصل الصفحات وسطرًا جديدًا من النص:
