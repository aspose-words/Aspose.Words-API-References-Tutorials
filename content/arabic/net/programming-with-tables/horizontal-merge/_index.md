...
description: تعرف على كيفية دمج الخلايا أفقيًا في جدول Word باستخدام Aspose.Words لـ .NET.
type: docs
weight: 10
...
```
 ...
 نستخدم هنا أداة إنشاء المستندات لإنشاء الجدول وتعيين خصائص الدمج الأفقي للخلية. نحن نستخدم ال`HorizontalMerge` ملكية`CellFormat` كائن لتحديد نوع الدمج الأفقي الذي سيتم تطبيقه على كل خلية. استخدام`CellMerge.First` نقوم بدمج الخلية الأولى مع الخلية التالية أثناء الاستخدام`CellMerge.Previous` نقوم بدمج الخلية الحالية مع الخلية السابقة.`CellMerge.None` يشير إلى أنه لا ينبغي دمج الخلية.
