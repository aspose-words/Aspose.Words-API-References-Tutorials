...
```
 ...
 نحن هنا نستخدم`Clone` طريقة إنشاء نسخة كاملة من المصفوفة. ثم نستخدم`InsertAfter` لإدراج الجدول المستنسخ في المستند، بعد الجدول الأصلي. نقوم أيضًا بإضافة فقرة فارغة بين الجدولين لمنع دمجهما عند الحفظ.
