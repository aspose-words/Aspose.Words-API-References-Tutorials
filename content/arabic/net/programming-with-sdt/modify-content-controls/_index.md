...
نعم، يمكنك إزالة المعاملة الخاصة والتفضيلية (SDTs) عن طريق الوصول إلى عقد المستند وحذف المعاملة الخاصة والتفضيلية (SDT) المطلوبة.

4. كيف أتعامل مع SDTs المتداخلة ضمن عناصر أخرى؟

 استخدم`GetChildNodes` طريقة مع المعلمات المناسبة للوصول إلى SDTs المتداخلة.
