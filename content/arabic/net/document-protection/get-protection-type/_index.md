...
في هذه المقالة، شرحنا كيفية استخدام وظيفة Get Protection Type في Aspose.Words لـ .NET لتحديد نوع الحماية للمستند. باتباع الخطوات الموضحة، ستتمكن من دمج هذه الوظيفة بسهولة في مشاريع C# الخاصة بك والتعامل مع المستندات المحمية بكفاءة. يوفر Aspose.Words for .NET مرونة كبيرة
