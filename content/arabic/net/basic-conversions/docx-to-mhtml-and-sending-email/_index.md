...
## الخطوة 1: قم بتحميل مستند DOCX
 ...
 أولاً، تحتاج إلى تحميل مستند DOCX الذي تريد تحويله. استخدم ال`Document` فئة من Aspose.Words لتحميل ملف DOCX الخاص بك.
...
### كيف يمكنني إضافة مرفقات إلى البريد الإلكتروني؟
 يمكنك استخدام ال`Attachments` ملكية`MailMessage`فئة لإضافة مرفقات إلى البريد الإلكتروني الخاص بك.
