...
#### كيفية تحديد الدليل الذي يحتوي على المستندات التي سيتم البحث فيها عن التوقيع الرقمي؟
 ...
 لتحديد الدليل الذي يحتوي على المستندات التي تريد البحث عن التوقيع الرقمي فيها، يجب عليك تعديل الملف`dataDir` المتغيرات في الكود. يستبدل`"YOUR DOCUMENT DIRECTORY"` بالمسار الفعلي إلى دليل المستندات الخاص بك.
