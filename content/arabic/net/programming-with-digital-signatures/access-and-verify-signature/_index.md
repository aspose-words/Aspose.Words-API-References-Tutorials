...
2.  استخدم حلقة للتكرار من خلال`DigitalSignatures` جمع الوثائق. يمثل كل تكرار توقيعًا رقميًا.
...
1.  الوصول إلى`DigitalSignatures` جمع الوثائق.
...
ج: نعم، يمكنك استرداد تعليقات الموقع أو سبب التوقيع من التوقيع الرقمي في مستند Word. ال`Comments` ملكية`DigitalSignature` يوفر الكائن الوصول إلى التعليقات المحددة بواسطة الموقع أثناء عملية التوقيع.
