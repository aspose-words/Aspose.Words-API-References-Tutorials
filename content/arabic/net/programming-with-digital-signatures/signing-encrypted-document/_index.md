...
## الخطوة 4: كتابة الكود
 ...
 الآن، دعونا نتعمق في الكود. افتح الخاص بك`Program.cs` الملف وابدأ بإعداد المسار إلى دليل المستند الخاص بك وتهيئة الملف`SignOptions` مع كلمة المرور فك التشفير.
