...
#### س: هل يدعم Aspose.Words لغات متعددة لإضافة علامات Bidi؟
نعم، يدعم Aspose.Words عدة لغات لإضافة علامات Bidi. يمكنك إضافة علامات Bidi إلى نص بلغات مختلفة، مثل الإنجليزية والعبرية والعربية، باستخدام Aspose.Words for .NET.
