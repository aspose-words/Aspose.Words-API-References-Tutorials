...
## الخطوة 2: إنشاء قائمة ذات مستويات متعددة من المسافة البادئة
 ...
 مع ال`DocumentBuilder` على سبيل المثال، يمكنك الآن إنشاء قائمة بمستويات مختلفة من المسافة البادئة. استخدم ال`ListFormat` خاصية لتطبيق الترقيم ووضع مسافة بادئة لعناصر القائمة كما هو مطلوب.
