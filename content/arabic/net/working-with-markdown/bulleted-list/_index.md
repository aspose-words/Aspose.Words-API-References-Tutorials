...
## الخطوة 3: تخصيص تنسيق التعداد النقطي
 ...
 يمكننا تخصيص تنسيق التعداد النقطي عن طريق الوصول إلى خصائص`ListFormat.List.ListLevels[0]`. في هذا المثال، نستخدم الشرطة "-" كرصاصة.
...
ج: نعم، من الممكن تداخل القوائم النقطية في Markdown عن طريق إضافة أربع مسافات إزاحة أمام كل عنصر قائمة متداخل.
