...
## الخطوة 2: تطبيق تنسيق القائمة المرتبة
 ...
 سنقوم بتطبيق تنسيق القائمة المطلوبة باستخدام أداة إنشاء المستندات`ApplyBulletDefault`طريقة. يمكننا أيضًا تخصيص تنسيق الترقيم من خلال الانتقال إلى مستويات القائمة وتعيين التنسيق الذي نريده.
