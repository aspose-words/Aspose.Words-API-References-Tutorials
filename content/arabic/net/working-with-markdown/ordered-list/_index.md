...
لذا، قررت التعمق في Aspose.Words for .NET لإنشاء مستندات Word مذهلة برمجيًا. اختيار رائع! سنقوم اليوم بشرح كيفية إنشاء قائمة مرتبة في مستند Word. سنأخذ الأمر خطوة بخطوة، لذا سواء كنت مبتدئًا في مجال البرمجة أو محترفًا متمرسًا، ستجد هذا الدليل مفيدًا للغاية. دعونا نبدأ!
...
يقوم سطر التعليمات البرمجية هذا بإعداد الترقيم لقائمتك. سهل، أليس كذلك؟
...
ماذا لو كنت تريد إضافة عناصر فرعية ضمن عنصر ما؟ دعونا نفعل ذلك!
...
### كيف يمكنني إضافة المزيد من مستويات المسافة البادئة؟  
 يمكنك استخدام`ListIndent` الطريقة عدة مرات لإنشاء مستويات أعمق من القوائم الفرعية. كل دعوة ل`ListIndent` يضيف مستوى واحد من المسافة البادئة.
