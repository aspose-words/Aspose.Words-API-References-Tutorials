...
---
في هذا البرنامج التعليمي، سنستكشف كود مصدر C# المقدم لتحديث خاصية توفير الوقت الأخيرة عند حفظ مستند باستخدام Aspose.Words for .NET. تسمح لك هذه الميزة بالتحديث التلقائي لخاصية توفير الوقت الأخيرة للمستند الذي تم إنشاؤه.
