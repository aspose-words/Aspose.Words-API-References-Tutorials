...
في هذا البرنامج التعليمي، اكتشفنا ميزة اتجاه نص المستند في Aspose.Words لـ .NET. لقد تعلمنا كيفية تحديد اتجاه النص في المستند، خاصة بالنسبة للغات المكتوبة من اليمين إلى اليسار، مثل العبرية أو العربية.
