...
```
 ...
 يستبدل`"YOUR DOCUMENT DIRECTORY"` بالمسار الفعلي حيث توجد مستندات Word الخاصة بك. هنا يبدا المرح!
