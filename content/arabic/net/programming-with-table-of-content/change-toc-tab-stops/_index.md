...
### هل أحتاج إلى ترخيص لاستخدام Aspose.Words لـ .NET؟
 نعم، أنت بحاجة إلى ترخيص صالح لاستخدام Aspose.Words لـ .NET بعد الفترة التجريبية. يمكنك الحصول على[ترخيص مؤقت](https://purchase.aspose.com/temporary-license/) أو[شراء واحدة](https://purchase.aspose.com/buy).