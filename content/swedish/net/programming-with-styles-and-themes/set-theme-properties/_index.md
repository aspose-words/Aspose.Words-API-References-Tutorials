...
```
 ...
 det här steget kommer vi åt`Theme` föremålet för`Document` objekt för att hämta dokumenttemat. Därefter kan vi ändra temaegenskaper som sekundära teckensnitt (`MinorFonts.Latin`) och färger (`Colors.Hyperlink`).
