...
在本文中，我们将探索上面的 C# 源代码，以了解如何使用 Aspose.Words for .NET 库中的“忽略删除修订内的文本”功能。当我们在处理文档时想要忽略删除修订内的文本时，此功能非常有用。

## Aspose.Words for .NET 库概述

在深入了解代码细节之前，让我简要介绍一下 Aspose.Words for .NET 库。它是一个功能强大的库，允许在 .NET 应用程序中创建、修改和转换 Word 文档。它提供了许多用于处理文档的高级功能，包括修订管理。
