...
| Título | Descripción |
| --- | --- |
| [Cambiar el estilo del nivel de TOC](./change-style-of-toc-level/) | Aprenda a cambiar fácilmente el estilo de un nivel de tabla de contenido en un documento de Word usando Aspose.Words para .NET. |
| [Cambiar paradas de tabulación de índice](./change-toc-tab-stops/) | Aprenda a cambiar las pestañas de la tabla de contenido en un documento de Word usando Aspose.Words para .NET. |