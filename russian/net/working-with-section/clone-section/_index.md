...
#### В: Как установить каталог документов в Aspose.Words для .NET?
 ...
 О: Чтобы указать путь к каталогу, содержащему ваш документ Word, необходимо заменить`"YOUR DOCUMENT DIRECTORY"` в коде с соответствующим путем. Вот как это сделать:
...
#### В: Как загрузить документ и клонировать раздел в Aspose.Words для .NET?
