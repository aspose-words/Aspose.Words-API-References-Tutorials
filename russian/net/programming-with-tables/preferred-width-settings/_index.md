...
Здесь мы используем конструктор документов для построения таблицы с тремя ячейками. Первая ячейка имеет предпочтительную ширину 40 пунктов, вторая ячейка имеет предпочтительную ширину 20% от ширины таблицы, а третья ячейка имеет автоматическую предпочтительную ширину, которая настраивается.
