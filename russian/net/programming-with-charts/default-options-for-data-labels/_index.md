...
Да, методы, описанные в этом руководстве, можно применять к другим типам диаграмм, поддерживаемым Aspose.Words для .NET. Ключевым моментом является доступ к соответствующим объектам и свойствам, специфичным для типа диаграммы, с которой вы работаете в Word Processing.