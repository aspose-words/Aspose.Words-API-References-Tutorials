...
Aspose.Words for .NET — это мощная библиотека для создания, редактирования и управления документами Word в приложении C#. Он предлагает множество функций для работы с документами Word, включая добавление двунаправленных (двунаправленных) меток.
