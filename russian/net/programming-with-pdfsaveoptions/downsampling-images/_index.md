...
В этом руководстве мы покажем вам, как уменьшить размер документа PDF с помощью понижения разрешения изображений при преобразовании в PDF с помощью Aspose.Words для .NET. Это уменьшает размер сгенерированного файла PDF. Выполните следующие действия:
