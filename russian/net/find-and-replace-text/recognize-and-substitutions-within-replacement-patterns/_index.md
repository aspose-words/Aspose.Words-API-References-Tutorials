...
О: Для получения дополнительной информации и примеров использования регулярных выражений в Aspose.Words для .NET вы можете обратиться к официальной документации и репозиторию Aspose.Words GitHub. Документация содержит подробные пояснения и примеры кода для различных сценариев, включающих регулярные выражения и работу с текстом в Aspose.Words для .NET.
