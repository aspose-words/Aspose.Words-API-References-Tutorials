---
title: Заменить текст, содержащий метасимволы
linktitle: Заменить текст, содержащий метасимволы
...
В этой статье мы рассмотрим приведенный выше исходный код C#, чтобы понять, как использовать функцию «Заменить текст, содержащий метасимволы» в библиотеке Aspose.Words для .NET. Эта функция позволяет заменять части текста в документе, содержащие определенные метасимволы.
