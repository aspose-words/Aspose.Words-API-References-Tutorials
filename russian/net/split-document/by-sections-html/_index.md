...
Aspose.Words for .NET предоставляет различные параметры для настройки выходного формата HTML. Вы можете изменить стиль, настройки шрифта, разрешение изображения и многие другие аспекты HTML-документа, настроив параметры сохранения. Обратитесь к документации Aspose.Words для .NET за подробной информацией о доступных опциях и о том, как их использовать.
