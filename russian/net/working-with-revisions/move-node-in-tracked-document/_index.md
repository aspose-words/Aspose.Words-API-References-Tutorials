...
В этом руководстве мы узнали, как переместить узел в отслеживаемом документе Word с помощью Aspose.Words для .NET. Выполнив шаги по созданию документа, включив отслеживание изменений, переместив узел и остановив отслеживание изменений, мы смогли успешно выполнить эту манипуляцию. Aspose.Words for .NET — это мощный инструмент для работы с документами Word, предлагающий расширенные функции для управления версиями. Теперь вы можете использовать эти знания для перемещения узлов в ваших собственных документах Word, отслеживая изменения с помощью Aspose.Words для .NET.
