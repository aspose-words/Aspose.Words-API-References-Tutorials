...
description: Учебники содержат управление порогом экспозиции для бинаризации tiff, получение диапазона страниц tiff, форматирование 1bpp с индексированием, получение диапазона страниц jpeg и обратный вызов сохранения страницы.
type: docs
weight: 1630
