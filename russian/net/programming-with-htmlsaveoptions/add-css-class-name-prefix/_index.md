...
В этом руководстве мы познакомим вас с исходным кодом C#, чтобы добавить префикс имени класса CSS с помощью Aspose.Words для .NET. Эта функция позволяет добавлять пользовательский префикс к сгенерированным именам классов CSS при преобразовании документа в HTML.
...
На этом шаге мы загрузим документ Word, который хотим преобразовать в HTML. Используйте следующий код для загрузки документа:
