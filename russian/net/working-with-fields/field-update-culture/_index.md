...
A: Чтобы проверить текущую культуру обновления поля в документе Word, вы можете использовать свойство Document.UpdateFieldsCultureInfo. Это свойство возвращает объект CultureInfo, представляющий культуру, используемую в настоящее время для установки обновлений поля.