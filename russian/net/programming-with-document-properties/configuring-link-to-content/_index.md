...
Теперь вы узнали, как настроить ссылку на содержимое в документе с помощью Aspose.Words для .NET. Следуя пошаговому руководству, представленному в этом руководстве, вы сможете легко создавать и настраивать ссылки на определенный контент в своих собственных документах.