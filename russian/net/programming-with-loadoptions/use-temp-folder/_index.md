...
При работе с документами Word в приложении C# может потребоваться использование временной папки для хранения временных файлов, созданных во время обработки документа. С библиотекой Aspose.Words для .NET вы можете легко указать временную папку, используя параметры загрузки LoadOptions. В этом пошаговом руководстве мы покажем вам, как использовать исходный код Aspose.Words для .NET C# для загрузки документа с использованием временной папки, указанной с помощью параметров загрузки LoadOptions.
