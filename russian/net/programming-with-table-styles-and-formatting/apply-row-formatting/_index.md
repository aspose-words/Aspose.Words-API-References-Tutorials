...
## Шаг 6: Определите форматирование таблицы
 Некоторые свойства форматирования можно задать для самой таблицы, и они применяются ко всем строкам таблицы. В этом примере мы устанавливаем свойства поля таблицы, используя`LeftPadding`, `RightPadding`, `TopPadding` и`BottomPadding` характеристики.
