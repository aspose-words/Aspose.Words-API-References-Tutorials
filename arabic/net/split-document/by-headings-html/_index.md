...
#### هل يمكنني تقسيم المستند بناءً على معايير متعددة؟
 ...
 نعم ، يمكنك تقسيم المستند بناءً على معايير متعددة من خلال دمج خيارات المعايير وفقًا لذلك. على سبيل المثال ، يمكنك تقسيم المستند حسب العنوان والصفحة عن طريق تعيين ملف`DocumentSplitCriteria` الملكية ل`HeadingParagraph | Page`. سيؤدي هذا إلى تقسيم المستند في كل عنوان وكل صفحة ، مما يؤدي إلى إنشاء أجزاء أصغر بناءً على كلا المعيارين.