---
title: خانة الاختيار الحالة الحالية
linktitle: خانة الاختيار الحالة الحالية
...
## الخطوة 3: حدد أو ألغِ تحديد خانة الاختيار بناءً على حالتها الحالية
 تحقق مما إذا كانت علامة المستند المهيكلة المستردة من النوع`SdtType.Checkbox` . إذا كان الأمر كذلك ، فاضبط`Checked` ملكية التحكم في المحتوى إلى`true` لتحديد المربع. خلاف ذلك ، يمكنك تركه دون رادع.
