...
تسمح لك قراءة خصائص عناصر تحكم ActiveX باستخراج معلومات مهمة من ملفات Word التي تحتوي على عناصر التحكم هذه. يوفر Aspose.Words for .NET ميزات قوية للعمل مع عناصر تحكم ActiveX وأتمتة معالجة المستندات الخاصة بك.
