...
#### س: هل من الممكن إضافة نص يتوسطه خط إلى عدة أجزاء من النص في نفس الفقرة؟
 ...
 ج: نعم ، يمكنك إضافة نص يتوسطه خط إلى أجزاء متعددة من النص في فقرة واحدة باستخدام عدة`Run` أشياء. يمكنك إنشاء ملفات`Run` الأشياء وتعيين`Font.StrikeThrough` الملكية ل`true`لكل كائن لإضافة نص يتوسطه خط إلى أجزاء النص المطلوبة. ثم يمكنك إضافتها إلى الفقرة باستخدام`Paragraph.AppendChild(run)` طريقة.
