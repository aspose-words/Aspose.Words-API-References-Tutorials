...
## الخطوة 1: تحديد الدلائل
 ...
 للبدء ، تحتاج إلى تحديد الدلائل حيث تريد تخزين الملفات وفقًا لتنسيقها. يستبدل`"YOUR DOCUMENT DIRECTORY"` مع المسار الفعلي إلى دليل المستندات الخاص بك. نقوم بإنشاء الدلائل "مدعوم" و "غير معروف" و "مشفر" و "ما قبل 97" إذا لم تكن موجودة بالفعل.
...
### الأسئلة الشائعة لاكتشاف تنسيق ملف المستند
