...
description: تعرف على كيفية البحث عن نص واستبداله في مستندات Word باستخدام Aspose.Words for .NET. توضح لك البرامج التعليمية كيفية إجراء عمليات بحث دقيقة عن النص ، بما في ذلك خيارات البحث المتقدم.
type: docs
weight: 1360
...
| عنوان | وصف |
| --- | --- |
| [البحث عن نص بسيط واستبداله في Word](./simple-find-replace/) | تعرف على كيفية إجراء بحث بسيط عن النص واستبداله في مستند Word باستخدام Aspose.Words for .NET. |
...
| [Word استبدال النص الذي يحتوي على أحرف التعريف](./replace-text-containing-meta-characters/) | تعرف على كيفية استبدال نص يحتوي على أحرف أولية في مستندات Word باستخدام Aspose.Words for .NET. |
