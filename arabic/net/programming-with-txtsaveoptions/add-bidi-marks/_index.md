...
Aspose.Words for .NET مكتبة قوية لإنشاء مستندات Word وتحريرها ومعالجتها في تطبيق C #. يوفر العديد من الميزات للعمل مع مستندات Word ، بما في ذلك إضافة علامات ثنائية الاتجاه (ثنائية الاتجاه).
...
يمكنك إضافة علامات ثنائية الاتجاه إلى مستند Word باتباع الخطوات التالية:
 ...
 بمجرد إضافة المحتوى ، استخدم`TxtSaveOptions` فئة وضبط`AddBidiMarks` الملكية ل`true`.
