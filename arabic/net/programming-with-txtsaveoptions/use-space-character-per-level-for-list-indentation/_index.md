...
Aspose.Words for .NET مكتبة قوية لإنشاء مستندات Word وتحريرها ومعالجتها في تطبيق C #. يوفر العديد من الميزات للعمل مع مستندات Word ، بما في ذلك القدرة على استخدام مسافة واحدة لكل مستوى لعمل قوائم المسافة البادئة.
